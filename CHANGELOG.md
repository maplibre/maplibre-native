...
- [android] Add `Style#setGlobalStateProperty` / `Style#getGlobalState` and the `Expression.globalState` builder for the [`global-state`](https://maplibre.org/maplibre-style-spec/expressions/#global-state) expression ([#3302](https://github.com/maplibre/maplibre-native/issues/3302)).
