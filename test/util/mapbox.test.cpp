...
TEST(Mapbox, SourceURL) {
    ...
    EXPECT_EQ(
        ...
        mbgl::util::mapbox::normalizeSourceURL(
            mapboxFixture::mapboxTileServerOptions, "mapbox://user.map?style=mapbox://styles/mapbox/streets-v9@0", "key"
        )
    );
    EXPECT_EQ(
        "https://api.mapbox.com/v4/user.map.json?access_token=key&secure",
...
TEST(Mapbox, CanonicalURL) {
    ...
    EXPECT_EQ(
        ...
        mbgl::util::mapbox::canonicalizeTileURL(
            mapboxFixture::mapboxTileServerOptions, "http://api.mapbox.com/v4/a.b/{z}/{x}/{y}.", SourceType::Raster, 256
        )
    );
    EXPECT_EQ(
        "http://api.mapbox.com/v4/a.b/{z}/{x}/{y}/.",
...
TEST(MapLibre, CanonicalURL) {
    ...
    EXPECT_EQ(
        ...
        mbgl::util::mapbox::canonicalizeTileURL(
            mapboxFixture::mapLibreTileServerOptions,
...
TEST(MapTiler, SourceURL) {
    ...
    EXPECT_EQ(
        ...
        mbgl::util::mapbox::canonicalizeSourceURL(
            mapboxFixture::mapTilerTileServerOptions, "https://api.maptiler.com/tiles/v3/tiles.json?key=abcdef"
        )
    );
    EXPECT_EQ(
        "maptiler://sources/outdoor",
        mbgl::util::mapbox::canonicalizeSourceURL(
            mapboxFixture::mapTilerTileServerOptions, "https://api.maptiler.com/tiles/outdoor/tiles.json?key=abcdef"
        )
    );
    EXPECT_EQ(
        "maptiler://sources/7ac429c7-c96e-46dd-8c3e-13d48988986a",
...
TEST(MapTiler, GlyphsURL) {
    ...
    EXPECT_EQ(
        ...
        mbgl::util::mapbox::canonicalizeGlyphURL(
            mapboxFixture::mapTilerTileServerOptions, "https://api.maptiler.com/fonts/{fontstack}/{range}.pbf"
        )
    );
    EXPECT_EQ(
        "maptiler://fonts/{fontstack}/{range}.pbf",
...
TEST(MapTiler, Sprites) {
    ...
    EXPECT_EQ(
        ...
        mbgl::util::mapbox::canonicalizeSpriteURL(
            mapboxFixture::mapTilerTileServerOptions, "https://api.maptiler.com/maps/streets/sprite"
        )
    );
}
...
TEST(MapTiler, TilesURLPassThrough) {
    ...
    EXPECT_EQ(
        "https://api.tileserver.com/map?key=1234",
        mbgl::util::mapbox::canonicalizeTileURL(
            mapboxFixture::mapTilerTileServerOptions, "https://api.tileserver.com/map?key=1234", SourceType::Vector, 512
        )
    );
    EXPECT_EQ(
        "",
