...
TEST(TileCover, PitchIssue15442) {
    ...
    transform.jumpTo(CameraOptions()
                         ...
                         .withBearing(0.74963938256567264 * util::RAD2DEG_D)
...
TEST(TileCover, GeomSanFranciscoPoly) {
    auto sanFranciscoGeom =
        Polygon<double>{{{-122.5143814086914, 37.779127216982424},  {-122.50811576843262, 37.72721239056709},
