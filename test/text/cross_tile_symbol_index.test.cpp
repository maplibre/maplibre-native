...
SymbolInstance makeSymbolInstance(float x, float y, std::u16string key) {
    ...
    auto sharedData = std::make_shared<SymbolInstanceSharedData>(std::move(line),
                                                                 ...
                                                                 false,
                                                                 false);
    return SymbolInstance(anchor, std::move(sharedData), shaping, {}, {}, 0, 0, placementType, textOffset, 0, 0, iconOffset, subfeature, 0, 0, key, 0.0f, 0.0f, 0.0f, variableTextOffset, false);
}
