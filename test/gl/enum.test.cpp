...
TEST(GL, DrawModeType) {
    ...
    ASSERT_EQ(GL_INVALID_ENUM, Enum<DrawModeType>::to(static_cast<DrawModeType>(-1)));  // NOLINT(clang-analyzer-optin.core.EnumCastOutOfRange)
}
...
TEST(GL, ColorBlendEquationType) {
    ...
    ASSERT_EQ(GL_INVALID_ENUM, Enum<ColorBlendEquationType>::to(static_cast<ColorBlendEquationType>(-1)));  // NOLINT(clang-analyzer-optin.core.EnumCastOutOfRange)
...
TEST(GL, ColorBlendFactorType) {
    ...
    ASSERT_EQ(GL_INVALID_ENUM, Enum<ColorBlendFactorType>::to(static_cast<ColorBlendFactorType>(-1)));  // NOLINT(clang-analyzer-optin.core.EnumCastOutOfRange)
...
TEST(GL, DepthFunctionType) {
    ...
    ASSERT_EQ(GL_INVALID_ENUM, Enum<DepthFunctionType>::to(static_cast<DepthFunctionType>(-1)));  // NOLINT(clang-analyzer-optin.core.EnumCastOutOfRange)
...
TEST(GL, StencilFunctionType) {
    ...
    ASSERT_EQ(GL_INVALID_ENUM, Enum<StencilFunctionType>::to(static_cast<StencilFunctionType>(-1)));  // NOLINT(clang-analyzer-optin.core.EnumCastOutOfRange)
...
TEST(GL, StencilOpType) {
    ...
    ASSERT_EQ(GL_INVALID_ENUM, Enum<StencilOpType>::to(static_cast<StencilOpType>(-1)));  // NOLINT(clang-analyzer-optin.core.EnumCastOutOfRange)
...
TEST(GL, CullFaceSideType) {
    ...
    ASSERT_EQ(GL_INVALID_ENUM, Enum<CullFaceSideType>::to(static_cast<CullFaceSideType>(-1)));  // NOLINT(clang-analyzer-optin.core.EnumCastOutOfRange)
...
TEST(GL, CullFaceWindingType) {
    ...
    ASSERT_EQ(GL_INVALID_ENUM, Enum<CullFaceWindingType>::to(static_cast<CullFaceWindingType>(-1)));  // NOLINT(clang-analyzer-optin.core.EnumCastOutOfRange)
...
TEST(GL, BufferUsageType) {
    ...
    ASSERT_EQ(GL_INVALID_ENUM, Enum<BufferUsageType>::to(static_cast<BufferUsageType>(-1)));  // NOLINT(clang-analyzer-optin.core.EnumCastOutOfRange)
...
TEST(GL, TexturePixelType) {
    ...
    ASSERT_EQ(GL_INVALID_ENUM, Enum<TexturePixelType>::to(static_cast<TexturePixelType>(-1)));  // NOLINT(clang-analyzer-optin.core.EnumCastOutOfRange)
...
TEST(GL, TextureChannelDataType) {
    ...
    ASSERT_EQ(GL_INVALID_ENUM, Enum<TextureChannelDataType>::to(static_cast<TextureChannelDataType>(-1)));  // NOLINT(clang-analyzer-optin.core.EnumCastOutOfRange)
...
TEST(GL, RenderbufferPixelType) {
    ...
    ASSERT_EQ(GL_INVALID_ENUM, Enum<RenderbufferPixelType>::to(static_cast<RenderbufferPixelType>(-1)));  // NOLINT(clang-analyzer-optin.core.EnumCastOutOfRange)
...
TEST(GL, sizedFor) {
    ...
    ASSERT_EQ(GL_INVALID_ENUM,
              Enum<gfx::TexturePixelType>::sizedFor(TexturePixelType::RGBA, static_cast<TextureChannelDataType>(-1)));  // NOLINT(clang-analyzer-optin.core.EnumCastOutOfRange)
}
