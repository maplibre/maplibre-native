...
TEST(UpdateTileMasks, NoChildren) {
    validate({{UnwrappedTileID{0, 0, 0}, TileMask{CanonicalTileID{0, 0, 0}}}});
...
TEST(UpdateTileMasks, OneChild) {
    validate({
        {UnwrappedTileID{0, 0, 0},
         ...
         TileMask{CanonicalTileID{1, 0, 1}, CanonicalTileID{1, 1, 0}, CanonicalTileID{1, 1, 1}}},
        {UnwrappedTileID{1, 0, 0}, TileMask{CanonicalTileID{0, 0, 0}}},
    });
}
...
TEST(UpdateTileMasks, Complex) {
    ...
    validate({
        {UnwrappedTileID{12, 1028, 1456},
         TileMask{CanonicalTileID{1, 1, 1}, CanonicalTileID{2, 3, 0}, CanonicalTileID{2, 3, 1}}},
        {UnwrappedTileID{13, 2056, 2912},
         TileMask{CanonicalTileID{1, 0, 1}, CanonicalTileID{1, 1, 0}, CanonicalTileID{1, 1, 1}}},
        {UnwrappedTileID{13, 2056, 2913},
         TileMask{CanonicalTileID{1, 0, 0}, CanonicalTileID{1, 1, 0}, CanonicalTileID{1, 1, 1}}},
