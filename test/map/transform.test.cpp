...
TEST(Transform, InvalidBearing) {
    ...
    ASSERT_DOUBLE_EQ(0, transform.getLatLng().longitude());
    ASSERT_DOUBLE_EQ(1, transform.getZoom());
    ASSERT_DOUBLE_EQ(util::DEG2RAD_D(-2.0), transform.getBearing());
...
TEST(Transform, Anchor) {
    ...
    ASSERT_DOUBLE_EQ(util::DEG2RAD_D(-45.0), transform.getBearing());
    ...
    ASSERT_DOUBLE_EQ(util::DEG2RAD_D(10.0), transform.getPitch());
    ASSERT_DOUBLE_EQ(latLng.latitude(), transform.getLatLng().latitude());
    ASSERT_DOUBLE_EQ(latLng.longitude(), transform.getLatLng().longitude());

    transform.jumpTo(CameraOptions().withPitch(15.0));
    ASSERT_DOUBLE_EQ(util::DEG2RAD_D(15.0), transform.getPitch());
    ASSERT_DOUBLE_EQ(latLng.latitude(), transform.getLatLng().latitude());
    ASSERT_DOUBLE_EQ(latLng.longitude(), transform.getLatLng().longitude());

    transform.jumpTo(CameraOptions().withPitch(20.0).withAnchor(anchorPoint));
    ASSERT_DOUBLE_EQ(util::DEG2RAD_D(20.0), transform.getPitch());
...
TEST(Transform, InvalidPitch) {
    ...
    ASSERT_DOUBLE_EQ(1, transform.getZoom());
    ASSERT_DOUBLE_EQ(util::DEG2RAD_D(45), transform.getPitch());
    ...
    ASSERT_DOUBLE_EQ(util::DEG2RAD_D(60), transform.getPitch());
}
...
TEST(Transform, MinMaxPitch) {
    ...
    transform.jumpTo(CameraOptions().withPitch(0));
    ASSERT_DOUBLE_EQ(transform.getState().getMinPitch(), transform.getPitch());
    ASSERT_DOUBLE_EQ(util::DEG2RAD_D(15), transform.getPitch());

    transform.setMinPitch(45);
    ASSERT_DOUBLE_EQ(util::DEG2RAD_D(45), transform.getState().getMinPitch());
    transform.setMaxPitch(45);
    ASSERT_DOUBLE_EQ(util::DEG2RAD_D(45), transform.getState().getMaxPitch());
...
TEST(Transform, FreeCameraOptionsSetOrientation) {
    ...
    options.orientation = Quaternion::fromAxisAngle(vec3{{1.0, 0.0, 0.0}}, util::DEG2RAD_D(-60.0)).m;
    transform.setFreeCameraOptions(options);
    EXPECT_DOUBLE_EQ(0.0, transform.getState().getBearing());
    EXPECT_DOUBLE_EQ(util::DEG2RAD_D(60.0), transform.getState().getPitch());
    EXPECT_DOUBLE_EQ(0.0, transform.getState().getX());
    EXPECT_DOUBLE_EQ(206.0, transform.getState().getY());

    options.orientation = Quaternion::fromAxisAngle(vec3{{0.0, 0.0, 1.0}}, util::DEG2RAD_D(56.0)).m;
    transform.setFreeCameraOptions(options);
    EXPECT_DOUBLE_EQ(util::DEG2RAD_D(-56.0), transform.getState().getBearing());
    EXPECT_DOUBLE_EQ(0.0, transform.getState().getPitch());
    EXPECT_DOUBLE_EQ(0.0, transform.getState().getX());
    EXPECT_NEAR(152.192378, transform.getState().getY(), 1e-6);

    options.orientation = Quaternion::fromEulerAngles(0.0, 0.0, util::DEG2RAD_D(-179.0))
                              .multiply(Quaternion::fromEulerAngles(util::DEG2RAD_D(-30.0), 0.0, 0.0))
                              .m;
    transform.setFreeCameraOptions(options);
    EXPECT_DOUBLE_EQ(util::DEG2RAD_D(179.0), transform.getState().getBearing());
    EXPECT_DOUBLE_EQ(util::DEG2RAD_D(30.0), transform.getState().getPitch());
...
TEST(Transform, FreeCameraOptionsClampToBounds) {
    ...
    options.orientation = Quaternion::fromEulerAngles(util::DEG2RAD_D(-45.0), 0.0, 0.0).m;
    transform.setFreeCameraOptions(options);
    ...
    EXPECT_DOUBLE_EQ(206.0, transform.getState().getY());
    EXPECT_DOUBLE_EQ(0.0, transform.getState().getBearing());
    EXPECT_DOUBLE_EQ(util::DEG2RAD_D(45.0), transform.getState().getPitch());
...
TEST(Transform, FreeCameraOptionsOrientationRoll) {
    ...
    EXPECT_NEAR(util::DEG2RAD_D(45.0), transform.getState().getPitch(), 1e-9);
