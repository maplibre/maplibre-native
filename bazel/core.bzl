...
MLN_CORE_SOURCE = [
    ...
    "src/mbgl/renderer/dem_elevation_provider.cpp",
    "src/mbgl/renderer/dem_elevation_provider.hpp",
    ...
    "src/mbgl/renderer/texture_pool.hpp",
    ...
    "src/mbgl/style/terrain.cpp",
    "src/mbgl/style/terrain_impl.hpp",
    ...
    "src/mbgl/util/error_sink.hpp",
    "src/mbgl/util/error_sink.cpp",
...
MLN_DRAWABLES_SOURCE = [
    ...
    "src/mbgl/renderer/texture_pool.cpp",
...
MLN_DRAWABLES_MTL_SOURCE = [
    ...
    "src/mbgl/shaders/mtl/terrain_depth.cpp",
...
MLN_DRAWABLES_WEBGPU_SOURCE = [
    ...
    "src/mbgl/shaders/webgpu/terrain_depth.cpp",
