...
MLN_GENERATED_STYLE_SOURCE = [
    ...
    "src/mbgl/style/layers/debug_layer_properties.cpp",
    "src/mbgl/style/layers/debug_layer.cpp",
...
MLN_CORE_SOURCE = [
    ...
    "src/mbgl/renderer/layers/render_debug_layer.cpp",
    "src/mbgl/renderer/layers/render_debug_layer.hpp",
    ...
    "src/mbgl/style/layers/debug_layer_impl.cpp",
    "src/mbgl/style/layers/debug_layer_impl.hpp",
