# MLN_RENDERER_DEFINES = select({
#     ":legacy_renderer": ["MLN_LEGACY_RENDERER=1"],
#     "//conditions:default": ["MLN_LEGACY_RENDERER=0"]
# }) + select({
#     ":drawable_renderer": ["MLN_DRAWABLE_RENDERER=1"],
#     "//conditions:default": ["MLN_DRAWABLE_RENDERER=0"]
# })
...
MLN_DRAWABLES_SOURCE = [
    ...
    "src/mbgl/gfx/fill_extrusion_drawable_data.hpp",
    ...
    "src/mbgl/gl/drawable_gl_tweaker.cpp",
