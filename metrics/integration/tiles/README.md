...
| `jaxa/{z}-{x}-{y}.terrain.png` | PNG raster-DEM (Mapbox terrain-RGB encoding) | Terrain DEM tiles, z0-z12 | Credit: [AW3D30 (JAXA)](https://www.eorc.jaxa.jp/ALOS/en/dataset/aw3d30/aw3d30_e.htm). Originally added (in `tiles/`) in [369af13](https://github.com/maplibre/maplibre-native/commit/369af13ead1b); moved into `jaxa/` and extended with the z0-z9 set the skirts tests need. |
