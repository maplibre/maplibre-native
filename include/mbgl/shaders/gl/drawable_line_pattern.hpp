...
mediump vec4 pattern_to = u_pattern_to;
    ...
    static constexpr const char* fragmentData = R"(layout (std140) uniform LinePatternUBO {
    highp mat4 u_matrix;
    mediump vec4 u_scale;
    highp vec2 u_texsize;
    highp vec2 u_units_to_pixels;
...
lowp float opacity = u_opacity;
    ...
    static std::string vertex() {
        using Ty = ShaderSource<BuiltIn::LinePatternShader, gfx::Backend::Type::OpenGL>;
