...
mediump vec4 pattern_to = u_pattern_to;
    ...
    static constexpr const char* fragmentData = R"(layout (std140) uniform FillPatternDrawableUBO {
    highp mat4 u_matrix;
    highp vec4 u_scale;
    highp vec2 u_pixel_coord_upper;
    highp vec2 u_pixel_coord_lower;
...
mediump vec4 pattern_to = u_pattern_to;
    ...
    static std::string vertex() {
        using Ty = ShaderSource<BuiltIn::FillPatternShader, gfx::Backend::Type::OpenGL>;
