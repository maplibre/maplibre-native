...
struct VertexStage {
    ...
    float2 edge_distance [[attribute(fillExtrusionUBOCount + 2)]];

#if !defined(HAS_UNIFORM_u_color)
    float4 color [[attribute(fillExtrusionUBOCount + 3)]];
#endif
#if !defined(HAS_UNIFORM_u_base)
    float base [[attribute(fillExtrusionUBOCount + 4)]];
#endif
#if !defined(HAS_UNIFORM_u_height)
    float height [[attribute(fillExtrusionUBOCount + 5)]];
#endif
};
...
struct VertexStage {
    ...
    ushort4 pattern_from [[attribute(fillExtrusionUBOCount + 5)]];
#endif
#if !defined(HAS_UNIFORM_u_pattern_to)
    ushort4 pattern_to [[attribute(fillExtrusionUBOCount + 6)]];
#endif
};
