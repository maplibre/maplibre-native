...
public:
    ...
    EstablishedActor(Scheduler& scheduler, AspiringActor<Object>& parent_, Args&&... args) : parent(parent_) {
    ...
    EstablishedActor(Scheduler& scheduler, AspiringActor<Object>& parent_, ArgsTuple&& args) : parent(parent_) {
