...
std::map<GlyphTypeWrap, InternalHBLangInfo> HBShaperWrap::internalInfos = {
    {GlyphTypeWrap::KhmerWrap, {"kh", HB_SCRIPT_KHMER, HB_DIRECTION_LTR}},
    {GlyphTypeWrap::MyanmarWrap, {"my", HB_SCRIPT_MYANMAR, HB_DIRECTION_LTR}},
    {GlyphTypeWrap::DevanagariWrap, {"hi", HB_SCRIPT_DEVANAGARI, HB_DIRECTION_LTR}},
};
...
void HBShaperWrap::CreateComplexGlyphIDs(const std::string &text,
