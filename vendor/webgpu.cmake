...
if(MLN_WITH_WEBGPU)
    ...
    if(MLN_WEBGPU_IMPL_DAWN)
        ...
        target_compile_definitions(mbgl-core PUBLIC MLN_WEBGPU_IMPL_DAWN)
        if(MLN_WEBGPU_EMDAWN)
            message(STATUS "Using emdawnwebgpu port for browser WebGPU")
            target_compile_definitions(mbgl-core PUBLIC MLN_WEBGPU_EMDAWN)
        endif()

    elseif(MLN_WEBGPU_IMPL_WGPU)
        message(STATUS "Using wgpu as WebGPU backend")
        target_compile_definitions(mbgl-core PUBLIC MLN_WEBGPU_IMPL_WGPU)
    else()
        message(FATAL_ERROR "MLN_WEBGPU_IMPL_DAWN or MLN_WEBGPU_IMPL_WGPU must be set")
    endif()

    if(MLN_WEBGPU_IMPL_FFI)
        target_compile_definitions(mbgl-core PUBLIC MLN_WEBGPU_IMPL_FFI)
    endif()
endif()
