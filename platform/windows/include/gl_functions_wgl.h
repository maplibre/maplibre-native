...
PFNGLRENDERBUFFERSTORAGEMULTISAMPLEPROC wgl_glRenderbufferStorageMultisample =
    NULL;
...
void loadWGL() {
  ...
  wgl_wglGetProcAddress = (PFNWGLLOADERWGLGETPROCADDRESSPROC)GetProcAddress(
      opengl32, "wglGetProcAddress");

  /* OpenGL ES 2.0 */

  wgl_glActiveTexture =
      (PFNGLACTIVETEXTUREPROC)wgl_GetProcAddress("glActiveTexture");
  wgl_glAttachShader =
      (PFNGLATTACHSHADERPROC)wgl_GetProcAddress("glAttachShader");
  wgl_glBindAttribLocation =
      (PFNGLBINDATTRIBLOCATIONPROC)wgl_GetProcAddress("glBindAttribLocation");
  wgl_glBindBuffer = (PFNGLBINDBUFFERPROC)wgl_GetProcAddress("glBindBuffer");
  wgl_glBindFramebuffer =
      (PFNGLBINDFRAMEBUFFERPROC)wgl_GetProcAddress("glBindFramebuffer");
  wgl_glBindRenderbuffer =
      (PFNGLBINDRENDERBUFFERPROC)wgl_GetProcAddress("glBindRenderbuffer");
  ...
  wgl_glBlendEquation =
      (PFNGLBLENDEQUATIONPROC)wgl_GetProcAddress("glBlendEquation");
  wgl_glBlendEquationSeparate =
      (PFNGLBLENDEQUATIONSEPARATEPROC)wgl_GetProcAddress(
          "glBlendEquationSeparate");
  wgl_glBlendFunc = (PFNGLBLENDFUNCPROC)wgl_GetProcAddress("glBlendFunc");
  wgl_glBlendFuncSeparate =
      (PFNGLBLENDFUNCSEPARATEPROC)wgl_GetProcAddress("glBlendFuncSeparate");
  wgl_glBufferData = (PFNGLBUFFERDATAPROC)wgl_GetProcAddress("glBufferData");
  wgl_glBufferSubData =
      (PFNGLBUFFERSUBDATAPROC)wgl_GetProcAddress("glBufferSubData");
  wgl_glCheckFramebufferStatus =
      (PFNGLCHECKFRAMEBUFFERSTATUSPROC)wgl_GetProcAddress(
  ...
  wgl_glClearStencil =
      (PFNGLCLEARSTENCILPROC)wgl_GetProcAddress("glClearStencil");
  wgl_glColorMask = (PFNGLCOLORMASKPROC)wgl_GetProcAddress("glColorMask");
  wgl_glCompileShader =
      (PFNGLCOMPILESHADERPROC)wgl_GetProcAddress("glCompileShader");
  wgl_glCompressedTexImage2D =
      (PFNGLCOMPRESSEDTEXIMAGE2DPROC)wgl_GetProcAddress(
          "glCompressedTexImage2D");
  wgl_glCompressedTexSubImage2D =
      (PFNGLCOMPRESSEDTEXSUBIMAGE2DPROC)wgl_GetProcAddress(
          "glCompressedTexSubImage2D");
  wgl_glCopyTexImage2D =
      (PFNGLCOPYTEXIMAGE2DPROC)wgl_GetProcAddress("glCopyTexImage2D");
  wgl_glCopyTexSubImage2D =
      (PFNGLCOPYTEXSUBIMAGE2DPROC)wgl_GetProcAddress("glCopyTexSubImage2D");
  wgl_glCreateProgram =
      (PFNGLCREATEPROGRAMPROC)wgl_GetProcAddress("glCreateProgram");
  wgl_glCreateShader =
      (PFNGLCREATESHADERPROC)wgl_GetProcAddress("glCreateShader");
  wgl_glCullFace = (PFNGLCULLFACEPROC)wgl_GetProcAddress("glCullFace");
  wgl_glDeleteBuffers =
      (PFNGLDELETEBUFFERSPROC)wgl_GetProcAddress("glDeleteBuffers");
  wgl_glDeleteFramebuffers =
      (PFNGLDELETEFRAMEBUFFERSPROC)wgl_GetProcAddress("glDeleteFramebuffers");
  wgl_glDeleteProgram =
      (PFNGLDELETEPROGRAMPROC)wgl_GetProcAddress("glDeleteProgram");
  wgl_glDeleteRenderbuffers =
      (PFNGLDELETERENDERBUFFERSPROC)wgl_GetProcAddress("glDeleteRenderbuffers");
  wgl_glDeleteShader =
      (PFNGLDELETESHADERPROC)wgl_GetProcAddress("glDeleteShader");
  wgl_glDeleteTextures =
      (PFNGLDELETETEXTURESPROC)wgl_GetProcAddress("glDeleteTextures");
  ...
  wgl_glDetachShader =
      (PFNGLDETACHSHADERPROC)wgl_GetProcAddress("glDetachShader");
  wgl_glDisable = (PFNGLDISABLEPROC)wgl_GetProcAddress("glDisable");
  wgl_glDisableVertexAttribArray =
      (PFNGLDISABLEVERTEXATTRIBARRAYPROC)wgl_GetProcAddress(
          "glDisableVertexAttribArray");
  wgl_glDrawArrays = (PFNGLDRAWARRAYSPROC)wgl_GetProcAddress("glDrawArrays");
  wgl_glDrawElements =
      (PFNGLDRAWELEMENTSPROC)wgl_GetProcAddress("glDrawElements");
  wgl_glEnable = (PFNGLENABLEPROC)wgl_GetProcAddress("glEnable");
  wgl_glEnableVertexAttribArray =
      (PFNGLENABLEVERTEXATTRIBARRAYPROC)wgl_GetProcAddress(
          "glEnableVertexAttribArray");
  wgl_glFinish = (PFNGLFINISHPROC)wgl_GetProcAddress("glFinish");
  wgl_glFlush = (PFNGLFLUSHPROC)wgl_GetProcAddress("glFlush");
  wgl_glFramebufferRenderbuffer =
      (PFNGLFRAMEBUFFERRENDERBUFFERPROC)wgl_GetProcAddress(
          "glFramebufferRenderbuffer");
  wgl_glFramebufferTexture2D =
  ...
  wgl_glGenerateMipmap =
      (PFNGLGENERATEMIPMAPPROC)wgl_GetProcAddress("glGenerateMipmap");
  wgl_glGenFramebuffers =
      (PFNGLGENFRAMEBUFFERSPROC)wgl_GetProcAddress("glGenFramebuffers");
  wgl_glGenRenderbuffers =
      (PFNGLGENRENDERBUFFERSPROC)wgl_GetProcAddress("glGenRenderbuffers");
  wgl_glGenTextures = (PFNGLGENTEXTURESPROC)wgl_GetProcAddress("glGenTextures");
  wgl_glGetActiveAttrib =
      (PFNGLGETACTIVEATTRIBPROC)wgl_GetProcAddress("glGetActiveAttrib");
  wgl_glGetActiveUniform =
      (PFNGLGETACTIVEUNIFORMPROC)wgl_GetProcAddress("glGetActiveUniform");
  wgl_glGetAttachedShaders =
      (PFNGLGETATTACHEDSHADERSPROC)wgl_GetProcAddress("glGetAttachedShaders");
  wgl_glGetAttribLocation =
      (PFNGLGETATTRIBLOCATIONPROC)wgl_GetProcAddress("glGetAttribLocation");
  wgl_glGetBooleanv = (PFNGLGETBOOLEANVPROC)wgl_GetProcAddress("glGetBooleanv");
  wgl_glGetBufferParameteriv =
      (PFNGLGETBUFFERPARAMETERIVPROC)wgl_GetProcAddress(
  ...
  wgl_glGetFramebufferAttachmentParameteriv =
      (PFNGLGETFRAMEBUFFERATTACHMENTPARAMETERIVPROC)wgl_GetProcAddress(
          "glGetFramebufferAttachmentParameteriv");
  wgl_glGetIntegerv = (PFNGLGETINTEGERVPROC)wgl_GetProcAddress("glGetIntegerv");
  wgl_glGetProgramInfoLog =
      (PFNGLGETPROGRAMINFOLOGPROC)wgl_GetProcAddress("glGetProgramInfoLog");
  wgl_glGetProgramiv =
      (PFNGLGETPROGRAMIVPROC)wgl_GetProcAddress("glGetProgramiv");
  wgl_glGetRenderbufferParameteriv =
      (PFNGLGETRENDERBUFFERPARAMETERIVPROC)wgl_GetProcAddress(
          "glGetRenderbufferParameteriv");
  wgl_glGetShaderInfoLog =
      (PFNGLGETSHADERINFOLOGPROC)wgl_GetProcAddress("glGetShaderInfoLog");
  wgl_glGetShaderiv = (PFNGLGETSHADERIVPROC)wgl_GetProcAddress("glGetShaderiv");
  wgl_glGetShaderPrecisionFormat =
      (PFNGLGETSHADERPRECISIONFORMATPROC)wgl_GetProcAddress(
          "glGetShaderPrecisionFormat");
  wgl_glGetShaderSource =
      (PFNGLGETSHADERSOURCEPROC)wgl_GetProcAddress("glGetShaderSource");
  wgl_glGetString = (PFNGLGETSTRINGPROC)wgl_GetProcAddress("glGetString");
  wgl_glGetTexParameterfv =
      (PFNGLGETTEXPARAMETERFVPROC)wgl_GetProcAddress("glGetTexParameterfv");
  wgl_glGetTexParameteriv =
      (PFNGLGETTEXPARAMETERIVPROC)wgl_GetProcAddress("glGetTexParameteriv");
  wgl_glGetUniformfv =
      (PFNGLGETUNIFORMFVPROC)wgl_GetProcAddress("glGetUniformfv");
  wgl_glGetUniformiv =
      (PFNGLGETUNIFORMIVPROC)wgl_GetProcAddress("glGetUniformiv");
  wgl_glGetUniformLocation =
      (PFNGLGETUNIFORMLOCATIONPROC)wgl_GetProcAddress("glGetUniformLocation");
  wgl_glGetVertexAttribfv =
      (PFNGLGETVERTEXATTRIBFVPROC)wgl_GetProcAddress("glGetVertexAttribfv");
  wgl_glGetVertexAttribiv =
      (PFNGLGETVERTEXATTRIBIVPROC)wgl_GetProcAddress("glGetVertexAttribiv");
  wgl_glGetVertexAttribPointerv =
      (PFNGLGETVERTEXATTRIBPOINTERVPROC)wgl_GetProcAddress(
  ...
  wgl_glIsFramebuffer =
      (PFNGLISFRAMEBUFFERPROC)wgl_GetProcAddress("glIsFramebuffer");
  wgl_glIsProgram = (PFNGLISPROGRAMPROC)wgl_GetProcAddress("glIsProgram");
  wgl_glIsRenderbuffer =
      (PFNGLISRENDERBUFFERPROC)wgl_GetProcAddress("glIsRenderbuffer");
  ...
  wgl_glPolygonOffset =
      (PFNGLPOLYGONOFFSETPROC)wgl_GetProcAddress("glPolygonOffset");
  wgl_glReadPixels = (PFNGLREADPIXELSPROC)wgl_GetProcAddress("glReadPixels");
  wgl_glReleaseShaderCompiler =
      (PFNGLRELEASESHADERCOMPILERPROC)wgl_GetProcAddress(
          "glReleaseShaderCompiler");
  wgl_glRenderbufferStorage =
      (PFNGLRENDERBUFFERSTORAGEPROC)wgl_GetProcAddress("glRenderbufferStorage");
  wgl_glSampleCoverage =
      (PFNGLSAMPLECOVERAGEPROC)wgl_GetProcAddress("glSampleCoverage");
  wgl_glScissor = (PFNGLSCISSORPROC)wgl_GetProcAddress("glScissor");
  wgl_glShaderBinary =
      (PFNGLSHADERBINARYPROC)wgl_GetProcAddress("glShaderBinary");
  wgl_glShaderSource =
      (PFNGLSHADERSOURCEPROC)wgl_GetProcAddress("glShaderSource");
  wgl_glStencilFunc = (PFNGLSTENCILFUNCPROC)wgl_GetProcAddress("glStencilFunc");
  wgl_glStencilFuncSeparate =
      (PFNGLSTENCILFUNCSEPARATEPROC)wgl_GetProcAddress("glStencilFuncSeparate");
  wgl_glStencilMask = (PFNGLSTENCILMASKPROC)wgl_GetProcAddress("glStencilMask");
  wgl_glStencilMaskSeparate =
      (PFNGLSTENCILMASKSEPARATEPROC)wgl_GetProcAddress("glStencilMaskSeparate");
  wgl_glStencilOp = (PFNGLSTENCILOPPROC)wgl_GetProcAddress("glStencilOp");
  wgl_glStencilOpSeparate =
      (PFNGLSTENCILOPSEPARATEPROC)wgl_GetProcAddress("glStencilOpSeparate");
  wgl_glTexImage2D = (PFNGLTEXIMAGE2DPROC)wgl_GetProcAddress("glTexImage2D");
  wgl_glTexParameterf =
      (PFNGLTEXPARAMETERFPROC)wgl_GetProcAddress("glTexParameterf");
  wgl_glTexParameterfv =
      (PFNGLTEXPARAMETERFVPROC)wgl_GetProcAddress("glTexParameterfv");
  wgl_glTexParameteri =
      (PFNGLTEXPARAMETERIPROC)wgl_GetProcAddress("glTexParameteri");
  wgl_glTexParameteriv =
      (PFNGLTEXPARAMETERIVPROC)wgl_GetProcAddress("glTexParameteriv");
  wgl_glTexSubImage2D =
      (PFNGLTEXSUBIMAGE2DPROC)wgl_GetProcAddress("glTexSubImage2D");
  ...
  wgl_glUniformMatrix2fv =
      (PFNGLUNIFORMMATRIX2FVPROC)wgl_GetProcAddress("glUniformMatrix2fv");
  wgl_glUniformMatrix3fv =
      (PFNGLUNIFORMMATRIX3FVPROC)wgl_GetProcAddress("glUniformMatrix3fv");
  wgl_glUniformMatrix4fv =
      (PFNGLUNIFORMMATRIX4FVPROC)wgl_GetProcAddress("glUniformMatrix4fv");
  wgl_glUseProgram = (PFNGLUSEPROGRAMPROC)wgl_GetProcAddress("glUseProgram");
  wgl_glValidateProgram =
      (PFNGLVALIDATEPROGRAMPROC)wgl_GetProcAddress("glValidateProgram");
  wgl_glVertexAttrib1f =
      (PFNGLVERTEXATTRIB1FPROC)wgl_GetProcAddress("glVertexAttrib1f");
  wgl_glVertexAttrib1fv =
      (PFNGLVERTEXATTRIB1FVPROC)wgl_GetProcAddress("glVertexAttrib1fv");
  wgl_glVertexAttrib2f =
      (PFNGLVERTEXATTRIB2FPROC)wgl_GetProcAddress("glVertexAttrib2f");
  wgl_glVertexAttrib2fv =
      (PFNGLVERTEXATTRIB2FVPROC)wgl_GetProcAddress("glVertexAttrib2fv");
  wgl_glVertexAttrib3f =
      (PFNGLVERTEXATTRIB3FPROC)wgl_GetProcAddress("glVertexAttrib3f");
  wgl_glVertexAttrib3fv =
      (PFNGLVERTEXATTRIB3FVPROC)wgl_GetProcAddress("glVertexAttrib3fv");
  wgl_glVertexAttrib4f =
      (PFNGLVERTEXATTRIB4FPROC)wgl_GetProcAddress("glVertexAttrib4f");
  wgl_glVertexAttrib4fv =
      (PFNGLVERTEXATTRIB4FVPROC)wgl_GetProcAddress("glVertexAttrib4fv");
  wgl_glVertexAttribPointer =
      (PFNGLVERTEXATTRIBPOINTERPROC)wgl_GetProcAddress("glVertexAttribPointer");
  ...
  wgl_glDrawRangeElements =
      (PFNGLDRAWRANGEELEMENTSPROC)wgl_GetProcAddress("glDrawRangeElements");
  wgl_glTexImage3D = (PFNGLTEXIMAGE3DPROC)wgl_GetProcAddress("glTexImage3D");
  wgl_glTexSubImage3D =
      (PFNGLTEXSUBIMAGE3DPROC)wgl_GetProcAddress("glTexSubImage3D");
  wgl_glCopyTexSubImage3D =
      (PFNGLCOPYTEXSUBIMAGE3DPROC)wgl_GetProcAddress("glCopyTexSubImage3D");
  wgl_glCompressedTexImage3D =
      (PFNGLCOMPRESSEDTEXIMAGE3DPROC)wgl_GetProcAddress(
          "glCompressedTexImage3D");
  wgl_glCompressedTexSubImage3D =
      (PFNGLCOMPRESSEDTEXSUBIMAGE3DPROC)wgl_GetProcAddress(
          "glCompressedTexSubImage3D");
  wgl_glGenQueries = (PFNGLGENQUERIESPROC)wgl_GetProcAddress("glGenQueries");
  wgl_glDeleteQueries =
      (PFNGLDELETEQUERIESPROC)wgl_GetProcAddress("glDeleteQueries");
  ...
  wgl_glGetQueryObjectuiv =
      (PFNGLGETQUERYOBJECTUIVPROC)wgl_GetProcAddress("glGetQueryObjectuiv");
  wgl_glUnmapBuffer = (PFNGLUNMAPBUFFERPROC)wgl_GetProcAddress("glUnmapBuffer");
  wgl_glGetBufferPointerv =
      (PFNGLGETBUFFERPOINTERVPROC)wgl_GetProcAddress("glGetBufferPointerv");
  wgl_glDrawBuffers = (PFNGLDRAWBUFFERSPROC)wgl_GetProcAddress("glDrawBuffers");
  wgl_glUniformMatrix2x3fv =
      (PFNGLUNIFORMMATRIX2X3FVPROC)wgl_GetProcAddress("glUniformMatrix2x3fv");
  wgl_glUniformMatrix3x2fv =
      (PFNGLUNIFORMMATRIX3X2FVPROC)wgl_GetProcAddress("glUniformMatrix3x2fv");
  wgl_glUniformMatrix2x4fv =
      (PFNGLUNIFORMMATRIX2X4FVPROC)wgl_GetProcAddress("glUniformMatrix2x4fv");
  wgl_glUniformMatrix4x2fv =
      (PFNGLUNIFORMMATRIX4X2FVPROC)wgl_GetProcAddress("glUniformMatrix4x2fv");
  wgl_glUniformMatrix3x4fv =
      (PFNGLUNIFORMMATRIX3X4FVPROC)wgl_GetProcAddress("glUniformMatrix3x4fv");
  wgl_glUniformMatrix4x3fv =
      (PFNGLUNIFORMMATRIX4X3FVPROC)wgl_GetProcAddress("glUniformMatrix4x3fv");
  wgl_glBlitFramebuffer =
      (PFNGLBLITFRAMEBUFFERPROC)wgl_GetProcAddress("glBlitFramebuffer");
  wgl_glRenderbufferStorageMultisample =
      (PFNGLRENDERBUFFERSTORAGEMULTISAMPLEPROC)wgl_GetProcAddress(
          "glRenderbufferStorageMultisample");
  wgl_glFramebufferTextureLayer =
      (PFNGLFRAMEBUFFERTEXTURELAYERPROC)wgl_GetProcAddress(
          "glFramebufferTextureLayer");
  wgl_glMapBufferRange =
      (PFNGLMAPBUFFERRANGEPROC)wgl_GetProcAddress("glMapBufferRange");
  wgl_glFlushMappedBufferRange =
      (PFNGLFLUSHMAPPEDBUFFERRANGEPROC)wgl_GetProcAddress(
          "glFlushMappedBufferRange");
  wgl_glBindVertexArray =
      (PFNGLBINDVERTEXARRAYPROC)wgl_GetProcAddress("glBindVertexArray");
  wgl_glDeleteVertexArrays =
      (PFNGLDELETEVERTEXARRAYSPROC)wgl_GetProcAddress("glDeleteVertexArrays");
  wgl_glGenVertexArrays =
      (PFNGLGENVERTEXARRAYSPROC)wgl_GetProcAddress("glGenVertexArrays");
  wgl_glIsVertexArray =
      (PFNGLISVERTEXARRAYPROC)wgl_GetProcAddress("glIsVertexArray");
  wgl_glGetIntegeri_v =
      (PFNGLGETINTEGERI_VPROC)wgl_GetProcAddress("glGetIntegeri_v");
  wgl_glBeginTransformFeedback =
      (PFNGLBEGINTRANSFORMFEEDBACKPROC)wgl_GetProcAddress(
          "glBeginTransformFeedback");
  wgl_glEndTransformFeedback =
      (PFNGLENDTRANSFORMFEEDBACKPROC)wgl_GetProcAddress(
          "glEndTransformFeedback");
  wgl_glBindBufferRange =
      (PFNGLBINDBUFFERRANGEPROC)wgl_GetProcAddress("glBindBufferRange");
  wgl_glBindBufferBase =
      (PFNGLBINDBUFFERBASEPROC)wgl_GetProcAddress("glBindBufferBase");
  wgl_glTransformFeedbackVaryings =
      (PFNGLTRANSFORMFEEDBACKVARYINGSPROC)wgl_GetProcAddress(
          "glTransformFeedbackVaryings");
  wgl_glGetTransformFeedbackVarying =
      (PFNGLGETTRANSFORMFEEDBACKVARYINGPROC)wgl_GetProcAddress(
          "glGetTransformFeedbackVarying");
  wgl_glVertexAttribIPointer =
      (PFNGLVERTEXATTRIBIPOINTERPROC)wgl_GetProcAddress(
          "glVertexAttribIPointer");
  wgl_glGetVertexAttribIiv =
      (PFNGLGETVERTEXATTRIBIIVPROC)wgl_GetProcAddress("glGetVertexAttribIiv");
  wgl_glGetVertexAttribIuiv =
      (PFNGLGETVERTEXATTRIBIUIVPROC)wgl_GetProcAddress("glGetVertexAttribIuiv");
  wgl_glVertexAttribI4i =
      (PFNGLVERTEXATTRIBI4IPROC)wgl_GetProcAddress("glVertexAttribI4i");
  wgl_glVertexAttribI4ui =
      (PFNGLVERTEXATTRIBI4UIPROC)wgl_GetProcAddress("glVertexAttribI4ui");
  wgl_glVertexAttribI4iv =
      (PFNGLVERTEXATTRIBI4IVPROC)wgl_GetProcAddress("glVertexAttribI4iv");
  wgl_glVertexAttribI4uiv =
      (PFNGLVERTEXATTRIBI4UIVPROC)wgl_GetProcAddress("glVertexAttribI4uiv");
  wgl_glGetUniformuiv =
      (PFNGLGETUNIFORMUIVPROC)wgl_GetProcAddress("glGetUniformuiv");
  wgl_glGetFragDataLocation =
      (PFNGLGETFRAGDATALOCATIONPROC)wgl_GetProcAddress("glGetFragDataLocation");
  ...
  wgl_glClearBufferiv =
      (PFNGLCLEARBUFFERIVPROC)wgl_GetProcAddress("glClearBufferiv");
  wgl_glClearBufferuiv =
      (PFNGLCLEARBUFFERUIVPROC)wgl_GetProcAddress("glClearBufferuiv");
  wgl_glClearBufferfv =
      (PFNGLCLEARBUFFERFVPROC)wgl_GetProcAddress("glClearBufferfv");
  wgl_glClearBufferfi =
      (PFNGLCLEARBUFFERFIPROC)wgl_GetProcAddress("glClearBufferfi");
  wgl_glGetStringi = (PFNGLGETSTRINGIPROC)wgl_GetProcAddress("glGetStringi");
  wgl_glCopyBufferSubData =
      (PFNGLCOPYBUFFERSUBDATAPROC)wgl_GetProcAddress("glCopyBufferSubData");
  wgl_glGetUniformIndices =
      (PFNGLGETUNIFORMINDICESPROC)wgl_GetProcAddress("glGetUniformIndices");
  wgl_glGetActiveUniformsiv =
      (PFNGLGETACTIVEUNIFORMSIVPROC)wgl_GetProcAddress("glGetActiveUniformsiv");
  wgl_glGetUniformBlockIndex =
      (PFNGLGETUNIFORMBLOCKINDEXPROC)wgl_GetProcAddress(
          "glGetUniformBlockIndex");
  wgl_glGetActiveUniformBlockiv =
      (PFNGLGETACTIVEUNIFORMBLOCKIVPROC)wgl_GetProcAddress(
          "glGetActiveUniformBlockiv");
  wgl_glGetActiveUniformBlockName =
      (PFNGLGETACTIVEUNIFORMBLOCKNAMEPROC)wgl_GetProcAddress(
          "glGetActiveUniformBlockName");
  wgl_glUniformBlockBinding =
      (PFNGLUNIFORMBLOCKBINDINGPROC)wgl_GetProcAddress("glUniformBlockBinding");
  wgl_glDrawArraysInstanced =
      (PFNGLDRAWARRAYSINSTANCEDPROC)wgl_GetProcAddress("glDrawArraysInstanced");
  wgl_glDrawElementsInstanced =
      (PFNGLDRAWELEMENTSINSTANCEDPROC)wgl_GetProcAddress(
  ...
  wgl_glClientWaitSync =
      (PFNGLCLIENTWAITSYNCPROC)wgl_GetProcAddress("glClientWaitSync");
  wgl_glWaitSync = (PFNGLWAITSYNCPROC)wgl_GetProcAddress("glWaitSync");
  wgl_glGetInteger64v =
      (PFNGLGETINTEGER64VPROC)wgl_GetProcAddress("glGetInteger64v");
  wgl_glGetSynciv = (PFNGLGETSYNCIVPROC)wgl_GetProcAddress("glGetSynciv");
  wgl_glGetInteger64i_v =
      (PFNGLGETINTEGER64I_VPROC)wgl_GetProcAddress("glGetInteger64i_v");
  wgl_glGetBufferParameteri64v =
      (PFNGLGETBUFFERPARAMETERI64VPROC)wgl_GetProcAddress(
          "glGetBufferParameteri64v");
  wgl_glGenSamplers = (PFNGLGENSAMPLERSPROC)wgl_GetProcAddress("glGenSamplers");
  wgl_glDeleteSamplers =
      (PFNGLDELETESAMPLERSPROC)wgl_GetProcAddress("glDeleteSamplers");
  ...
  wgl_glSamplerParameteri =
      (PFNGLSAMPLERPARAMETERIPROC)wgl_GetProcAddress("glSamplerParameteri");
  wgl_glSamplerParameteriv =
      (PFNGLSAMPLERPARAMETERIVPROC)wgl_GetProcAddress("glSamplerParameteriv");
  wgl_glSamplerParameterf =
      (PFNGLSAMPLERPARAMETERFPROC)wgl_GetProcAddress("glSamplerParameterf");
  wgl_glSamplerParameterfv =
      (PFNGLSAMPLERPARAMETERFVPROC)wgl_GetProcAddress("glSamplerParameterfv");
  wgl_glGetSamplerParameteriv =
      (PFNGLGETSAMPLERPARAMETERIVPROC)wgl_GetProcAddress(
          "glGetSamplerParameteriv");
  wgl_glGetSamplerParameterfv =
      (PFNGLGETSAMPLERPARAMETERFVPROC)wgl_GetProcAddress(
          "glGetSamplerParameterfv");
  wgl_glVertexAttribDivisor =
      (PFNGLVERTEXATTRIBDIVISORPROC)wgl_GetProcAddress("glVertexAttribDivisor");
  wgl_glBindTransformFeedback =
      (PFNGLBINDTRANSFORMFEEDBACKPROC)wgl_GetProcAddress(
          "glBindTransformFeedback");
  wgl_glDeleteTransformFeedbacks =
      (PFNGLDELETETRANSFORMFEEDBACKSPROC)wgl_GetProcAddress(
          "glDeleteTransformFeedbacks");
  wgl_glGenTransformFeedbacks =
      (PFNGLGENTRANSFORMFEEDBACKSPROC)wgl_GetProcAddress(
          "glGenTransformFeedbacks");
  wgl_glIsTransformFeedback =
      (PFNGLISTRANSFORMFEEDBACKPROC)wgl_GetProcAddress("glIsTransformFeedback");
  wgl_glPauseTransformFeedback =
      (PFNGLPAUSETRANSFORMFEEDBACKPROC)wgl_GetProcAddress(
          "glPauseTransformFeedback");
  wgl_glResumeTransformFeedback =
      (PFNGLRESUMETRANSFORMFEEDBACKPROC)wgl_GetProcAddress(
          "glResumeTransformFeedback");
  wgl_glGetProgramBinary =
      (PFNGLGETPROGRAMBINARYPROC)wgl_GetProcAddress("glGetProgramBinary");
  wgl_glProgramBinary =
      (PFNGLPROGRAMBINARYPROC)wgl_GetProcAddress("glProgramBinary");
  wgl_glProgramParameteri =
      (PFNGLPROGRAMPARAMETERIPROC)wgl_GetProcAddress("glProgramParameteri");
  wgl_glInvalidateFramebuffer =
      (PFNGLINVALIDATEFRAMEBUFFERPROC)wgl_GetProcAddress(
          "glInvalidateFramebuffer");
  wgl_glInvalidateSubFramebuffer =
      (PFNGLINVALIDATESUBFRAMEBUFFERPROC)wgl_GetProcAddress(
          "glInvalidateSubFramebuffer");
  wgl_glTexStorage2D =
      (PFNGLTEXSTORAGE2DPROC)wgl_GetProcAddress("glTexStorage2D");
  wgl_glTexStorage3D =
      (PFNGLTEXSTORAGE3DPROC)wgl_GetProcAddress("glTexStorage3D");
  wgl_glGetInternalformativ =
      (PFNGLGETINTERNALFORMATIVPROC)wgl_GetProcAddress("glGetInternalformativ");

  /* OpenGL Windows Extensions */

  wgl_wglChoosePixelFormatARB =
      (PFNWGLCHOOSEPIXELFORMATARBPROC)wgl_GetProcAddress(
          "wglChoosePixelFormatARB");
  wgl_wglCreateContextAttribsARB =
      (PFNWGLCREATECONTEXTATTRIBSARBPROC)wgl_GetProcAddress(
          "wglCreateContextAttribsARB");
  wgl_wglGetExtensionsStringARB =
      (PFNWGLGETEXTENSIONSSTRINGARBPROC)wgl_GetProcAddress(
          "wglGetExtensionsStringARB");
  wgl_wglGetExtensionsStringEXT =
      (PFNWGLGETEXTENSIONSSTRINGEXTPROC)wgl_GetProcAddress(
...
void (*const glAttachShader)(GLuint, GLuint) = [](GLuint program,
                                                  GLuint shader) {
  if (!opengl32) loadWGL();
...
void (*const glBindFramebuffer)(GLenum, GLuint) = [](GLenum target,
                                                     GLuint framebuffer) {
  if (!opengl32) loadWGL();
  ::wgl_glBindFramebuffer(target, framebuffer);
};
void (*const glBindRenderbuffer)(GLenum, GLuint) = [](GLenum target,
                                                      GLuint renderbuffer) {
  if (!opengl32) loadWGL();
  ::wgl_glBindRenderbuffer(target, renderbuffer);
};
void (*const glBindTexture)(GLenum, GLuint) = [](GLenum target,
                                                 GLuint texture) {
  if (!opengl32) loadWGL();
...
void (*const glBlendEquationSeparate)(GLenum, GLenum) = [](GLenum modeRGB,
                                                           GLenum modeAlpha) {
  if (!opengl32) loadWGL();
...
void (*const glBlendFuncSeparate)(GLenum, GLenum, GLenum, GLenum) =
    [](GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha,
       GLenum dfactorAlpha) {
      if (!opengl32) loadWGL();
      ::wgl_glBlendFuncSeparate(sfactorRGB, dfactorRGB, sfactorAlpha,
                                dfactorAlpha);
    };
...
void (*const glCompressedTexImage2D)(GLenum, GLint, GLenum, GLsizei, GLsizei,
                                     GLint, GLsizei, const void*) =
    [](GLenum target, GLint level, GLenum internalformat, GLsizei width,
       GLsizei height, GLint border, GLsizei imageSize, const void* data) {
      if (!opengl32) loadWGL();
      ::wgl_glCompressedTexImage2D(target, level, internalformat, width, height,
                                   border, imageSize, data);
    };
void (*const glCompressedTexSubImage2D)(GLenum, GLint, GLint, GLint, GLsizei,
                                        GLsizei, GLenum, GLsizei, const void*) =
    [](GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width,
       GLsizei height, GLenum format, GLsizei imageSize, const void* data) {
      if (!opengl32) loadWGL();
      ::wgl_glCompressedTexSubImage2D(target, level, xoffset, yoffset, width,
                                      height, format, imageSize, data);
    };
void (*const glCopyTexImage2D)(GLenum, GLint, GLenum, GLint, GLint, GLsizei,
                               GLsizei, GLint) =
    [](GLenum target, GLint level, GLenum internalformat, GLint x, GLint y,
       GLsizei width, GLsizei height, GLint border) {
      if (!opengl32) loadWGL();
      ::wgl_glCopyTexImage2D(target, level, internalformat, x, y, width, height,
                             border);
    };
void (*const glCopyTexSubImage2D)(GLenum, GLint, GLint, GLint, GLint, GLint,
                                  GLsizei, GLsizei) =
    [](GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x,
       GLint y, GLsizei width, GLsizei height) {
      if (!opengl32) loadWGL();
      ::wgl_glCopyTexSubImage2D(target, level, xoffset, yoffset, x, y, width,
                                height);
    };
...
void (*const glDetachShader)(GLuint, GLuint) = [](GLuint program,
                                                  GLuint shader) {
  if (!opengl32) loadWGL();
...
void (*const glFramebufferRenderbuffer)(GLenum, GLenum, GLenum, GLuint) =
    [](GLenum target, GLenum attachment, GLenum renderbuffertarget,
       GLuint renderbuffer) {
      if (!opengl32) loadWGL();
      ::wgl_glFramebufferRenderbuffer(target, attachment, renderbuffertarget,
                                      renderbuffer);
    };
void (*const glFramebufferTexture2D)(GLenum, GLenum, GLenum, GLuint, GLint) =
    [](GLenum target, GLenum attachment, GLenum textarget, GLuint texture,
       GLint level) {
      if (!opengl32) loadWGL();
      ::wgl_glFramebufferTexture2D(target, attachment, textarget, texture,
                                   level);
    };
...
void (*const glGenFramebuffers)(GLsizei, GLuint*) = [](GLsizei n,
                                                       GLuint* framebuffers) {
  if (!opengl32) loadWGL();
  ::wgl_glGenFramebuffers(n, framebuffers);
};
void (*const glGenRenderbuffers)(GLsizei, GLuint*) = [](GLsizei n,
                                                        GLuint* renderbuffers) {
  if (!opengl32) loadWGL();
  ::wgl_glGenRenderbuffers(n, renderbuffers);
};
void (*const glGenTextures)(GLsizei, GLuint*) = [](GLsizei n,
                                                   GLuint* textures) {
  if (!opengl32) loadWGL();
  ::wgl_glGenTextures(n, textures);
};
void (*const glGetActiveAttrib)(GLuint, GLuint, GLsizei, GLsizei*, GLint*,
                                GLenum*,
                                GLchar*) = [](GLuint program, GLuint index,
...
void (*const glGetActiveUniform)(GLuint, GLuint, GLsizei, GLsizei*, GLint*,
                                 GLenum*,
                                 GLchar*) = [](GLuint program, GLuint index,
                                               GLsizei bufSize, GLsizei* length,
                                               GLint* size, GLenum* type,
...
void (*const glGetBooleanv)(GLenum, GLboolean*) = [](GLenum pname,
                                                     GLboolean* data) {
  if (!opengl32) loadWGL();
...
void (*const glGetFramebufferAttachmentParameteriv)(GLenum, GLenum, GLenum,
                                                    GLint*) =
    [](GLenum target, GLenum attachment, GLenum pname, GLint* params) {
      if (!opengl32) loadWGL();
      ::wgl_glGetFramebufferAttachmentParameteriv(target, attachment, pname,
                                                  params);
    };
...
void (*const glGetShaderPrecisionFormat)(GLenum, GLenum, GLint*, GLint*) =
    [](GLenum shadertype, GLenum precisiontype, GLint* range,
       GLint* precision) {
      if (!opengl32) loadWGL();
      ::wgl_glGetShaderPrecisionFormat(shadertype, precisiontype, range,
                                       precision);
    };
...
void (*const glPolygonOffset)(GLfloat, GLfloat) = [](GLfloat factor,
                                                     GLfloat units) {
  if (!opengl32) loadWGL();
  ::wgl_glPolygonOffset(factor, units);
};
void (*const glReadPixels)(GLint, GLint, GLsizei, GLsizei, GLenum, GLenum,
                           void*) = [](GLint x, GLint y, GLsizei width,
...
void (*const glSampleCoverage)(GLfloat, GLboolean) = [](GLfloat value,
                                                        GLboolean invert) {
  if (!opengl32) loadWGL();
...
void (*const glShaderBinary)(GLsizei, const GLuint*, GLenum, const GLvoid*,
                             GLsizei) =
...
void (*const glShaderSource)(GLuint, GLsizei, const GLchar* const*,
                             const GLint*) = [](GLuint shader, GLsizei count,
                                                const GLchar* const* string,
                                                const GLint* length) {
  if (!opengl32) loadWGL();
  ::wgl_glShaderSource(shader, count, string, length);
};
void (*const glStencilFunc)(GLenum, GLint, GLuint) = [](GLenum func, GLint ref,
                                                        GLuint mask) {
  if (!opengl32) loadWGL();
...
void (*const glStencilMaskSeparate)(GLenum, GLuint) = [](GLenum face,
                                                         GLuint mask) {
  if (!opengl32) loadWGL();
...
void (*const glTexImage2D)(GLenum, GLint, GLint, GLsizei, GLsizei, GLint,
                           GLenum, GLenum, const void*) =
    [](GLenum target, GLint level, GLint internalformat, GLsizei width,
       GLsizei height, GLint border, GLenum format, GLenum type,
       const void* pixels) {
      if (!opengl32) loadWGL();
      ::wgl_glTexImage2D(target, level, internalformat, width, height, border,
                         format, type, pixels);
    };
...
void (*const glTexSubImage2D)(GLenum, GLint, GLint, GLint, GLsizei, GLsizei,
                              GLenum, GLenum, const void*) =
    [](GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width,
       GLsizei height, GLenum format, GLenum type, const void* pixels) {
      if (!opengl32) loadWGL();
      ::wgl_glTexSubImage2D(target, level, xoffset, yoffset, width, height,
                            format, type, pixels);
    };
...
void (*const glUniform2i)(GLint, GLint, GLint) = [](GLint location, GLint v0,
                                                    GLint v1) {
  if (!opengl32) loadWGL();
...
void (*const glVertexAttrib1fv)(GLuint, const GLfloat*) = [](GLuint index,
                                                             const GLfloat* v) {
  if (!opengl32) loadWGL();
...
void (*const glVertexAttrib2fv)(GLuint, const GLfloat*) = [](GLuint index,
                                                             const GLfloat* v) {
  if (!opengl32) loadWGL();
...
void (*const glVertexAttrib3fv)(GLuint, const GLfloat*) = [](GLuint index,
                                                             const GLfloat* v) {
  if (!opengl32) loadWGL();
...
void (*const glVertexAttrib4fv)(GLuint, const GLfloat*) = [](GLuint index,
                                                             const GLfloat* v) {
  if (!opengl32) loadWGL();
  ::wgl_glVertexAttrib4fv(index, v);
};
void (*const glVertexAttribPointer)(GLuint, GLint, GLenum, GLboolean, GLsizei,
                                    const void*) = [](GLuint index, GLint size,
                                                      GLenum type,
...
void (*const glDrawRangeElements)(GLenum, GLuint, GLuint, GLsizei, GLenum,
                                  const GLvoid*) =
...
void (*const glTexImage3D)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei,
                           GLint, GLenum, GLenum, const GLvoid*) =
    [](GLenum target, GLint level, GLint internalformat, GLsizei width,
       GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type,
       const GLvoid* pixels) {
      if (!opengl32) loadWGL();
      ::wgl_glTexImage3D(target, level, internalformat, width, height, depth,
                         border, format, type, pixels);
    };
void (*const glTexSubImage3D)(GLenum, GLint, GLint, GLint, GLint, GLsizei,
                              GLsizei, GLsizei, GLenum, GLenum, const GLvoid*) =
    [](GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset,
       GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type,
       const GLvoid* pixels) {
      if (!opengl32) loadWGL();
      ::wgl_glTexSubImage3D(target, level, xoffset, yoffset, zoffset, width,
                            height, depth, format, type, pixels);
    };
void (*const glCopyTexSubImage3D)(GLenum, GLint, GLint, GLint, GLint, GLint,
                                  GLint, GLsizei, GLsizei) =
    [](GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset,
       GLint x, GLint y, GLsizei width, GLsizei height) {
      if (!opengl32) loadWGL();
      ::wgl_glCopyTexSubImage3D(target, level, xoffset, yoffset, zoffset, x, y,
                                width, height);
    };
void (*const glCompressedTexImage3D)(GLenum, GLint, GLenum, GLsizei, GLsizei,
                                     GLsizei, GLint, GLsizei, const GLvoid*) =
    [](GLenum target, GLint level, GLenum internalformat, GLsizei width,
       GLsizei height, GLsizei depth, GLint border, GLsizei imageSize,
       const GLvoid* data) {
      if (!opengl32) loadWGL();
      ::wgl_glCompressedTexImage3D(target, level, internalformat, width, height,
                                   depth, border, imageSize, data);
    };
void (*const glCompressedTexSubImage3D)(GLenum, GLint, GLint, GLint, GLint,
    ...
    [](GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset,
      ...
      if (!opengl32) loadWGL();
      ::wgl_glCompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset,
...
void (*const glDeleteQueries)(GLsizei, const GLuint*) = [](GLsizei n,
                                                           const GLuint* ids) {
  if (!opengl32) loadWGL();
...
void (*const glDrawBuffers)(GLsizei, const GLenum*) = [](GLsizei n,
                                                         const GLenum* bufs) {
  if (!opengl32) loadWGL();
...
void (*const glBlitFramebuffer)(GLint, GLint, GLint, GLint, GLint, GLint, GLint,
                                GLint, GLbitfield, GLenum) =
    [](GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0,
       GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter) {
      if (!opengl32) loadWGL();
      ::wgl_glBlitFramebuffer(srcX0, srcY0, srcX1, srcY1, dstX0, dstY0, dstX1,
                              dstY1, mask, filter);
    };
void (*const glRenderbufferStorageMultisample)(GLenum, GLsizei, GLenum, GLsizei,
                                               GLsizei) =
    [](GLenum target, GLsizei samples, GLenum internalformat, GLsizei width,
       GLsizei height) {
      if (!opengl32) loadWGL();
      ::wgl_glRenderbufferStorageMultisample(target, samples, internalformat,
                                             width, height);
    };
void (*const glFramebufferTextureLayer)(GLenum, GLenum, GLuint, GLint, GLint) =
    [](GLenum target, GLenum attachment, GLuint texture, GLint level,
       GLint layer) {
      if (!opengl32) loadWGL();
      ::wgl_glFramebufferTextureLayer(target, attachment, texture, level,
                                      layer);
    };
...
void (*const glGenVertexArrays)(GLsizei, GLuint*) = [](GLsizei n,
                                                       GLuint* arrays) {
  if (!opengl32) loadWGL();
...
void (*const glTransformFeedbackVaryings)(GLuint, GLsizei, const GLchar* const*,
                                          GLenum) =
...
void (*const glGetTransformFeedbackVarying)(GLuint, GLuint, GLsizei, GLsizei*,
                                            GLsizei*, GLenum*, GLchar*) =
    [](GLuint program, GLuint index, GLsizei bufSize, GLsizei* length,
       GLsizei* size, GLenum* type, GLchar* name) {
      if (!opengl32) loadWGL();
      ::wgl_glGetTransformFeedbackVarying(program, index, bufSize, length, size,
                                          type, name);
    };
void (*const glVertexAttribIPointer)(GLuint, GLint, GLenum, GLsizei,
                                     const GLvoid*) =
...
void (*const glVertexAttribI4iv)(GLuint, const GLint*) = [](GLuint index,
                                                            const GLint* v) {
  if (!opengl32) loadWGL();
  ::wgl_glVertexAttribI4iv(index, v);
};
void (*const glVertexAttribI4uiv)(GLuint, const GLuint*) = [](GLuint index,
                                                              const GLuint* v) {
  if (!opengl32) loadWGL();
...
void (*const glUniform2ui)(GLint, GLuint, GLuint) = [](GLint location,
                                                       GLuint v0, GLuint v1) {
  if (!opengl32) loadWGL();
...
const GLubyte* (*const glGetStringi)(GLenum, GLuint) = [](GLenum name,
                                                          GLuint index) {
  if (!opengl32) loadWGL();
  return ::wgl_glGetStringi(name, index);
};
void (*const glCopyBufferSubData)(GLenum, GLenum, GLintptr, GLintptr,
                                  GLsizeiptr) =
    [](GLenum readTarget, GLenum writeTarget, GLintptr readOffset,
       GLintptr writeOffset, GLsizeiptr size) {
      if (!opengl32) loadWGL();
      ::wgl_glCopyBufferSubData(readTarget, writeTarget, readOffset,
                                writeOffset, size);
    };
void (*const glGetUniformIndices)(GLuint, GLsizei, const GLchar* const*,
                                  GLuint*) =
    [](GLuint program, GLsizei uniformCount, const GLchar* const* uniformNames,
       GLuint* uniformIndices) {
      if (!opengl32) loadWGL();
      ::wgl_glGetUniformIndices(program, uniformCount, uniformNames,
                                uniformIndices);
    };
void (*const glGetActiveUniformsiv)(GLuint, GLsizei, const GLuint*, GLenum,
                                    GLint*) =
    [](GLuint program, GLsizei uniformCount, const GLuint* uniformIndices,
       GLenum pname, GLint* params) {
      if (!opengl32) loadWGL();
      ::wgl_glGetActiveUniformsiv(program, uniformCount, uniformIndices, pname,
                                  params);
    };
...
void (*const glGetActiveUniformBlockiv)(GLuint, GLuint, GLenum, GLint*) =
    [](GLuint program, GLuint uniformBlockIndex, GLenum pname, GLint* params) {
      if (!opengl32) loadWGL();
      ::wgl_glGetActiveUniformBlockiv(program, uniformBlockIndex, pname,
                                      params);
    };
void (*const glGetActiveUniformBlockName)(GLuint, GLuint, GLsizei, GLsizei*,
                                          GLchar*) =
    [](GLuint program, GLuint uniformBlockIndex, GLsizei bufSize,
       GLsizei* length, GLchar* uniformBlockName) {
      if (!opengl32) loadWGL();
      ::wgl_glGetActiveUniformBlockName(program, uniformBlockIndex, bufSize,
...
void (*const glUniformBlockBinding)(GLuint, GLuint, GLuint) =
    [](GLuint program, GLuint uniformBlockIndex, GLuint uniformBlockBinding) {
      if (!opengl32) loadWGL();
      ::wgl_glUniformBlockBinding(program, uniformBlockIndex,
                                  uniformBlockBinding);
    };
...
void (*const glDrawElementsInstanced)(GLenum, GLsizei, GLenum, const GLvoid*,
                                      GLsizei) =
...
GLsync (*const glFenceSync)(GLenum, GLbitfield) = [](GLenum condition,
                                                     GLbitfield flags) {
  if (!opengl32) loadWGL();
...
void (*const glGetInteger64v)(GLenum, GLint64*) = [](GLenum pname,
                                                     GLint64* params) {
  if (!opengl32) loadWGL();
...
void (*const glGenSamplers)(GLsizei, GLuint*) = [](GLsizei count,
                                                   GLuint* samplers) {
  if (!opengl32) loadWGL();
...
void (*const glVertexAttribDivisor)(GLuint, GLuint) = [](GLuint index,
                                                         GLuint divisor) {
  if (!opengl32) loadWGL();
  ::wgl_glVertexAttribDivisor(index, divisor);
};
void (*const glBindTransformFeedback)(GLenum, GLuint) = [](GLenum target,
                                                           GLuint id) {
  if (!opengl32) loadWGL();
...
void (*const glGenTransformFeedbacks)(GLsizei, GLuint*) = [](GLsizei n,
                                                             GLuint* ids) {
  if (!opengl32) loadWGL();
...
void (*const glInvalidateSubFramebuffer)(GLenum, GLsizei, const GLenum*, GLint,
                                         GLint, GLsizei, GLsizei) =
    [](GLenum target, GLsizei numAttachments, const GLenum* attachments,
       GLint x, GLint y, GLsizei width, GLsizei height) {
      if (!opengl32) loadWGL();
      ::wgl_glInvalidateSubFramebuffer(target, numAttachments, attachments, x,
                                       y, width, height);
    };
...
void (*const glTexStorage3D)(GLenum, GLsizei, GLenum, GLsizei, GLsizei,
                             GLsizei) = [](GLenum target, GLsizei levels,
...
void (*const glGetInternalformativ)(GLenum, GLenum, GLenum, GLsizei, GLint*) =
    [](GLenum target, GLenum internalformat, GLenum pname, GLsizei bufSize,
       GLint* params) {
      if (!opengl32) loadWGL();
      ::wgl_glGetInternalformativ(target, internalformat, pname, bufSize,
                                  params);
    };

/* OpenGL Windows Extensions */

BOOL (*const wglChoosePixelFormatARB)(HDC, const int*, const FLOAT*, UINT, int*,
                                      UINT*) =
    [](HDC hdc, const int* piAttribIList, const FLOAT* pfAttribFList,
       UINT nMaxFormats, int* piFormats, UINT* nNumFormats) {
      if (!opengl32) loadWGL();
      return ::wgl_wglChoosePixelFormatARB(hdc, piAttribIList, pfAttribFList,
