...
function(add_node_module NAME)
    cmake_parse_arguments("" "" "MINIMUM_NODE_ABI;MAXIMUM_NODE_ABI;NAN_VERSION;INSTALL_PATH;CACHE_DIR" "EXCLUDE_NODE_ABIS" ${ARGN})
    if(NOT _MINIMUM_NODE_ABI)
        set(_MINIMUM_NODE_ABI "${NODE_MODULE_MINIMUM_ABI}")
    endif()
    if(NOT _MAXIMUM_NODE_ABI)
        set(_MAXIMUM_NODE_ABI "${NODE_MODULE_MAXIMUM_ABI}")
    endif()
    if (NOT _CACHE_DIR)
    ...
    foreach(_LINE IN LISTS _INDEX_FILE)
        ...
        if(_ABI GREATER_EQUAL _MINIMUM_NODE_ABI AND _ABI LESS_EQUAL _MAXIMUM_NODE_ABI AND NOT _ABI IN_LIST _EXCLUDE_NODE_ABIS AND NOT DEFINED _NODE_ABI_${_ABI}_VERSION)
