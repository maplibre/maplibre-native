...
v8::Local<v8::Value> toJS(const mln::style::expression::Value&);
...
private:
    NodeExpression(std::unique_ptr<mln::style::expression::Expression> expression_)
    ...
    std::unique_ptr<mln::style::expression::Expression> expression;
};
