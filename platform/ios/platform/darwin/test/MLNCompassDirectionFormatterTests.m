...
@implementation MLNCompassDirectionFormatterTests

- (void)testCompassDirections {
    MLNCompassDirectionFormatter *shortFormatter = [[MLNCompassDirectionFormatter alloc] init];
    shortFormatter.unitStyle = NSFormattingUnitStyleShort;

    MLNCompassDirectionFormatter *mediumFormatter = [[MLNCompassDirectionFormatter alloc] init];
    XCTAssertEqual(mediumFormatter.unitStyle, NSFormattingUnitStyleMedium, @"Unit style should be medium by default.");

    MLNCompassDirectionFormatter *longFormatter = [[MLNCompassDirectionFormatter alloc] init];
