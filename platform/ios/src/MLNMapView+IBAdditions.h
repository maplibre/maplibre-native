...
@interface MLNMapView (IBAdditions)
...
// inspectables declared in MLNMapView.h are always sorted before those in
// MLNMapView+IBAdditions.h, due to ASCII sort order.
