...
- (void)test0_NativeNetworkManagerDelegateIsSet {
  ...
  id<MLNNativeNetworkDelegate> manager =
      MLN_OBJC_DYNAMIC_CAST_AS_PROTOCOL(delegate, MLNNativeNetworkDelegate);
...
- (void)internalTestNetworkConfigurationWithSession:(NSURLSession *)session
  ...
  MLNNetworkConfiguration *manager = [MLNNetworkConfiguration sharedManager];
  MLNNetworkConfigurationTestDelegate *delegate =
      [[MLNNetworkConfigurationTestDelegate alloc] init];
  delegate.handler = ^{
  ...
  NSData *context = [NSKeyedArchiver archivedDataWithRootObject:@{@"Name" : @"Faneuil Hall"}];
  ...
  {
    XCTestExpectation *expectation =
        [self expectationForNotification:MLNOfflinePackProgressChangedNotification
                                  object:pack
...
- (void)testNetworkConfigurationWithBackgroundSessionConfiguration {
  ...
  NSURLSessionConfiguration *sessionConfig = [NSURLSessionConfiguration
      backgroundSessionConfigurationWithIdentifier:NSStringFromSelector(_cmd)];
  ...
  //  [self internalTestNetworkConfigurationWithSession:session], NSException,
...
- (void)testNetworkConfigurationWithSessionConfigurationWithDelegateLOCKED {
  ...
  NSURLSessionConfiguration *sessionConfig =
      [NSURLSessionConfiguration defaultSessionConfiguration];
  MLNNetworkConfigurationSessionDelegate *delegate =
      [[MLNNetworkConfigurationSessionDelegate alloc] init];
...
- (void)testFailureForNetworkConfigurationWithSessionWithDataDelegateLOCKED {
  ...
  NSURLSessionConfiguration *sessionConfig =
      [NSURLSessionConfiguration defaultSessionConfiguration];
  MLNNetworkConfigurationSessionDataDelegate *delegate =
      [[MLNNetworkConfigurationSessionDataDelegate alloc] init];
