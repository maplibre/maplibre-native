...
@implementation MLNOpenGLLayer {
  NSOpenGLContext *_context;
}

- (MLNMapView *)mapView {
  return (MLNMapView *)super.view;
}
...
- (BOOL)canDrawInOpenGLContext:(__unused NSOpenGLContext *)context
                   pixelFormat:(__unused NSOpenGLPixelFormat *)pixelFormat
                  forLayerTime:(__unused CFTimeInterval)t
                   displayTime:(__unused const CVTimeStamp *)ts {
