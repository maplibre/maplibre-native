# Contributing to the MapLibre Maps SDK for macOS

This document explains how to build the MapLibre Maps SDK for macOS from source.
It is intended for advanced developers who wish to contribute to MapLibre GL
and the MapLibre Maps SDK for iOS.
