...
abstract class SentryConfigPlugin
    @Inject
    constructor(
        ...
        override fun apply(project: Project) {
            ...
            fun setProperty(
                ...
                try {
                    val getter =
                        ext.javaClass.methods.firstOrNull { it.name == propertyGetterName && it.parameterCount == 0 }
                            ?: return
                    val propObj = getter.invoke(ext) ?: return
                    val setMethod =
                        propObj.javaClass.methods.firstOrNull { it.name == "set" && it.parameterCount == 1 }
                            ?: return
