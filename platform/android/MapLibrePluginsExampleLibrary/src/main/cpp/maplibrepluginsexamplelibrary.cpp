...
Java_org_maplibre_maplibrepluginsexamplelibrary_NativeLib_stringFromJNI(JNIEnv* env, jobject /* this */) {
    std::string hello = "Hello from C++";
    return env->NewStringUTF(hello.c_str());
}

extern "C" JNIEXPORT void JNICALL
Java_org_maplibre_maplibrepluginsexamplelibrary_NativeLib_registerPlugins(JNIEnv* env, jobject /* this */) {
