...
public:
    PixelGuard(jni::JNIEnv& env_, const jni::Object<Bitmap>& bitmap_) : env(env_), bitmap(bitmap_) {
        const int result = AndroidBitmap_lockPixels(&env, jni::Unwrap(*bitmap), reinterpret_cast<void**>(&address));
...
jni::Local<jni::Object<Bitmap>> Bitmap::CreateBitmap(jni::JNIEnv& env,
    ...
    static auto method =
        _class.GetStaticMethod<jni::Object<Bitmap>(jni::jint, jni::jint, jni::Object<Config>)>(env, "createBitmap");
