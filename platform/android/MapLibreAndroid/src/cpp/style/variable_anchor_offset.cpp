...
jni::Local<jni::Object<VariableAnchorOffset>> VariableAnchorOffset::New(jni::JNIEnv& env,
    ...
    static auto variableAnchorOffsetConstructor =
        variableAnchorOffsetClass.GetConstructor<jni::Array<jni::Object<AnchorOffset>>>(env);
