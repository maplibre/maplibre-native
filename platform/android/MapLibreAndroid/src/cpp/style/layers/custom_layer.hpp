...
public:
    ...
    CustomLayer(mln::style::CustomLayer&);
    CustomLayer(std::unique_ptr<mln::style::CustomLayer>);
    ~CustomLayer();

    jni::Local<jni::Object<Layer>> createJavaPeer(jni::JNIEnv&);
}; // class CustomLayer

class CustomJavaLayerPeerFactory final : public JavaLayerPeerFactory, public mln::CustomLayerFactory {
public:
