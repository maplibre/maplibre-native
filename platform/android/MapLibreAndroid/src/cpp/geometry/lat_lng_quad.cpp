...
jni::Local<jni::Object<LatLngQuad>> LatLngQuad::New(jni::JNIEnv& env, std::array<mln::LatLng, 4> coordinates) {
    static auto& javaClass = jni::Class<LatLngQuad>::Singleton(env);
    static auto quadConstructor =
        javaClass.GetConstructor<jni::Object<LatLng>, jni::Object<LatLng>, jni::Object<LatLng>, jni::Object<LatLng>>(
            env);
...
std::array<mln::LatLng, 4> LatLngQuad::getLatLngArray(jni::JNIEnv& env, const jni::Object<LatLngQuad>& quad) {
    static auto& javaClass = jni::Class<LatLngQuad>::Singleton(env);
