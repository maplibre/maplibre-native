...
class LocationLayerControllerTest : BaseTest() {
    ...
    fun onInitialization_locationSourceIsAdded() {
        val internalRenderModeChangedListener =
            Mockito.mock(
    ...
    fun onInitialization_shadowLayerIsAdded() {
        ...
        Mockito
            .`when`(sourceProvider.generateLayer(LocationComponentConstants.SHADOW_LAYER))
    ...
    fun onInitialization_backgroundLayerIsAdded() {
        ...
        Mockito
            .`when`(sourceProvider.generateLayer(LocationComponentConstants.BACKGROUND_LAYER))
    ...
    fun onInitialization_foregroundLayerIsAdded() {
        ...
        Mockito
            .`when`(sourceProvider.generateLayer(LocationComponentConstants.FOREGROUND_LAYER))
    ...
    fun onInitialization_bearingLayerIsAdded() {
        ...
        Mockito
            .`when`(sourceProvider.generateLayer(LocationComponentConstants.BEARING_LAYER))
    ...
    fun onInitialization_numberOfCachedLayerIdsIsConstant() {
        ...
        val layerSet: MutableSet<String> = HashSet()
    ...
    fun applyStyle_specializedLayer_ignoreBitmapNames() {
        ...
        Mockito.verify(indicatorRenderer).updateIconIds(
            eq(LocationComponentConstants.FOREGROUND_ICON),
            any<String>(),
            any<String>(),
            any<String>(),
            any<String>(),
    ...
    fun updateForegroundOffset_foregroundIconPropertyIsUpdated() {
        ...
        Mockito.verify(locationFeature).addProperty(
            eq(LocationComponentConstants.PROPERTY_FOREGROUND_ICON_OFFSET),
            any<JsonElement>(),
        )
    }
    ...
    fun updateForegroundOffset_shadowPropertyIsUpdated() {
        ...
        layer.cameraTiltUpdated(2.0)
        Mockito.verify(locationFeature).addProperty(
            eq(LocationComponentConstants.PROPERTY_SHADOW_ICON_OFFSET),
            any<JsonElement>(),
        )
    }
    ...
    fun onNewLatLngValue_locationFeatureIsUpdated() {
        ...
        val locationSource = Mockito.mock(GeoJsonSource::class.java)
        Mockito
            .`when`<Any?>(style.getSourceAs(LocationComponentConstants.LOCATION_SOURCE))
            .thenReturn(locationSource)
    ...
    fun onNewGpsBearingValue_updateIgnoredWithInvalidRenderMode() {
        ...
        Mockito
            .verify(locationFeature, Mockito.times(0))
            .addNumberProperty(LocationComponentConstants.PROPERTY_GPS_BEARING, gpsBearing)
    }
    ...
    fun layerHidden_renderModeChanged_layerShown_foregroundIconUpdated() {
        ...
        Mockito
            .`when`(bitmapProvider.generateBitmap(drawableGpsResId, tintColor))
    ...
    private fun buildFeatureProvider(options: LocationComponentOptions): LayerFeatureProvider {
        ...
        Mockito
            .`when`(provider.generateLocationFeature(null, options.enableStaleState()))
            .thenReturn(
                Mockito.mock(
                    Feature::class.java,
                ),
    ...
    private fun buildLayerProvider(): LayerSourceProvider {
        ...
        Mockito
            .`when`(layerSourceProvider.generateLayer(LocationComponentConstants.SHADOW_LAYER))
            .thenReturn(shadowLayer)
        val backgroundLayer =
            Mockito.mock(
                Layer::class.java,
        ...
        Mockito
            .`when`(layerSourceProvider.generateLayer(LocationComponentConstants.BACKGROUND_LAYER))
            .thenReturn(backgroundLayer)
        val foregroundLayer =
            Mockito.mock(
                Layer::class.java,
        ...
        Mockito
            .`when`(layerSourceProvider.generateLayer(LocationComponentConstants.FOREGROUND_LAYER))
            .thenReturn(foregroundLayer)
        val bearingLayer =
            Mockito.mock(
                Layer::class.java,
        ...
        Mockito
            .`when`(layerSourceProvider.generateLayer(LocationComponentConstants.BEARING_LAYER))
            .thenReturn(bearingLayer)
        val accuracyLayer =
            Mockito.mock(
                Layer::class.java,
        ...
        Mockito
            .`when`(pulsingCircleLayer.id)
            .thenReturn(LocationComponentConstants.PULSING_CIRCLE_LAYER)
        Mockito
            .`when`(layerSourceProvider.generatePulsingCircleLayer())
    ...
    private fun <T> getAnimationListener(
        ...
        for (holder in holders) {
            ...
            if (type == animatorType) {
                ...
                return holder.listener as AnimationsValueChangeListener<Any>
            }
        }
        return null
    }
