...
/**
    ...
    @Keep
    constructor(
        @field:Keep val topLeft: LatLng,
        @field:Keep val topRight: LatLng,
        @field:Keep val bottomRight: LatLng,
        @field:Keep val bottomLeft: LatLng,
    ) : Parcelable {
        ...
        companion object {
            ...
            val CREATOR: Parcelable.Creator<LatLngQuad> =
                object : Parcelable.Creator<LatLngQuad> {
                    override fun createFromParcel(parcel: Parcel): LatLngQuad = readFromParcel(parcel)

                    override fun newArray(size: Int): Array<LatLngQuad?> = arrayOfNulls(size)
                }
