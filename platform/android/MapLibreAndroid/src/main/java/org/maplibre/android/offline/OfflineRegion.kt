    ...
    private constructor(
        ...
        fun getStatus(callback: OfflineRegionStatusCallback) {
            ...
            getOfflineRegionStatus(
                object : OfflineRegionStatusCallback {
        ...
        @Keep
        private external fun setOfflineRegionDownloadState(
            @DownloadState offlineRegionDownloadState: Int,
        )
        ...
        @Keep
        private external fun updateOfflineRegionMetadata(
            metadata: ByteArray,
            callback: OfflineRegionUpdateMetadataCallback,
        )
