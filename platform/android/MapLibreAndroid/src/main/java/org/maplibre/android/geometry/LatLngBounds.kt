...
/**
    ...
    internal constructor(
         ...
         * @return double latitude value for north
         */
        fun getLatNorth(): Double = latitudeNorth
         ...
         * @return double latitude value for south
         */
        fun getLatSouth(): Double = latitudeSouth
         ...
         * @return double longitude value for east
         */
        fun getLonEast(): Double = longitudeEast
         ...
         * @return double longitude value for west
         */
        fun getLonWest(): Double = longitudeWest
         ...
         */
        override fun toString(): String = ("N:" + latitudeNorth + "; E:" + longitudeEast + "; S:" + latitudeSouth + "; W:" + longitudeWest)
         ...
         */
        fun toLatLngs(): Array<LatLng> = arrayOf(northEast, southWest)
        ...
        override fun equals(other: Any?): Boolean {
            ...
            if (other is LatLngBounds) {
                return latitudeNorth == other.latitudeNorth &&
        ...
        private fun containsLatitude(latitude: Double): Boolean = latitude in latitudeSouth..latitudeNorth

        private fun containsLongitude(longitude: Double): Boolean = longitude in longitudeWest..longitudeEast
         ...
         */
        operator fun contains(latLng: LatLng): Boolean = (containsLatitude(latLng.latitude) && containsLongitude(latLng.longitude))
         ...
         */
        operator fun contains(other: LatLngBounds): Boolean = (contains(other.northEast) && contains(other.southWest))
        ...
        fun union(bounds: LatLngBounds): LatLngBounds =
            unionNoParamCheck(bounds.latitudeNorth, bounds.longitudeEast, bounds.latitudeSouth, bounds.longitudeWest)
        ...
        fun intersect(box: LatLngBounds): LatLngBounds? =
            intersectNoParamCheck(box.latitudeNorth, box.longitudeEast, box.latitudeSouth, box.longitudeWest)
        ...
        override fun hashCode(): Int =
            (latitudeNorth + 90 + (latitudeSouth + 90) * 1000 + (longitudeEast + 180) * 1000000 + (longitudeWest + 180) * 1000000000)
                .toInt()
        ...
        companion object {
            ...
            private fun checkParams(
                ...
                require(
                    !(
                        latNorth > GeometryConstants.MAX_LATITUDE || latNorth < GeometryConstants.MIN_LATITUDE ||
                            latSouth > GeometryConstants.MAX_LATITUDE ||
                            latSouth < GeometryConstants.MIN_LATITUDE
                    ),
            ...
            private fun lon_(
                z: Int,
                x: Int,
            ): Double = x / Math.pow(2.0, z.toDouble()) * 360.0 - GeometryConstants.MAX_WRAP_LONGITUDE
            ...
            fun from(
                ...
                x: Int,
                y: Int,
            ): LatLngBounds = LatLngBounds(lat_(z, y), lon_(z, x + 1), lat_(z, y + 1), lon_(z, x))
            ...
            val CREATOR: Parcelable.Creator<LatLngBounds?> =
                object : Parcelable.Creator<LatLngBounds?> {
                    override fun createFromParcel(parcel: Parcel): LatLngBounds = readFromParcel(parcel)

                    override fun newArray(size: Int): Array<LatLngBounds?> = arrayOfNulls(size)
                }
