...
class LatLng : Parcelable {
    ...
    var longitude = 0.0
         ...
         */
        set(
            @FloatRange(from = GeometryConstants.MIN_LONGITUDE, to = GeometryConstants.MAX_LONGITUDE) longitude,
        ) {
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return java.lang.Double.compare(latLng.altitude, altitude) == 0 && java.lang.Double.compare(latLng.latitude, latitude) == 0 &&
            java.lang.Double.compare(latLng.longitude, longitude) == 0
    }
     ...
     */
    override fun toString(): String = "LatLng [latitude=$latitude, longitude=$longitude, altitude=$altitude]"
    ...
    fun distanceTo(other: LatLng): Double =
        TurfMeasurement.distance(
            ...
            Point.fromLngLat(other.longitude, other.latitude),
    ...
    companion object {
        ...
        val CREATOR: Parcelable.Creator<LatLng> =
            object : Parcelable.Creator<LatLng> {
