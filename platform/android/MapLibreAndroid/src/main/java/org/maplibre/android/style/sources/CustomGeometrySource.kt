...
class CustomGeometrySource
    ...
    constructor(
                    ...
                    ThreadPoolExecutor(
                        ...
                        object : ThreadFactory {
                            ...
                            override fun newThread(runnable: Runnable): Thread =
                                Thread(runnable, String.format(Locale.US, "%s-%d-%d", THREAD_PREFIX, poolId, threadCount.getAndIncrement()))
                        },
                    )
                } finally {
                    executorLock.unlock()
        ...
        private fun isCancelled(
            ...
            x: Int,
            y: Int,
        ): Boolean = inProgressTasksMap[TileID(z, x, y)]!!.get()
        ...
        internal class TileID(
            ...
            override fun hashCode(): Int = intArrayOf(z, x, y).contentHashCode()
