...
open class SupportMapFragment :
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun newInstance(): SupportMapFragment = SupportMapFragment()
         ...
         */
        @JvmStatic
        fun newInstance(maplibreMapOptions: MapLibreMapOptions?): SupportMapFragment {
