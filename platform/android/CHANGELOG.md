...
## 10.0.3-snapshot - April 09, 2023

### 🐞 Bug fixes

- fix for ([#992](https://github.com/maplibre/maplibre-gl-native/issues/992)) with backward compatibility for java functions calling the converted code in `OfflineManager` and `OfflineRegion`

- add back in some attribute values (mapbox\_\* vs maplibre\_\*) still required by some external maplibre libraries
