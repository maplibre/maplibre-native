...
Value::Value(jni::JNIEnv& _env, jni::Local<jni::Object<>> _value) : env(_env), value(std::move(_value)) {}

Value::Value(jni::JNIEnv& _env, const jni::Object<>& _value) : env(_env), value(jni::NewLocal(_env, _value)) {}
