...
Converter<jni::Local<jni::Object<Position>>, mbgl::style::Position>::operator()(
    jni::JNIEnv &env, const mbgl::style::Position &value
) const {
...
Result<mbgl::style::Position> Converter<mbgl::style::Position, jni::Object<Position>>::operator()(
    jni::JNIEnv &env, const jni::Object<Position> &value
) const {
