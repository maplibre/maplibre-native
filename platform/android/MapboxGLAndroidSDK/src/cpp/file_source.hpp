...
public:
    ...
    struct ResourceTransformCallback {
        ...
        static std::string onURL(
            jni::JNIEnv&, const jni::Object<FileSource::ResourceTransformCallback>&, int, std::string
        );
    };
    ...
    struct ResourcesCachePathChangeCallback {
        ...
        static void
        onSuccess(jni::JNIEnv&, const jni::Object<FileSource::ResourcesCachePathChangeCallback>&, const jni::String&);

        static void
        onError(jni::JNIEnv&, const jni::Object<FileSource::ResourcesCachePathChangeCallback>&, const jni::String&);
    };
    ...
    void
    setResourceCachePath(jni::JNIEnv&, const jni::String&, const jni::Object<FileSource::ResourcesCachePathChangeCallback>&);
