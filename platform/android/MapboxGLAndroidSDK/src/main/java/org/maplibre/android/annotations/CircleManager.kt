...
//        maplibreMap
//    )
//) : AnnotationManager<CircleLayer, Circle, OnCircleDragListener, OnCircleClickListener, OnCircleLongClickListener>(
//    mapView,
//    maplibreMap,
//    style,
//    coreElementProvider,
...
//
//    override fun generateDataDrivenPropertyExpression(property: String) {
//        when (property) {
