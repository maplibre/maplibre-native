...
import com.mapbox.mapboxsdk.camera.CameraUpdateFactory.ZoomUpdate
 ...
 */ @Keep internal constructor(
    ...
    class Builder {
        ...
        constructor(typedArray: TypedArray?) : super() {
            if (typedArray != null) {
                bearing = typedArray.getFloat(R.styleable.mapbox_MapView_maplibre_cameraBearing, 0.0f).toDouble()
                val lat = typedArray.getFloat(R.styleable.mapbox_MapView_maplibre_cameraTargetLat, 0.0f).toDouble()
                val lng = typedArray.getFloat(R.styleable.mapbox_MapView_maplibre_cameraTargetLng, 0.0f).toDouble()
                target = LatLng(lat, lng)
                tilt = typedArray.getFloat(R.styleable.mapbox_MapView_maplibre_cameraTilt, 0.0f).toDouble()
                zoom = typedArray.getFloat(R.styleable.mapbox_MapView_maplibre_cameraZoom, 0.0f).toDouble()
            }
        }
