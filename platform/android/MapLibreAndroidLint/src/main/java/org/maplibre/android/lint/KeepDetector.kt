...
class KeepDetector :
    ...
    companion object {
        ...
        private const val ISSUE_EXPLANATION =
            "This class, method or field might contain native references. " +
    ...
    class KeepHandler(
        ...
        private fun checkKeepAnnotation(uAnnotated: UAnnotated): Boolean =
            !hasKeepAnnotation(uAnnotated) && !hasKeepAnnotation(uAnnotated.getContainingUClass()!!)

        private fun hasKeepAnnotation(uAnnotated: UAnnotated): Boolean = uAnnotated.findAnnotation("androidx.annotation.Keep") != null
    }
}
