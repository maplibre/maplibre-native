...
class MapLibreMapTest : EspressoTest() {
    ...
    fun testConcurrentInfoWindowEnabled() {
        ...
        onView(ViewMatchers.withId(R.id.mapView)).perform(
            MapLibreMapAction { uiController: UiController?, view: View? ->
    ...
    fun testAddEmptyPolyline() {
        validateTestSetup()
        onView(ViewMatchers.withId(R.id.mapView)).perform(
            MapLibreMapAction { _: UiController?, _: View? ->
        ...
        onView(ViewMatchers.withId(R.id.mapView)).perform(
            MapLibreMapAction { uiController: UiController?, view: View? ->
                ...
                assertTrue(
                    ...
                    !maplibreMap.polylines.contains(polygonOptions3.polyline),
                )
            },
        )
    }
    ...
    fun testGetAnnotations() {
        ...
        onView(ViewMatchers.withId(R.id.mapView)).perform(
            MapLibreMapAction {
                ...
                view: View?,
                ->
                TestCase.assertNotNull("Annotations should be non null", maplibreMap.annotations)
            },
        )
    }
    ...
    fun testGetMarkers() {
        ...
        onView(ViewMatchers.withId(R.id.mapView)).perform(
            MapLibreMapAction {
                ...
                view: View?,
                ->
                TestCase.assertNotNull("Markers should be non null", maplibreMap.markers)
            },
        )
    }
    ...
    fun testGetPolygons() {
        ...
        onView(ViewMatchers.withId(R.id.mapView)).perform(
            MapLibreMapAction { uiController: UiController?, view: View? ->
                TestCase.assertNotNull("Polygons should be non null", maplibreMap.polygons)
            },
        )
    }
    ...
    fun testGetPolylines() {
        ...
        onView(ViewMatchers.withId(R.id.mapView)).perform(
            MapLibreMapAction { uiController: UiController?, view: View? ->
                TestCase.assertNotNull("Polylines should be non null", maplibreMap.polylines)
            },
        )
    }
    ...
    fun testGetSelectedMarkers() {
        ...
        onView(ViewMatchers.withId(R.id.mapView)).perform(
            MapLibreMapAction { uiController: UiController?, view: View? ->
                TestCase.assertNotNull("Selected markers should be non null", maplibreMap.selectedMarkers)
            },
        )
    }
    ...
    inner class MapLibreMapAction internal constructor(
