        ...
        val componentAction =
            object : LocationComponentAction.OnPerformLocationComponentAction {
                override fun onLocationComponentAction(
                    ...
                    assertEquals(
                        FOREGROUND_ICON,
                        maplibreMap.querySourceFeatures(LOCATION_SOURCE)[0].getStringProperty(PROPERTY_FOREGROUND_ICON),
                    )
                }
            }
        ...
        val componentAction =
            object : LocationComponentAction.OnPerformLocationComponentAction {
                override fun onLocationComponentAction(
                    ...
                    assertEquals(
                        77f,
                        maplibreMap.querySourceFeatures(LOCATION_SOURCE)[0].getNumberProperty(PROPERTY_GPS_BEARING).toFloat(),
                        0.1f,
                    )
                ...
                override fun onLocationComponentAction(
                    ...
                    val engine: CompassEngine =
                        object : CompassEngine {
                            ...
                            override val lastHeading: Float
                                get() = 0f

                            override val lastAccuracySensorStatus: Int
                                get() = 0
                        }
