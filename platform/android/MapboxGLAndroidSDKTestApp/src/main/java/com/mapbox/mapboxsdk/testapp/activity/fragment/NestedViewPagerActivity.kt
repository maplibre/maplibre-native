            ...
            override fun getItem(position: Int): androidx.fragment.app.Fragment {
                ...
                when (position) {
                    0 -> {
                        ...
                        fragment.getMapAsync { mapboxMap -> mapboxMap.setStyle(Style.getPredefindStyle("Streets")) }
                        return fragment
                    }
                    1 -> {
                    ...
                    2 -> {
                        ...
                        val fragment = SupportMapFragment.newInstance(options)
                        fragment.getMapAsync { mapboxMap -> mapboxMap.setStyle(Style.getPredefindStyle("Dark")) }
                        return fragment
                    }
                    3 -> {
                        return EmptyFragment.newInstance()
                    ...
                    4 -> {
                        ...
                        val fragment = SupportMapFragment.newInstance(options)
                        fragment.getMapAsync { mapboxMap -> mapboxMap.setStyle(Style.getPredefindStyle("Satellite")) }
                        return fragment
                    }
                    5 -> {
                        return EmptyFragment.newInstance()
