...
class CameraPositionActivity :
  ...
  private class DialogClickListener(
    ...
    override fun onClick(dialog: DialogInterface, which: Int) {
      val latitude =
          (dialogContent.findViewById<View>(R.id.value_lat) as TextView).text.toString().toDouble()
      val longitude =
          (dialogContent.findViewById<View>(R.id.value_lon) as TextView).text.toString().toDouble()
      val zoom =
          (dialogContent.findViewById<View>(R.id.value_zoom) as TextView).text.toString().toDouble()
      val bearing =
          (dialogContent.findViewById<View>(R.id.value_bearing) as TextView)
              ...
              .toDouble()
      val tilt =
          (dialogContent.findViewById<View>(R.id.value_tilt) as TextView).text.toString().toDouble()
