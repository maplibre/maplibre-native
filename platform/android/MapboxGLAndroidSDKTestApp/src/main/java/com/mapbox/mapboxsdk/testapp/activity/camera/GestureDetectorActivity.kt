...
class GestureDetectorActivity : AppCompatActivity() {
    ...
    fun attachListeners() {
        ...
        mapboxMap!!.addOnRotateListener(object : OnRotateListener {
            override fun onRotateBegin(detector: RotateGestureDetector) {
                gestureAlertsAdapter!!.addAlert(
                    GestureAlert(
                        GestureAlert.TYPE_START,
                        "ROTATE START"
                    )
                )
            }
        ...
        mapboxMap!!.addOnScaleListener(object : OnScaleListener {
        ...
        mapboxMap!!.addOnShoveListener(object : OnShoveListener {
    ...
    private fun fixedFocalPointEnabled(enabled: Boolean) {
        if (enabled) {
            ...
            mapboxMap!!.easeCamera(CameraUpdateFactory.newLatLngZoom(focalPointLatLng!!, 16.0),
    ...
    private class GestureAlert internal constructor(
        @field:Type @param:Type val alertType: Int,
        val message: String?
    ) {
