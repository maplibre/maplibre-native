...
class FeatureOverviewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ItemClickSupport.addTo(recyclerView).setOnItemClickListener { recyclerView: RecyclerView?, position: Int, view: View? ->
    ...
    private inner class LoadFeatureTask : AsyncTask<PackageInfo?, Void?, List<Feature>>() {
        override fun doInBackground(vararg p0: PackageInfo?): List<Feature>? {
