...
public class RuntimeStyleTests extends EspressoTest {
  ...
  public void testAddRemoveSource() {
    ...
    invoke(mapboxMap, (uiController, mapboxMap) -> {
      mapboxMap.getStyle().addSource(new VectorSource("my-source", "maptiler://tiles/hillshades"));
      ...
      // Add
      Source source = new VectorSource("my-source", "maptiler://tiles/hillshades");
      ...
      try {
        Source source2 = new VectorSource("my-source", "maptiler://tiles/hillshades2");
  ...
  public void testVectorSourceUrlGetter() {
    validateTestSetup();
    invoke(mapboxMap, (uiController, mapboxMap) -> {
      VectorSource source = new VectorSource("my-source", "maptiler://tiles/hillshades");
      mapboxMap.getStyle().addSource(source);
      assertEquals("maptiler://tiles/hillshades", source.getUri());
    });
  }
  ...
  public void testRasterSourceUrlGetter() {
    validateTestSetup();
    invoke(mapboxMap, (uiController, mapboxMap) -> {
      RasterSource source = new RasterSource("my-source", "maptiler://tiles/hillshades");
      mapboxMap.getStyle().addSource(source);
      assertEquals("maptiler://tiles/hillshades", source.getUri());
    });
  }
