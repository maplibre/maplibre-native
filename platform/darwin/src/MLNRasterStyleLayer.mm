...
- (instancetype)initWithIdentifier:(NSString *)identifier source:(MLNSource *)source {
  MLNLogDebug(@"Initializing %@ with identifier: %@ source: %@", NSStringFromClass([self class]),
              identifier, source);
  auto layer = std::make_unique<mbgl::style::RasterLayer>(identifier.UTF8String,
...
- (void)setMaximumRasterBrightness:(NSExpression *)maximumRasterBrightness {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<float, NSNumber *>()
          .toPropertyValue<mbgl::style::PropertyValue<float>>(maximumRasterBrightness, false);
...
- (void)setMaximumRasterBrightnessTransition:(MLNTransition)transition {
  MLNAssertStyleLayerIsValid();
  MLNLogDebug(@"Setting maximumRasterBrightnessTransition: %@",
...
- (MLNTransition)maximumRasterBrightnessTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getRasterBrightnessMaxTransition();
...
- (void)setMinimumRasterBrightness:(NSExpression *)minimumRasterBrightness {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<float, NSNumber *>()
          .toPropertyValue<mbgl::style::PropertyValue<float>>(minimumRasterBrightness, false);
...
- (void)setMinimumRasterBrightnessTransition:(MLNTransition)transition {
  MLNAssertStyleLayerIsValid();
  MLNLogDebug(@"Setting minimumRasterBrightnessTransition: %@",
              MLNStringFromMLNTransition(transition));
...
- (MLNTransition)minimumRasterBrightnessTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getRasterBrightnessMinTransition();
...
- (void)setRasterContrast:(NSExpression *)rasterContrast {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(rasterContrast, false);
...
- (void)setRasterFadeDuration:(NSExpression *)rasterFadeDuration {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<float, NSNumber *>()
          .toPropertyValue<mbgl::style::PropertyValue<float>>(rasterFadeDuration, false);
...
- (void)setRasterHueRotation:(NSExpression *)rasterHueRotation {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<float, NSNumber *>()
          .toPropertyValue<mbgl::style::PropertyValue<float>>(rasterHueRotation, false);
...
- (void)setRasterOpacity:(NSExpression *)rasterOpacity {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(rasterOpacity, false);
...
- (void)setRasterResamplingMode:(NSExpression *)rasterResamplingMode {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<mbgl::style::RasterResamplingType, NSValue *,
                               mbgl::style::RasterResamplingType, MLNRasterResamplingMode>()
          .toPropertyValue<mbgl::style::PropertyValue<mbgl::style::RasterResamplingType>>(
              rasterResamplingMode, false);
...
- (NSExpression *)rasterResamplingMode {
  ...
  return MLNStyleValueTransformer<mbgl::style::RasterResamplingType, NSValue *,
                                  mbgl::style::RasterResamplingType, MLNRasterResamplingMode>()
...
- (void)setRasterSaturation:(NSExpression *)rasterSaturation {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(rasterSaturation, false);
