...
id MLNJSONObjectFromMBGLValue(const mbgl::Value &value) {
  return value.match(
      [](const mbgl::NullValue) -> id { return [NSNull null]; },
      ...
      [](const mbgl::Color &value) { return [MLNColor mgl_colorWithColor:value]; },
...
std::unique_ptr<mbgl::style::expression::Expression> MLNClusterPropertyFromNSExpression(
  ...
  auto expr = mbgl::style::expression::dsl::createExpression(
      mbgl::style::conversion::makeConvertible(jsonExpression));
