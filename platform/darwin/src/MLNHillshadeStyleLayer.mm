...
- (instancetype)initWithIdentifier:(NSString *)identifier source:(MLNSource *)source {
  MLNLogDebug(@"Initializing %@ with identifier: %@ source: %@", NSStringFromClass([self class]),
              identifier, source);
  auto layer = std::make_unique<mbgl::style::HillshadeLayer>(identifier.UTF8String,
...
- (void)setHillshadeAccentColor:(NSExpression *)hillshadeAccentColor {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<mbgl::Color, MLNColor *>()
          .toPropertyValue<mbgl::style::PropertyValue<mbgl::Color>>(hillshadeAccentColor, false);
...
- (void)setHillshadeAccentColorTransition:(MLNTransition)transition {
  MLNAssertStyleLayerIsValid();
  MLNLogDebug(@"Setting hillshadeAccentColorTransition: %@",
              MLNStringFromMLNTransition(transition));
...
- (MLNTransition)hillshadeAccentColorTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getHillshadeAccentColorTransition();
...
- (void)setHillshadeExaggeration:(NSExpression *)hillshadeExaggeration {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<float, NSNumber *>()
          .toPropertyValue<mbgl::style::PropertyValue<float>>(hillshadeExaggeration, false);
...
- (void)setHillshadeExaggerationTransition:(MLNTransition)transition {
  MLNAssertStyleLayerIsValid();
  MLNLogDebug(@"Setting hillshadeExaggerationTransition: %@",
              MLNStringFromMLNTransition(transition));
...
- (MLNTransition)hillshadeExaggerationTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getHillshadeExaggerationTransition();
...
- (void)setHillshadeHighlightColor:(NSExpression *)hillshadeHighlightColor {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<std::vector<mbgl::Color>, NSArray<MLNColor *> *, mbgl::Color>()
          .toPropertyValue<mbgl::style::PropertyValue<std::vector<mbgl::Color>>>(
              hillshadeHighlightColor, false);
...
- (NSExpression *)hillshadeHighlightColor {
  ...
  return MLNStyleValueTransformer<std::vector<mbgl::Color>, NSArray<MLNColor *> *, mbgl::Color>()
      .toExpression(propertyValue);
}

- (void)setHillshadeHighlightColorTransition:(MLNTransition)transition {
  MLNAssertStyleLayerIsValid();
  MLNLogDebug(@"Setting hillshadeHighlightColorTransition: %@",
              MLNStringFromMLNTransition(transition));
...
- (MLNTransition)hillshadeHighlightColorTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getHillshadeHighlightColorTransition();
...
- (void)setHillshadeIlluminationAltitude:(NSExpression *)hillshadeIlluminationAltitude {
  ...
  auto mbglValue = MLNStyleValueTransformer<std::vector<float>, NSArray<NSNumber *> *, float>()
                       .toPropertyValue<mbgl::style::PropertyValue<std::vector<float>>>(
                           hillshadeIlluminationAltitude, false);
...
- (void)setHillshadeIlluminationAnchor:(NSExpression *)hillshadeIlluminationAnchor {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<mbgl::style::HillshadeIlluminationAnchorType, NSValue *,
                               mbgl::style::HillshadeIlluminationAnchorType,
                               MLNHillshadeIlluminationAnchor>()
          .toPropertyValue<
              mbgl::style::PropertyValue<mbgl::style::HillshadeIlluminationAnchorType>>(
              hillshadeIlluminationAnchor, false);
...
- (NSExpression *)hillshadeIlluminationAnchor {
  ...
  return MLNStyleValueTransformer<mbgl::style::HillshadeIlluminationAnchorType, NSValue *,
                                  mbgl::style::HillshadeIlluminationAnchorType,
                                  MLNHillshadeIlluminationAnchor>()
      .toExpression(propertyValue);
}
...
- (void)setHillshadeIlluminationDirection:(NSExpression *)hillshadeIlluminationDirection {
  ...
  auto mbglValue = MLNStyleValueTransformer<std::vector<float>, NSArray<NSNumber *> *, float>()
                       .toPropertyValue<mbgl::style::PropertyValue<std::vector<float>>>(
                           hillshadeIlluminationDirection, false);
...
- (void)setHillshadeMethod:(NSExpression *)hillshadeMethod {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<mbgl::style::HillshadeMethodType, NSValue *,
                               mbgl::style::HillshadeMethodType, MLNHillshadeMethod>()
          .toPropertyValue<mbgl::style::PropertyValue<mbgl::style::HillshadeMethodType>>(
              hillshadeMethod, false);
...
- (NSExpression *)hillshadeMethod {
  ...
  return MLNStyleValueTransformer<mbgl::style::HillshadeMethodType, NSValue *,
                                  mbgl::style::HillshadeMethodType, MLNHillshadeMethod>()
      .toExpression(propertyValue);
}
...
- (void)setHillshadeShadowColorTransition:(MLNTransition)transition {
  MLNAssertStyleLayerIsValid();
  MLNLogDebug(@"Setting hillshadeShadowColorTransition: %@",
              MLNStringFromMLNTransition(transition));
...
- (MLNTransition)hillshadeShadowColorTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getHillshadeShadowColorTransition();
...
+ (NSValue *)valueWithMLNHillshadeIlluminationAnchor:
    (MLNHillshadeIlluminationAnchor)hillshadeIlluminationAnchor {
  return [NSValue value:&hillshadeIlluminationAnchor
           withObjCType:@encode(MLNHillshadeIlluminationAnchor)];
}
