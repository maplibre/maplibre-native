...
+ (nullable NSString *)mgl_applicationBundleIdentifier {
  ...
  // Before SDK 12.2 (bundled with Xcode 10.2): There’s no main bundle identifier when running in a
  // unit test bundle. 12.2 and after: the above bundle identifier is: com.apple.dt.xctest.tool
  if (!bundleIdentifier) {
