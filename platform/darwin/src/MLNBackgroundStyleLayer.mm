...
- (void)setBackgroundColor:(NSExpression *)backgroundColor {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<mbgl::Color, MLNColor *>()
          .toPropertyValue<mbgl::style::PropertyValue<mbgl::Color>>(backgroundColor, false);
...
- (void)setBackgroundOpacity:(NSExpression *)backgroundOpacity {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<float, NSNumber *>()
          .toPropertyValue<mbgl::style::PropertyValue<float>>(backgroundOpacity, false);
...
- (MLNTransition)backgroundOpacityTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getBackgroundOpacityTransition();
...
- (MLNTransition)backgroundPatternTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getBackgroundPatternTransition();
