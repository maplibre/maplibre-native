...
#define INSTALL_METHOD(sel)                                                                     \
  {                                                                                             \
    ...
    class_addMethod(NSPredicateUtilities, @selector(sel), method_getImplementation(method),     \
 ...
 */
- (id)mgl_interpolate:(id)inputExpression
        withCurveType:(NSString *)curveType
...
- (id)MLN_IF:(id)firstCondition, ... {
  ...
  for (id eachExpression = firstCondition; eachExpression;
       eachExpression = va_arg(argumentList, id)) {
...
- (mbgl::Value)mgl_constantMBGLValue {
  ...
  if ([value isKindOfClass:NSString.class]) {
    ...
    if ((strcmp([number objCType], @encode(char)) == 0) ||
      ...
      static dispatch_once_t onceToken;
      dispatch_once(&onceToken, ^{
        NSLog(@"Float value in expression will be converted to a double; some imprecision may "
              @"result. "
...
- (NSNumber *)mgl_number {
  if (self.doubleValue ||
      ![[NSDecimalNumber decimalNumberWithString:self] isEqual:[NSDecimalNumber notANumber]]) {
...
+ (instancetype)mgl_expressionForConditional:(nonnull NSPredicate *)conditionPredicate
  ...
  return [NSExpression expressionForConditional:conditionPredicate
...
+ (instancetype)mgl_expressionForSteppingExpression:(nonnull NSExpression *)steppingExpression
  ...
  return
      [NSExpression expressionForFunctionHelper:selectorName
...
+ (instancetype)mgl_expressionForInterpolatingExpression:(nonnull NSExpression *)inputExpression
  ...
  return [NSExpression
      expressionForFunctionHelper:selectorName
                        arguments:@[
                          inputExpression, [NSExpression expressionForConstantValue:curveType],
                          sanitizeParams, stops
                        ]];
}
...
+ (instancetype)mgl_expressionForMatchingExpression:(nonnull NSExpression *)inputExpression
  ...
  return [NSExpression expressionForFunctionHelper:@"MLN_MATCH" arguments:optionsArray];
}

+ (instancetype)mgl_expressionForAttributedExpressions:
    (nonnull NSArray<NSExpression *> *)attributedExpressions {
  return [NSExpression expressionForFunctionHelper:@"mgl_attributed:"
                                         arguments:attributedExpressions];
}
...
+ (instancetype)expressionWithMLNJSONObject:(id)object {
  ...
  if ([object isKindOfClass:[NSString class]] || [object isKindOfClass:[NSNumber class]] ||
      [object isKindOfClass:[NSValue class]] || [object isKindOfClass:[MLNColor class]] ||
  ...
  if ([object isKindOfClass:[NSArray class]]) {
    ...
    if (functionName) {
      ...
      if ([op isEqualToString:@"+"] && argumentObjects.count > 2) {
        ...
        return [NSExpression expressionForFunction:@"sum:" arguments:@[ subexpression ]];
      } else if ([op isEqualToString:@"^"] && [argumentObjects.firstObject isEqual:@[ @"e" ]]) {
        functionName = @"exp:";
        subexpressions =
            [subexpressions subarrayWithRange:NSMakeRange(1, subexpressions.count - 1)];
      }

      return [NSExpression expressionForFunctionHelper:functionName arguments:subexpressions];
      ...
      if ([argumentObjects.firstObject isKindOfClass:[NSArray class]]) {
        return [NSExpression
            expressionForAggregate:MLNSubexpressionsWithJSONObjects(argumentObjects.firstObject)];
      }
      return [NSExpression expressionWithMLNJSONObject:argumentObjects.firstObject];
    } else if ([op isEqualToString:@"to-boolean"]) {
      NSExpression *operand =
          [NSExpression expressionWithMLNJSONObject:argumentObjects.firstObject];
      ...
      argumentObjects =
          [argumentObjects subarrayWithRange:NSMakeRange(1, argumentObjects.count - 1)];
      NSArray *subexpressions = MLNSubexpressionsWithJSONObjects(argumentObjects);
      return [NSExpression expressionForFunction:operand
                                    selectorName:@"mgl_numberWithFallbackValues:"
      ...
      if (argumentObjects.count == 2) {
        NSExpression *operand =
            [NSExpression expressionWithMLNJSONObject:argumentObjects.lastObject];
      ...
      return [NSExpression expressionForFunction:function
                                       arguments:@[ subexpressions.firstObject ]];
      ...
      return [NSExpression expressionForFunction:@"objectFrom:withIndex:"
                                       arguments:@[ operand, index ]];
    } else if ([op isEqualToString:@"has"]) {
      NSArray *subexpressions = MLNSubexpressionsWithJSONObjects(argumentObjects);
      NSExpression *operand = argumentObjects.count > 1
                                  ? subexpressions[1]
                                  : [NSExpression expressionForEvaluatedObject];
      NSExpression *key = subexpressions.firstObject;
      return [NSExpression expressionForFunctionHelper:@"mgl_does:have:"
                                             arguments:@[ operand, key ]];
      ...
      if ([curveType isEqual:@"exponential"]) {
        ...
        curveParameters =
            @[ @"literal", [interpolationOptions subarrayWithRange:NSMakeRange(1, 4)] ];
        interpolationMode = MLNExpressionInterpolationModeCubicBezier;
      } else {
        curveParameters = [NSNull null];
      }
      NSExpression *curveParameterExpression =
          [NSExpression expressionWithMLNJSONObject:curveParameters];
      argumentObjects =
          [argumentObjects subarrayWithRange:NSMakeRange(1, argumentObjects.count - 1)];
      NSExpression *inputExpression =
          [NSExpression expressionWithMLNJSONObject:argumentObjects.firstObject];
      NSArray *stopExpressions =
          [argumentObjects subarrayWithRange:NSMakeRange(1, argumentObjects.count - 1)];
      NSMutableDictionary *stops =
          [NSMutableDictionary dictionaryWithCapacity:stopExpressions.count / 2];
      ...
      if (stopExpressions.count % 2) {
        ...
        stopExpressions =
            [stopExpressions subarrayWithRange:NSMakeRange(1, stopExpressions.count - 1)];
      }
      NSMutableDictionary *stops =
          [NSMutableDictionary dictionaryWithCapacity:stopExpressions.count / 2];
      NSEnumerator *stopEnumerator = stopExpressions.objectEnumerator;
      ...
      if (arguments.count == 3) {
        ...
        return [NSExpression expressionForConditional:conditional
                                       trueExpression:arguments[1]
                                      falseExpression:arguments[2]];
      }
      ...
      for (NSUInteger index = 0; index < argumentObjects.count; index++) {
        ...
        // match operators with arrays as matching values should not parse arrays as generic
        // functions.
        if (index > 0 && index < argumentObjects.count - 1 && !(index % 2 == 0) &&
            [argumentObjects[index] isKindOfClass:[NSArray class]]) {
          option = [NSExpression
              expressionForAggregate:MLNSubexpressionsWithJSONObjects(argumentObjects[index])];
        }
      ...
      for (NSUInteger index = 0; index < argumentObjects.count; index += 2) {
        NSExpression *expression =
            [NSExpression expressionWithMLNJSONObject:argumentObjects[index]];
        ...
        MLNAttributedExpression *attributedExpression =
            [[MLNAttributedExpression alloc] initWithExpression:expression attributes:attrs];

        [attributedExpressions
            addObject:[NSExpression expressionForConstantValue:attributedExpression]];
      }
      return [NSExpression expressionForFunctionHelper:@"mgl_attributed:"
                                             arguments:attributedExpressions];
      ...
      return [NSExpression
          expressionForFunctionHelper:@"mgl_coalesce:"
                            arguments:@[ [NSExpression expressionForConstantValue:expressions] ]];
    } else {
      NSArray *subexpressions = MLNSubexpressionsWithJSONObjects(array);
      return [NSExpression expressionForFunctionHelper:@"MLN_FUNCTION" arguments:subexpressions];
    }
  ...
  switch (self.expressionType) {
    ...
    case NSConstantValueExpressionType: {
      ...
      if ([constantValue isKindOfClass:[NSValue class]]) {
        ...
        if (strcmp([boxedValue objCType], @encode(MLNEdgeInsets)) == 0) {
          ...
          return
              @[ @"literal", @[ @(mglValue[0]), @(mglValue[1]), @(mglValue[2]), @(mglValue[3]) ] ];
        }
      }
      if ([constantValue isKindOfClass:[MLNAttributedExpression class]]) {
        ...
        NSMutableDictionary<MLNAttributedExpressionKey, NSExpression *> *attributedDictionary =
            [NSMutableDictionary dictionary];

        if (attributedExpression.attributes) {
          attributedDictionary =
              [NSMutableDictionary dictionaryWithDictionary:attributedExpression.attributes];

          for (NSString *key in attributedExpression.attributes.allKeys) {
            attributedDictionary[key] =
                attributedExpression.attributes[key].mgl_jsonExpressionObject;
          }
        }
    ...
    case NSFunctionExpressionType: {
      ...
      BOOL hasCollectionProperty =
          !(![self.arguments.firstObject isKindOfClass:[NSExpression class]] ||
            self.arguments.firstObject.expressionType != NSAggregateExpressionType ||
            self.arguments.firstObject.expressionType == NSSubqueryExpressionType);
      NSString *op = MLNExpressionOperatorsByFunctionNames[function];
      if (op) {
        NSArray *arguments = self.arguments.mgl_jsonExpressionObject;
        return [@[ op ] arrayByAddingObjectsFromArray:arguments];
      } else if ([function isEqualToString:@"valueForKey:"] ||
                 [function isEqualToString:@"valueForKeyPath:"]) {
        return @[
          @"get", self.arguments.firstObject.mgl_jsonExpressionObject,
          self.operand.mgl_jsonExpressionObject
        ];
      } else if ([function isEqualToString:@"average:"]) {
        NSExpression *sum = [NSExpression expressionForFunction:@"sum:" arguments:self.arguments];
        NSExpression *count = [NSExpression expressionForFunction:@"count:"
                                                        arguments:self.arguments];
        return [NSExpression expressionForFunction:@"divide:by:" arguments:@[ sum, count ]]
            .mgl_jsonExpressionObject;
      } else if ([function isEqualToString:@"sum:"]) {
        NSArray *arguments;
        if (hasCollectionProperty) {
          arguments =
              [self.arguments.firstObject.collection valueForKeyPath:@"mgl_jsonExpressionObject"];
        } else {
        ...
        return [NSExpression expressionForFunction:@"raise:toPower:"
                                         arguments:@[ @(M_E), self.arguments.firstObject ]]
            .mgl_jsonExpressionObject;
      } else if ([function isEqualToString:@"trunc:"]) {
        return [NSExpression expressionWithFormat:@"%@ - modulus:by:(%@, 1)",
                                                  self.arguments.firstObject,
                                                  self.arguments.firstObject]
            .mgl_jsonExpressionObject;
        ...
        NSArray *arguments = self.arguments.mgl_jsonExpressionObject;
        return [@[ @"concat", self.operand.mgl_jsonExpressionObject ]
        ...
        if ([self.arguments[1] expressionType] == NSConstantValueExpressionType &&
          ...
          if ([value isEqualToString:@"FIRST"]) {
            ...
            index = [NSExpression expressionWithFormat:@"count(%@) - 1", self.arguments[0]]
                        .mgl_jsonExpressionObject;
          } else if ([value isEqualToString:@"SIZE"]) {
            return [NSExpression expressionWithFormat:@"count(%@)", self.arguments[0]]
                .mgl_jsonExpressionObject;
          }
        }
        ...
        NSArray *arguments = self.arguments.mgl_jsonExpressionObject;
        return [@[ @"to-number", self.operand.mgl_jsonExpressionObject ]
            arrayByAddingObjectsFromArray:arguments];
        ...
        [context enumerateKeysAndObjectsUsingBlock:^(id _Nonnull key, NSExpression *_Nonnull obj,
                                                     BOOL *_Nonnull stop) {
        ...
        return expressionObject;
      } else if ([function isEqualToString:@"MLN_IF"] || [function isEqualToString:@"MLN_IF:"] ||
      ...
      } else if (op == (NSString *)[MLNColor class] &&
                 [function isEqualToString:@"colorWithRed:green:blue:alpha:"]) {
        NSArray *arguments = self.arguments.mgl_jsonExpressionObject;
        return [@[ @"rgba" ] arrayByAddingObjectsFromArray:arguments];
      } else if ([function isEqualToString:@"median:"] || [function isEqualToString:@"mode:"] ||
                 [function isEqualToString:@"stddev:"] || [function isEqualToString:@"random"] ||
                 [function isEqualToString:@"randomn:"] || [function isEqualToString:@"now"] ||
    ...
    case NSConditionalExpressionType: {
      NSMutableArray *arguments =
          [NSMutableArray arrayWithObjects:@"case", self.predicate.mgl_jsonExpressionObject, nil];
...
- (id)mgl_jsonInterpolationExpressionObject {
  ...
  if (self.arguments.count < expectedArgumentCount) {
    ...
    [NSException raise:NSInvalidArgumentException
                format:@"%lu unexpected arguments to ‘%@’ function; expected %lu arguments.",
                       ...
                       (unsigned long)expectedArgumentCount];
  }

  BOOL isAftermarketFunction =
      [self.function isEqualToString:@"mgl_interpolate:withCurveType:parameters:stops:"];
  ...
  if ([curveType isEqualToString:@"exponential"]) {
    ...
    NSArray *controlPoints =
        [self.arguments[curveTypeIndex + 1].collection mgl_jsonExpressionObject];
    [interpolationArray addObjectsFromArray:controlPoints];
  }

  NSDictionary<NSNumber *, NSExpression *> *stops =
      self.arguments[curveTypeIndex + 2].constantValue;

  if (stops.count == 0) {
    [NSException
         raise:NSInvalidArgumentException
        format:@"‘stops’ dictionary argument to ‘%@’ function must not be empty.", self.function];
  }

  NSMutableArray *expressionObject =
      [NSMutableArray arrayWithObjects:@"interpolate", interpolationArray, nil];
  [expressionObject addObject:(isAftermarketFunction ? self.arguments.firstObject : self.operand)
                                  .mgl_jsonExpressionObject];
...
- (id)mgl_jsonStepExpressionObject {
  ...
  NSMutableArray *expressionObject = [NSMutableArray
      arrayWithObjects:@"step",
                       (isAftermarketFunction ? self.arguments.firstObject : self.operand)
                           .mgl_jsonExpressionObject,
                       minimum, nil];
...
- (id)mgl_jsonMatchExpressionObject {
  ...
  for (NSUInteger index = minimumIndex; index < arguments.count; index++) {
    ...
    // match operators with arrays as matching values should not parse arrays using the literal
    // operator.
    if (index > 0 && index < arguments.count - 1 && !(index % 2 == 0)) {
      ...
      if (expression.expressionType == NSAggregateExpressionType ||
          (expression.expressionType == NSConstantValueExpressionType &&
           [expression.constantValue isKindOfClass:[NSArray class]])) {
...
- (id)mgl_jsonCoalesceExpressionObject {
  ...
  for (NSExpression *expression in (isAftermarketFunction ? self.arguments.firstObject
                                                          : self.operand)
           .constantValue) {
...
- (id)mgl_jsonHasExpressionObject {
  ...
  NSMutableArray *expressionObject =
      [NSMutableArray arrayWithObjects:@"has", key.mgl_jsonExpressionObject, nil];
...
- (id)mgl_jsonFormatExpressionObject {
  ...
  if ([formatArray respondsToSelector:@selector(constantValue)] &&
      [formatArray.constantValue isKindOfClass:[NSArray class]]) {
 ...
 */
NSArray<NSExpression *> *MLNLocalizedCollection(NSArray<NSExpression *> *collection,
                                                NSLocale *_Nullable locale) {
  __block NSMutableArray *localizedCollection;
  [collection enumerateObjectsUsingBlock:^(NSExpression *_Nonnull item, NSUInteger idx,
                                           BOOL *_Nonnull stop) {
...
/**
 ...
 dictionary.
 */
NSDictionary<NSNumber *, NSExpression *> *MLNLocalizedStopDictionary(
    NSDictionary<NSNumber *, NSExpression *> *stops, NSLocale *_Nullable locale) {
  __block NSMutableDictionary *localizedStops;
  [stops enumerateKeysAndObjectsUsingBlock:^(id _Nonnull zoomLevel, NSExpression *_Nonnull value,
                                             BOOL *_Nonnull stop) {
  ...
  switch (self.expressionType) {
    case NSConstantValueExpressionType: {
      if ([self.constantValue isKindOfClass:[NSDictionary class]]) {
        ...
        MLNAttributedExpression *attributedExpression =
            (MLNAttributedExpression *)self.constantValue;
        NSExpression *localizedExpression =
            [attributedExpression.expression mgl_expressionLocalizedIntoLocale:locale];
        MLNAttributedExpression *localizedAttributedExpression =
            [MLNAttributedExpression attributedExpression:localizedExpression
                                               attributes:attributedExpression.attributes];
    ...
    case NSKeyPathExpressionType: {
      if ([self.keyPath isEqualToString:@"name"] || [self.keyPath hasPrefix:@"name_"]) {
        ...
        if (![locale.localeIdentifier isEqualToString:@"mul"]) {
          NSArray *preferences =
              locale ? @[ locale.localeIdentifier ] : [NSLocale preferredLanguages];
          NSString *preferredLanguage =
              [MLNVectorTileSource preferredMapboxStreetsLanguageForPreferences:preferences];
        ...
        // Mapbox Streets v8 has `name_zh-Hant`, we should fallback to Simplified Chinese if the
        // field has no value.
        ...
        return
            [NSExpression expressionForFunctionHelper:@"mgl_coalesce:"
                                            arguments:@[ [NSExpression expressionForConstantValue:@[
                                              [NSExpression expressionForKeyPath:localizedKeyPath],
                                              [NSExpression expressionForKeyPath:@"name"],
                                            ]] ]];
    ...
    case NSConditionalExpressionType: {
      ...
      NSExpression *localizedTrueExpression =
          [trueExpression mgl_expressionLocalizedIntoLocale:locale];
      NSExpression *falseExpression = self.falseExpression;
      NSExpression *localizedFalseExpression =
          [falseExpression mgl_expressionLocalizedIntoLocale:locale];
      if (localizedTrueExpression != trueExpression ||
          localizedFalseExpression != falseExpression) {
