...
class PluginLayerPeerFactory : public LayerPeerFactory,
                               public mbgl::PluginLayerFactory {
 public:
  PluginLayerPeerFactory(
      std::string& layerType, mbgl::style::LayerTypeInfo::Source source,
      ...
      : mbgl::PluginLayerFactory(layerType, source, pass3D, layout, fadingTiles,
                                 crossTileIndex, tileKind) {}
