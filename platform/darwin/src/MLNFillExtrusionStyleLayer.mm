...
- (instancetype)initWithIdentifier:(NSString *)identifier source:(MLNSource *)source {
  MLNLogDebug(@"Initializing %@ with identifier: %@ source: %@", NSStringFromClass([self class]),
              identifier, source);
  auto layer = std::make_unique<mbgl::style::FillExtrusionLayer>(identifier.UTF8String,
...
- (void)setFillExtrusionBase:(NSExpression *)fillExtrusionBase {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(fillExtrusionBase, true);
...
- (MLNTransition)fillExtrusionBaseTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getFillExtrusionBaseTransition();
...
- (void)setFillExtrusionColor:(NSExpression *)fillExtrusionColor {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<mbgl::Color, MLNColor *>()
          .toPropertyValue<mbgl::style::PropertyValue<mbgl::Color>>(fillExtrusionColor, true);
...
- (MLNTransition)fillExtrusionColorTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getFillExtrusionColorTransition();
...
- (void)setFillExtrusionHasVerticalGradient:(NSExpression *)fillExtrusionHasVerticalGradient {
  ...
  auto mbglValue = MLNStyleValueTransformer<bool, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<bool>>(
                           fillExtrusionHasVerticalGradient, false);
...
- (void)setFillExtrusionHeight:(NSExpression *)fillExtrusionHeight {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<float, NSNumber *>()
          .toPropertyValue<mbgl::style::PropertyValue<float>>(fillExtrusionHeight, true);
...
- (MLNTransition)fillExtrusionHeightTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getFillExtrusionHeightTransition();
...
- (void)setFillExtrusionOpacity:(NSExpression *)fillExtrusionOpacity {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<float, NSNumber *>()
          .toPropertyValue<mbgl::style::PropertyValue<float>>(fillExtrusionOpacity, false);
...
- (void)setFillExtrusionOpacityTransition:(MLNTransition)transition {
  MLNAssertStyleLayerIsValid();
  MLNLogDebug(@"Setting fillExtrusionOpacityTransition: %@",
...
- (MLNTransition)fillExtrusionOpacityTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getFillExtrusionOpacityTransition();
...
- (void)setFillExtrusionPatternTransition:(MLNTransition)transition {
  MLNAssertStyleLayerIsValid();
  MLNLogDebug(@"Setting fillExtrusionPatternTransition: %@",
              MLNStringFromMLNTransition(transition));
...
- (MLNTransition)fillExtrusionPatternTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getFillExtrusionPatternTransition();
...
- (void)setFillExtrusionTranslation:(NSExpression *)fillExtrusionTranslation {
  ...
  auto mbglValue = MLNStyleValueTransformer<std::array<float, 2>, NSValue *>()
                       .toPropertyValue<mbgl::style::PropertyValue<std::array<float, 2>>>(
                           fillExtrusionTranslation, false);
...
- (void)setFillExtrusionTranslationTransition:(MLNTransition)transition {
  MLNAssertStyleLayerIsValid();
  MLNLogDebug(@"Setting fillExtrusionTranslationTransition: %@",
              MLNStringFromMLNTransition(transition));
...
- (MLNTransition)fillExtrusionTranslationTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getFillExtrusionTranslateTransition();
...
+ (NSValue *)valueWithMLNFillExtrusionTranslationAnchor:
    (MLNFillExtrusionTranslationAnchor)fillExtrusionTranslationAnchor {
  return [NSValue value:&fillExtrusionTranslationAnchor
           withObjCType:@encode(MLNFillExtrusionTranslationAnchor)];
}
