...
- (instancetype)initWithIdentifier:(NSString *)identifier source:(MLNSource *)source {
  MLNLogDebug(@"Initializing %@ with identifier: %@ source: %@", NSStringFromClass([self class]),
              identifier, source);
  auto layer = std::make_unique<mbgl::style::CircleLayer>(identifier.UTF8String,
...
- (void)setCircleSortKey:(NSExpression *)circleSortKey {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(circleSortKey, true);
...
- (void)setCircleBlur:(NSExpression *)circleBlur {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(circleBlur, true);
...
- (void)setCircleColor:(NSExpression *)circleColor {
  ...
  auto mbglValue = MLNStyleValueTransformer<mbgl::Color, MLNColor *>()
                       .toPropertyValue<mbgl::style::PropertyValue<mbgl::Color>>(circleColor, true);
...
- (void)setCircleOpacity:(NSExpression *)circleOpacity {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(circleOpacity, true);
...
- (void)setCirclePitchAlignment:(NSExpression *)circlePitchAlignment {
  ...
  auto mbglValue = MLNStyleValueTransformer<mbgl::style::AlignmentType, NSValue *,
                                            mbgl::style::AlignmentType, MLNCirclePitchAlignment>()
                       .toPropertyValue<mbgl::style::PropertyValue<mbgl::style::AlignmentType>>(
                           circlePitchAlignment, false);
...
- (void)setCircleRadius:(NSExpression *)circleRadius {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(circleRadius, true);
...
- (void)setCircleScaleAlignment:(NSExpression *)circleScaleAlignment {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<mbgl::style::CirclePitchScaleType, NSValue *,
                               mbgl::style::CirclePitchScaleType, MLNCircleScaleAlignment>()
          .toPropertyValue<mbgl::style::PropertyValue<mbgl::style::CirclePitchScaleType>>(
              circleScaleAlignment, false);
...
- (NSExpression *)circleScaleAlignment {
  ...
  return MLNStyleValueTransformer<mbgl::style::CirclePitchScaleType, NSValue *,
                                  mbgl::style::CirclePitchScaleType, MLNCircleScaleAlignment>()
      .toExpression(propertyValue);
}
...
- (void)setCircleStrokeColor:(NSExpression *)circleStrokeColor {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<mbgl::Color, MLNColor *>()
          .toPropertyValue<mbgl::style::PropertyValue<mbgl::Color>>(circleStrokeColor, true);
...
- (MLNTransition)circleStrokeColorTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getCircleStrokeColorTransition();
...
- (void)setCircleStrokeOpacity:(NSExpression *)circleStrokeOpacity {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<float, NSNumber *>()
          .toPropertyValue<mbgl::style::PropertyValue<float>>(circleStrokeOpacity, true);
...
- (MLNTransition)circleStrokeOpacityTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getCircleStrokeOpacityTransition();
...
- (void)setCircleStrokeWidth:(NSExpression *)circleStrokeWidth {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(circleStrokeWidth, true);
...
- (MLNTransition)circleStrokeWidthTransition {
  ...
  mbgl::style::TransitionOptions transitionOptions =
      self.rawLayer->getCircleStrokeWidthTransition();
...
- (void)setCircleTranslationAnchor:(NSExpression *)circleTranslationAnchor {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<mbgl::style::TranslateAnchorType, NSValue *,
                               mbgl::style::TranslateAnchorType, MLNCircleTranslationAnchor>()
          .toPropertyValue<mbgl::style::PropertyValue<mbgl::style::TranslateAnchorType>>(
              circleTranslationAnchor, false);
...
+ (NSValue *)valueWithMLNCircleTranslationAnchor:
