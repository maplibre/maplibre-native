...
// A struct to be stored in the `peer` member of mln::style::Layer, in order to implement
...
// "pending" MLNStyleLayers, which have a strong owning pointer to the mln::style::Layer.
struct LayerWrapper {
...
/**
 ...
 value returned by `mln::Map getLayer`, or for independently created objects,
