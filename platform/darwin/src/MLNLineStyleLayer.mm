...
- (instancetype)initWithIdentifier:(NSString *)identifier source:(MLNSource *)source {
  MLNLogDebug(@"Initializing %@ with identifier: %@ source: %@", NSStringFromClass([self class]),
              identifier, source);
  auto layer =
      std::make_unique<mbgl::style::LineLayer>(identifier.UTF8String, source.identifier.UTF8String);
...
- (void)setLineCap:(NSExpression *)lineCap {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<mbgl::style::LineCapType, NSValue *, mbgl::style::LineCapType,
                               MLNLineCap>()
          .toPropertyValue<mbgl::style::PropertyValue<mbgl::style::LineCapType>>(lineCap, false);
...
- (NSExpression *)lineCap {
  ...
  return MLNStyleValueTransformer<mbgl::style::LineCapType, NSValue *, mbgl::style::LineCapType,
                                  MLNLineCap>()
...
- (void)setLineJoin:(NSExpression *)lineJoin {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<mbgl::style::LineJoinType, NSValue *, mbgl::style::LineJoinType,
                               MLNLineJoin>()
          .toPropertyValue<mbgl::style::PropertyValue<mbgl::style::LineJoinType>>(lineJoin, true);
...
- (NSExpression *)lineJoin {
  ...
  return MLNStyleValueTransformer<mbgl::style::LineJoinType, NSValue *, mbgl::style::LineJoinType,
                                  MLNLineJoin>()
      .toExpression(propertyValue);
}
...
- (void)setLineMiterLimit:(NSExpression *)lineMiterLimit {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(lineMiterLimit, false);
...
- (void)setLineRoundLimit:(NSExpression *)lineRoundLimit {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(lineRoundLimit, false);
...
- (void)setLineSortKey:(NSExpression *)lineSortKey {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(lineSortKey, true);
...
- (void)setLineBlur:(NSExpression *)lineBlur {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(lineBlur, true);
...
- (void)setLineColor:(NSExpression *)lineColor {
  ...
  auto mbglValue = MLNStyleValueTransformer<mbgl::Color, MLNColor *>()
                       .toPropertyValue<mbgl::style::PropertyValue<mbgl::Color>>(lineColor, true);
...
- (void)setLineDashPattern:(NSExpression *)lineDashPattern {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<std::vector<float>, NSArray<NSNumber *> *, float>()
          .toPropertyValue<mbgl::style::PropertyValue<std::vector<float>>>(lineDashPattern, false);
...
- (NSExpression *)lineDashPattern {
  ...
  return MLNStyleValueTransformer<std::vector<float>, NSArray<NSNumber *> *, float>().toExpression(
      propertyValue);
}
...
- (void)setLineGapWidth:(NSExpression *)lineGapWidth {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(lineGapWidth, true);
...
- (void)setLineGradient:(NSExpression *)lineGradient {
  ...
  auto mbglValue = MLNStyleValueTransformer<mbgl::Color, MLNColor *>()
                       .toPropertyValue<mbgl::style::ColorRampPropertyValue>(lineGradient);
...
- (void)setLineOffset:(NSExpression *)lineOffset {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(lineOffset, true);
...
- (void)setLineOpacity:(NSExpression *)lineOpacity {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(lineOpacity, true);
...
- (void)setLineTranslationAnchor:(NSExpression *)lineTranslationAnchor {
  ...
  auto mbglValue =
      MLNStyleValueTransformer<mbgl::style::TranslateAnchorType, NSValue *,
                               mbgl::style::TranslateAnchorType, MLNLineTranslationAnchor>()
          .toPropertyValue<mbgl::style::PropertyValue<mbgl::style::TranslateAnchorType>>(
              lineTranslationAnchor, false);
...
- (void)setLineWidth:(NSExpression *)lineWidth {
  ...
  auto mbglValue = MLNStyleValueTransformer<float, NSNumber *>()
                       .toPropertyValue<mbgl::style::PropertyValue<float>>(lineWidth, true);
