...
- (void)testPredicates {
  ...
  MLNShapeSource *source = [[MLNShapeSource alloc] initWithIdentifier:@"sourceID"
                                                                shape:feature
                                                              options:nil];
  MLNCircleStyleLayer *layer = [[MLNCircleStyleLayer alloc] initWithIdentifier:@"layerID"
                                                                        source:source];
...
- (void)testProperties {
  ...
  // circle-sort-key
  {
    ...
    XCTAssertEqual(
        rawLayer->getCircleSortKey(), propertyValue,
  ...
  // circle-color
  {
    ...
    XCTAssertEqual(
        rawLayer->getCircleColor(), propertyValue,
  ...
  // circle-opacity
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getCircleOpacity(), propertyValue,
  ...
  // circle-pitch-alignment
  {
    ...
    XCTAssertEqual(rawLayer->getCirclePitchAlignment(), propertyValue,
                   @"Setting circlePitchAlignment to a constant value expression should update "
                   @"circle-pitch-alignment.");
    ...
    XCTAssertEqual(rawLayer->getCirclePitchAlignment(), propertyValue,
                   @"Setting circlePitchAlignment to a camera expression should update "
                   @"circle-pitch-alignment.");
    ...
    XCTAssertTrue(rawLayer->getCirclePitchAlignment().isUndefined(),
                  @"Unsetting circlePitchAlignment should return circle-pitch-alignment to the "
                  @"default value.");
    XCTAssertEqualObjects(
        layer.circlePitchAlignment, defaultExpression,
        @"circlePitchAlignment should return the default value after being unset.");

    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.circlePitchAlignment = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNCircleLayer should raise an exception if a camera-data expression is applied to a "
  ...
  // circle-radius
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getCircleRadius(), propertyValue,
  ...
  // circle-pitch-scale
  {
    ...
    mbgl::style::PropertyValue<mbgl::style::CirclePitchScaleType> propertyValue = {
        mbgl::style::CirclePitchScaleType::Viewport};
    XCTAssertEqual(rawLayer->getCirclePitchScale(), propertyValue,
                   @"Setting circleScaleAlignment to a constant value expression should update "
                   @"circle-pitch-scale.");
    ...
    XCTAssertEqual(
        rawLayer->getCirclePitchScale(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getCirclePitchScale().isUndefined(),
        @"Unsetting circleScaleAlignment should return circle-pitch-scale to the default value.");
    XCTAssertEqualObjects(
        layer.circleScaleAlignment, defaultExpression,
        @"circleScaleAlignment should return the default value after being unset.");

    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.circleScaleAlignment = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNCircleLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // circle-stroke-color
  {
    ...
    XCTAssertEqual(rawLayer->getCircleStrokeColor(), propertyValue,
                   @"Setting circleStrokeColor to a constant value expression should update "
                   @"circle-stroke-color.");
    ...
    XCTAssertEqual(
        rawLayer->getCircleStrokeColor(), propertyValue,
    ...
    XCTAssertEqual(rawLayer->getCircleStrokeColor(), propertyValue,
                   @"Setting circleStrokeColor to a camera-data expression should update "
                   @"circle-stroke-color.");
    pedanticFunctionExpression = [NSExpression
        expressionWithFormat:
            @"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)",
    ...
    XCTAssertTrue(
        rawLayer->getCircleStrokeColor().isUndefined(),
  ...
  // circle-stroke-opacity
  {
    ...
    XCTAssertEqual(rawLayer->getCircleStrokeOpacity(), propertyValue,
                   @"Setting circleStrokeOpacity to a constant value expression should update "
                   @"circle-stroke-opacity.");
    ...
    XCTAssertEqual(
        rawLayer->getCircleStrokeOpacity(), propertyValue,
    ...
    XCTAssertEqual(rawLayer->getCircleStrokeOpacity(), propertyValue,
                   @"Setting circleStrokeOpacity to a camera-data expression should update "
                   @"circle-stroke-opacity.");
    pedanticFunctionExpression = [NSExpression
        expressionWithFormat:
            @"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)",
    ...
    XCTAssertTrue(
        rawLayer->getCircleStrokeOpacity().isUndefined(),
        @"Unsetting circleStrokeOpacity should return circle-stroke-opacity to the default value.");
    XCTAssertEqualObjects(
        layer.circleStrokeOpacity, defaultExpression,
  ...
  // circle-stroke-width
  {
    ...
    XCTAssertEqual(rawLayer->getCircleStrokeWidth(), propertyValue,
                   @"Setting circleStrokeWidth to a constant value expression should update "
                   @"circle-stroke-width.");
    ...
    XCTAssertEqual(
        rawLayer->getCircleStrokeWidth(), propertyValue,
    ...
    XCTAssertEqual(rawLayer->getCircleStrokeWidth(), propertyValue,
                   @"Setting circleStrokeWidth to a camera-data expression should update "
                   @"circle-stroke-width.");
    pedanticFunctionExpression = [NSExpression
        expressionWithFormat:
            @"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)",
    ...
    XCTAssertTrue(
        rawLayer->getCircleStrokeWidth().isUndefined(),
  ...
  // circle-translate
  {
    ...
    XCTAssertEqual(rawLayer->getCircleTranslate(), propertyValue,
                   @"Setting circleTranslation to a constant value expression should update "
                   @"circle-translate.");
    ...
    XCTAssertEqual(
        rawLayer->getCircleTranslate(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getCircleTranslate().isUndefined(),
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.circleTranslation = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNCircleLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // circle-translate-anchor
  {
    ...
    XCTAssertEqual(rawLayer->getCircleTranslateAnchor(), propertyValue,
                   @"Setting circleTranslationAnchor to a constant value expression should update "
                   @"circle-translate-anchor.");
    ...
    XCTAssertEqual(rawLayer->getCircleTranslateAnchor(), propertyValue,
                   @"Setting circleTranslationAnchor to a camera expression should update "
                   @"circle-translate-anchor.");
    ...
    XCTAssertTrue(rawLayer->getCircleTranslateAnchor().isUndefined(),
                  @"Unsetting circleTranslationAnchor should return circle-translate-anchor to the "
                  @"default value.");
    XCTAssertEqualObjects(
        layer.circleTranslationAnchor, defaultExpression,
        @"circleTranslationAnchor should return the default value after being unset.");

    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.circleTranslationAnchor = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNCircleLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
...
- (void)testValueAdditions {
  XCTAssertEqual([NSValue valueWithMLNCirclePitchAlignment:MLNCirclePitchAlignmentMap]
                     .MLNCirclePitchAlignmentValue,
                 MLNCirclePitchAlignmentMap);
  XCTAssertEqual([NSValue valueWithMLNCirclePitchAlignment:MLNCirclePitchAlignmentViewport]
                     .MLNCirclePitchAlignmentValue,
                 MLNCirclePitchAlignmentViewport);
  XCTAssertEqual([NSValue valueWithMLNCircleScaleAlignment:MLNCircleScaleAlignmentMap]
                     .MLNCircleScaleAlignmentValue,
                 MLNCircleScaleAlignmentMap);
  XCTAssertEqual([NSValue valueWithMLNCircleScaleAlignment:MLNCircleScaleAlignmentViewport]
                     .MLNCircleScaleAlignmentValue,
                 MLNCircleScaleAlignmentViewport);
  XCTAssertEqual([NSValue valueWithMLNCircleTranslationAnchor:MLNCircleTranslationAnchorMap]
                     .MLNCircleTranslationAnchorValue,
                 MLNCircleTranslationAnchorMap);
  XCTAssertEqual([NSValue valueWithMLNCircleTranslationAnchor:MLNCircleTranslationAnchorViewport]
                     .MLNCircleTranslationAnchorValue,
