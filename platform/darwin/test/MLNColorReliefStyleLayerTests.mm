...
- (void)testProperties {
  ...
  MLNColorReliefStyleLayer *layer = [[MLNColorReliefStyleLayer alloc] initWithIdentifier:@"layerID"
                                                                                  source:source];
  ...
  // color-relief-opacity
  {
    ...
    XCTAssertEqual(rawLayer->getColorReliefOpacity(), propertyValue,
                   @"Setting colorReliefOpacity to a constant value expression should update "
                   @"color-relief-opacity.");
    ...
    XCTAssertEqual(
        rawLayer->getColorReliefOpacity(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getColorReliefOpacity().isUndefined(),
    ...
    XCTAssertThrowsSpecificNamed(
        layer.colorReliefOpacity = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNColorReliefLayer should raise an exception if a camera-data expression is applied to "
        @"a property that does not support key paths to feature attributes.");
