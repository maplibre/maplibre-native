...
- (void)testPredicates {
  ...
  MLNShapeSource *source = [[MLNShapeSource alloc] initWithIdentifier:@"sourceID"
                                                                shape:feature
                                                              options:nil];
  MLNLineStyleLayer *layer = [[MLNLineStyleLayer alloc] initWithIdentifier:@"layerID"
                                                                    source:source];
...
- (void)testProperties {
  ...
  // line-cap
  {
    XCTAssertTrue(rawLayer->getLineCap().isUndefined(), @"line-cap should be unset initially.");
    ...
    mbgl::style::PropertyValue<mbgl::style::LineCapType> propertyValue = {
    ...
    XCTAssertThrowsSpecificNamed(
        layer.lineCap = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNLineLayer should raise an exception if a camera-data expression is applied to a "
  ...
  // line-join
  {
    XCTAssertTrue(rawLayer->getLineJoin().isUndefined(), @"line-join should be unset initially.");
    ...
    mbgl::style::PropertyValue<mbgl::style::LineJoinType> propertyValue = {
  ...
  // line-miter-limit
  {
    ...
    XCTAssertEqual(
        rawLayer->getLineMiterLimit(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.lineMiterLimit = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNLineLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // line-round-limit
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getLineRoundLimit(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.lineRoundLimit = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNLineLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // line-sort-key
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getLineSortKey(), propertyValue,
  ...
  // line-blur
  {
    XCTAssertTrue(rawLayer->getLineBlur().isUndefined(), @"line-blur should be unset initially.");
  ...
  // line-color
  {
    XCTAssertTrue(rawLayer->getLineColor().isUndefined(), @"line-color should be unset initially.");
  ...
  // line-dasharray
  {
    ...
    XCTAssertEqual(
        rawLayer->getLineDasharray(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.lineDashPattern = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNLineLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // line-gap-width
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getLineGapWidth(), propertyValue,
  ...
  // line-opacity
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getLineOpacity(), propertyValue,
  ...
  // line-pattern
  {
    ...
    XCTAssertEqual(
        rawLayer->getLinePattern(), propertyValue,
    ...
    constantExpression =
        [NSExpression expressionWithFormat:@"MLN_FUNCTION('image', 'Line Pattern')"];
    XCTExpectFailure(
        @"Awaiting unit test refactoring https://github.com/maplibre/maplibre-native/issues/421");
    NSExpression *functionExpression = [NSExpression
        expressionWithFormat:@"mgl_step:from:stops:($zoomLevel, %@, %@)", constantExpression,
  ...
  // line-translate
  {
    ...
    XCTAssertEqual(
        rawLayer->getLineTranslate(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.lineTranslation = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNLineLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // line-translate-anchor
  {
    ...
    XCTAssertEqual(rawLayer->getLineTranslateAnchor(), propertyValue,
                   @"Setting lineTranslationAnchor to a constant value expression should update "
                   @"line-translate-anchor.");
    ...
    XCTAssertEqual(rawLayer->getLineTranslateAnchor(), propertyValue,
                   @"Setting lineTranslationAnchor to a camera expression should update "
                   @"line-translate-anchor.");
    ...
    XCTAssertTrue(rawLayer->getLineTranslateAnchor().isUndefined(),
                  @"Unsetting lineTranslationAnchor should return line-translate-anchor to the "
                  @"default value.");
    XCTAssertEqualObjects(
        layer.lineTranslationAnchor, defaultExpression,
        @"lineTranslationAnchor should return the default value after being unset.");

    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.lineTranslationAnchor = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNLineLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // line-width
  {
    XCTAssertTrue(rawLayer->getLineWidth().isUndefined(), @"line-width should be unset initially.");
...
- (void)testValueAdditions {
  ...
  XCTAssertEqual([NSValue valueWithMLNLineJoin:MLNLineJoinBevel].MLNLineJoinValue,
                 MLNLineJoinBevel);
  XCTAssertEqual([NSValue valueWithMLNLineJoin:MLNLineJoinRound].MLNLineJoinValue,
                 MLNLineJoinRound);
  XCTAssertEqual([NSValue valueWithMLNLineJoin:MLNLineJoinMiter].MLNLineJoinValue,
                 MLNLineJoinMiter);
  XCTAssertEqual([NSValue valueWithMLNLineTranslationAnchor:MLNLineTranslationAnchorMap]
                     .MLNLineTranslationAnchorValue,
                 MLNLineTranslationAnchorMap);
  XCTAssertEqual([NSValue valueWithMLNLineTranslationAnchor:MLNLineTranslationAnchorViewport]
                     .MLNLineTranslationAnchorValue,
