...
- (void)testGeoJSONOptionsFromDictionary {
  NSExpression *reduceExpression =
      [NSExpression expressionForFunction:@"sum:"
                                arguments:@[
                                  [NSExpression expressionForKeyPath:@"featureAccumulated"],
                                  [NSExpression expressionForKeyPath:@"sumValue"]
                                ]];
...
- (void)testUnclusterableShape {
  ...
  MLNShapeSource *source = [[MLNShapeSource alloc] initWithIdentifier:@"id"
                                                                shape:[[MLNPointFeature alloc] init]
                                                              options:options];
...
- (void)testMLNShapeSourceWithDataMultipleFeatures {
  ...
  MLNShapeSource *source = [[MLNShapeSource alloc] initWithIdentifier:@"source-id"
                                                                shape:shape
                                                              options:nil];
...
- (void)testMLNShapeSourceWithSingleGeometry {
  ...
  XCTAssertNil(error);
  XCTAssertNotNil(shape);
  MLNShapeSource *source = [[MLNShapeSource alloc] initWithIdentifier:@"geojson"
                                                                shape:shape
                                                              options:nil];
...
- (void)testMLNShapeSourceWithPolylineFeatures {
  ...
  MLNPolylineFeature *polylineFeature = [MLNPolylineFeature polylineWithCoordinates:coordinates
                                                                              count:2];
...
- (void)testMLNShapeSourceWithPolygonFeatures {
  CLLocationCoordinate2D coordinates[] = {
      CLLocationCoordinate2DMake(0.0, 100.0), CLLocationCoordinate2DMake(0.0, 101.0),
      CLLocationCoordinate2DMake(1.0, 101.0), CLLocationCoordinate2DMake(1.0, 100.0),
      CLLocationCoordinate2DMake(0.0, 100.0)};

  MLNPolygonFeature *polygonFeature = [MLNPolygonFeature polygonWithCoordinates:coordinates
                                                                          count:5];
  ...
  XCTAssertEqualObjects(expectedPolygonFeature.attributes[@"dictionary-attribute"],
                        dictionaryValue);
  XCTAssertEqualObjects(expectedPolygonFeature.attributes[@"array-attribute"], arrayValue);
  XCTAssertEqualObjects(expectedPolygonFeature.attributes[@"array-of-array-attribute"],
                        arrayOfArrays);
  XCTAssertEqualObjects(expectedPolygonFeature.attributes[@"array-of-dictionary-attribute"],
                        arrayOfDictionaries);
}
...
- (void)testMLNShapeSourceWithPolygonFeaturesInculdingInteriorPolygons {
  ...
  CLLocationCoordinate2D interiorCoordinates[] = {
      CLLocationCoordinate2DMake(0.2, 100.2), CLLocationCoordinate2DMake(0.2, 100.8),
      CLLocationCoordinate2DMake(0.8, 100.8), CLLocationCoordinate2DMake(0.8, 100.2),
...
- (void)testMLNShapeSourceWithMultiPolylineFeatures {
  CLLocationCoordinate2D firstCoordinates[] = {CLLocationCoordinate2DMake(0, 0),
                                               CLLocationCoordinate2DMake(10, 10)};
  MLNPolylineFeature *firstPolylineFeature =
      [MLNPolylineFeature polylineWithCoordinates:firstCoordinates count:2];
  CLLocationCoordinate2D secondCoordinates[] = {CLLocationCoordinate2DMake(0, 0),
                                                CLLocationCoordinate2DMake(10, 10)};
  MLNPolylineFeature *secondPolylineFeature =
      [MLNPolylineFeature polylineWithCoordinates:secondCoordinates count:2];
  MLNMultiPolylineFeature *multiPolylineFeature = [MLNMultiPolylineFeature
      multiPolylineWithPolylines:@[ firstPolylineFeature, secondPolylineFeature ]];

  MLNShapeSource *source = [[MLNShapeSource alloc] initWithIdentifier:@"source-id"
                                                                shape:multiPolylineFeature
                                                              options:nil];
...
- (void)testMLNShapeSourceWithMultiPolygonFeatures {
  ...
  MLNPolygonFeature *firstPolygon = [MLNPolygonFeature polygonWithCoordinates:coordinates
                                                                        count:5
                                                             interiorPolygons:@[ polygon ]];
  MLNPolygonFeature *secondPolygon = [MLNPolygonFeature polygonWithCoordinates:coordinates
                                                                         count:5
                                                              interiorPolygons:@[ polygon ]];

  MLNMultiPolygonFeature *multiPolygonFeature =
      [MLNMultiPolygonFeature multiPolygonWithPolygons:@[ firstPolygon, secondPolygon ]];

  MLNShapeSource *source = [[MLNShapeSource alloc] initWithIdentifier:@"source-id"
                                                                shape:multiPolygonFeature
                                                              options:nil];
...
- (void)testMLNShapeSourceWithPointFeature {
  ...
  MLNShapeSource *source = [[MLNShapeSource alloc] initWithIdentifier:@"souce-id"
                                                                shape:pointFeature
                                                              options:nil];
...
- (void)testMLNShapeSourceWithPointCollectionFeature {
  CLLocationCoordinate2D coordinates[] = {
      ...
      CLLocationCoordinate2DMake(1.0, 101.0), CLLocationCoordinate2DMake(1.0, 100.0),
      CLLocationCoordinate2DMake(0.0, 100.0)};
  MLNPointCollectionFeature *pointCollectionFeature =
      [MLNPointCollectionFeature pointCollectionWithCoordinates:coordinates count:5];
  MLNShapeSource *source = [[MLNShapeSource alloc] initWithIdentifier:@"souce-id"
                                                                shape:pointCollectionFeature
                                                              options:nil];
...
- (void)testMLNShapeSourceWithShapeCollectionFeatures {
  ...
  CLLocationCoordinate2D coordinates_2[] = {CLLocationCoordinate2DMake(0, 0),
                                            CLLocationCoordinate2DMake(10, 10)};
  MLNPolylineFeature *polylineFeature = [MLNPolylineFeature polylineWithCoordinates:coordinates_2
                                                                              count:2];

  MLNMultiPolygonFeature *multiPolygonFeature =
      [MLNMultiPolygonFeature multiPolygonWithPolygons:@[ polygonFeature, polygonFeature ]];

  MLNMultiPolylineFeature *multiPolylineFeature =
      [MLNMultiPolylineFeature multiPolylineWithPolylines:@[ polylineFeature, polylineFeature ]];
  ...
  MLNShapeCollectionFeature *shapeCollectionFeature =
      [MLNShapeCollectionFeature shapeCollectionWithShapes:@[
        polygonFeature, polylineFeature, multiPolygonFeature, multiPolylineFeature,
        pointCollectionFeature, pointFeature
      ]];

  MLNShapeSource *source = [[MLNShapeSource alloc] initWithIdentifier:@"source-id"
                                                                shape:shapeCollectionFeature
                                                              options:nil];
...
#pragma clang diagnostic ignored "-Wobjc-literal-conversion"
  XCTAssertThrowsSpecificNamed(
      [[MLNShapeSource alloc] initWithIdentifier:@"source-id-invalid"
                                        features:@[ polygon ]
                                         options:nil],
      NSException, NSInvalidArgumentException,
      @"Shape source should raise an exception if a shape is sent to the features initializer");
