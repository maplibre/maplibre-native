...
- (void)testPolyline {
  ...
  MLNPolyline *polyline = [MLNPolyline polylineWithCoordinates:coordinates
  ...
  CLLocationCoordinate2D otherCoordinates[] = {CLLocationCoordinate2DMake(-1, -2)};
  ...
  NSUInteger multiLineCoordinatesCount =
      sizeof(multiLineCoordinates) / sizeof(CLLocationCoordinate2D);
  MLNPolyline *multiLine = [MLNPolyline polylineWithCoordinates:multiLineCoordinates
                                                          count:multiLineCoordinatesCount];
  ...
  MLNPolyline *segmentLine = [MLNPolyline polylineWithCoordinates:segmentCoordinates
                                                            count:segmentCoordinatesCount];
  ...
  NSUInteger sfToBerkeleyCoordinatesCount =
      sizeof(sfToBerkeleyCoordinates) / sizeof(CLLocationCoordinate2D);
  MLNPolyline *sfToBerkeleyLine =
      [MLNPolyline polylineWithCoordinates:sfToBerkeleyCoordinates
                                     count:sfToBerkeleyCoordinatesCount];
  CLLocationCoordinate2D sfToBerkeleyCenter =
      CLLocationCoordinate2DMake(37.8230575118, -122.324867587);

  XCTAssertEqualWithAccuracy([sfToBerkeleyLine coordinate].latitude, sfToBerkeleyCenter.latitude,
                             0.0001);
  XCTAssertEqualWithAccuracy([sfToBerkeleyLine coordinate].longitude, sfToBerkeleyCenter.longitude,
                             0.0001);
}

- (void)testPolygon {
  CLLocationCoordinate2D coordinates[] = {CLLocationCoordinate2DMake(35.090745, -85.300259),
  ...
  MLNPolygon *squarePolygon = [MLNPolygon polygonWithCoordinates:squareCoordinates
                                                           count:squareCoordinatesCount];
...
- (void)testPolygonWithInteriorPolygons {
  CLLocationCoordinate2D coordinates[] = {CLLocationCoordinate2DMake(0, 1),
                                          CLLocationCoordinate2DMake(10, 20)};

  NSUInteger numberOfCoordinates = sizeof(coordinates) / sizeof(CLLocationCoordinate2D);

  CLLocationCoordinate2D interiorCoordinates[] = {CLLocationCoordinate2DMake(4, 4),
                                                  CLLocationCoordinate2DMake(6, 6)};

  NSUInteger numberOfInteriorCoordinates =
      sizeof(interiorCoordinates) / sizeof(CLLocationCoordinate2D);

  MLNPolygon *interiorPolygon = [MLNPolygon polygonWithCoordinates:interiorCoordinates
                                                             count:numberOfInteriorCoordinates];
  MLNPolygon *polygon = [MLNPolygon polygonWithCoordinates:coordinates
                                                     count:numberOfCoordinates
...
- (void)testPolylineFeature {
  ...
  NSUInteger numberOfCoordinates = sizeof(coordinates) / sizeof(CLLocationCoordinate2D);
  MLNPolylineFeature *polylineFeature =
      [MLNPolylineFeature polylineWithCoordinates:coordinates count:numberOfCoordinates];
  ...
  MLNPolylineFeature *unarchivedPolylineFeature =
...
- (void)testPolygonFeature {
  ...
  NSUInteger numberOfCoordinates = sizeof(coordinates) / sizeof(CLLocationCoordinate2D);
  MLNPolygonFeature *polygonFeature =
      [MLNPolygonFeature polygonWithCoordinates:coordinates count:numberOfCoordinates];
  ...
  MLNPolygonFeature *unarchivedPolygonFeature =
      [NSKeyedUnarchiver unarchiveObjectWithFile:filePath];
...
- (void)testPointCollection {
  ...
  MLNPointCollection *pointCollection =
      [MLNPointCollection pointCollectionWithCoordinates:coordinates count:numberOfCoordinates];
  ...
  MLNPointCollection *unarchivedPointCollection =
      [NSKeyedUnarchiver unarchiveObjectWithFile:filePath];
...
- (void)testPointCollectionFeature {
  ...
  MLNPointCollectionFeature *collection =
      [MLNPointCollectionFeature pointCollectionWithCoordinates:coordinates
                                                          count:numberOfCoordinates];
  ...
  MLNPointCollectionFeature *unarchivedCollection =
      [NSKeyedUnarchiver unarchiveObjectWithFile:filePath];
...
- (void)testMultiPolyline {
  ...
  CLLocationCoordinate2D line1[] = {CLLocationCoordinate2DMake(100, 40),
                                    CLLocationCoordinate2DMake(105, 45),
                                    CLLocationCoordinate2DMake(110, 55)};

  CLLocationCoordinate2D line2[] = {CLLocationCoordinate2DMake(105, 40),
  ...
  MLNPolyline *road1Polyline = [MLNPolyline polylineWithCoordinates:line1
                                                              count:road1CoordinatesCount];
  MLNPolyline *road2Polyline = [MLNPolyline polylineWithCoordinates:line1
                                                              count:road2CoordinatesCount];

  MLNMultiPolyline *roads =
      [MLNMultiPolyline multiPolylineWithPolylines:@[ road1Polyline, road2Polyline ]];
  ...
  MLNMultiPolyline *anotherMultipolyline = [MLNMultiPolyline
      multiPolylineWithPolylines:[polylines subarrayWithRange:NSMakeRange(0, polylines.count / 2)]];
...
- (void)testMultiPolygon {
  ...
  MLNPolygon *innerPolygonSquare = [MLNPolygon polygonWithCoordinates:innerSquare
                                                                count:innerCoordinatesCount];
  ...
  MLNMultiPolygon *anotherMultiPolygon = [MLNMultiPolygon
      multiPolygonWithPolygons:[polygons subarrayWithRange:NSMakeRange(0, polygons.count / 2)]];
...
- (void)testShapeCollection {
  ...
  MLNShapeCollection *shapeCollection =
      [MLNShapeCollection shapeCollectionWithShapes:@[ polyline, polygon ]];
  ...
  MLNShapeCollection *unarchivedShapeCollection =
      [NSKeyedUnarchiver unarchiveObjectWithFile:filePath];
  MLNShapeCollection *anotherShapeCollection =
      [MLNShapeCollection shapeCollectionWithShapes:@[ polygon ]];
...
- (void)testMultiPolylineFeature {
  ...
  MLNMultiPolylineFeature *multiPolylineFeature =
      [MLNMultiPolylineFeature multiPolylineWithPolylines:polylines];
  ...
  MLNMultiPolylineFeature *unarchivedMultiPolylineFeature =
      [NSKeyedUnarchiver unarchiveObjectWithFile:filePath];
  MLNMultiPolylineFeature *anotherMultiPolylineFeature = [MLNMultiPolylineFeature
      multiPolylineWithPolylines:[polylines subarrayWithRange:NSMakeRange(0, polylines.count / 2)]];
...
- (void)testMultiPolygonFeature {
  ...
  MLNMultiPolygonFeature *multiPolygonFeature =
      [MLNMultiPolygonFeature multiPolygonWithPolygons:polygons];
  multiPolygonFeature.attributes = @{
    @"bbox" : @[
      @(arc4random_uniform(100)), @(arc4random_uniform(100)), @(arc4random_uniform(100)),
  ...
  MLNMultiPolygonFeature *unarchivedMultiPolygonFeature =
      [NSKeyedUnarchiver unarchiveObjectWithFile:filePath];
  MLNMultiPolygonFeature *anotherMultiPolygonFeature = [MLNMultiPolygonFeature
      multiPolygonWithPolygons:[polygons subarrayWithRange:NSMakeRange(0, polygons.count / 2)]];
...
- (void)testShapeCollectionFeature {
  ...
  MLNPolylineFeature *polyline = [MLNPolylineFeature polylineWithCoordinates:coordinates
                                                                       count:numberOfCoordinates];
  MLNPolygonFeature *polygon = [MLNPolygonFeature polygonWithCoordinates:coordinates
                                                                   count:numberOfCoordinates];

  MLNShapeCollectionFeature *shapeCollectionFeature =
      [MLNShapeCollectionFeature shapeCollectionWithShapes:@[ polyline, polygon ]];
  shapeCollectionFeature.identifier = @(arc4random_uniform(100)).stringValue;
  shapeCollectionFeature.attributes = @{
    @"bbox" : @[
      @(arc4random_uniform(100)), @(arc4random_uniform(100)), @(arc4random_uniform(100)),
      @(arc4random_uniform(100))
    ]
  ...
  MLNShapeCollectionFeature *unarchivedShapeCollectionFeature =
      [NSKeyedUnarchiver unarchiveObjectWithFile:filePath];
...
- (void)testAnnotationImage {
  ...
  MLNAnnotationImage *annotationImage =
      [MLNAnnotationImage annotationImageWithImage:image
                                   reuseIdentifier:@(arc4random_uniform(100)).stringValue];
  ...
  MLNAnnotationImage *unarchivedAnnotationImage =
      [NSKeyedUnarchiver unarchiveObjectWithFile:filePath];
...
- (void)testAnnotationView {
  ...
  MLNAnnotationView *unarchivedAnnotationView =
      [NSKeyedUnarchiver unarchiveObjectWithFile:filePath];
  ...
  XCTAssertEqualObjects(NSStringFromCGVector(annotationView.centerOffset),
                        NSStringFromCGVector(unarchivedAnnotationView.centerOffset));
  XCTAssertEqual(annotationView.scalesWithViewingDistance,
                 unarchivedAnnotationView.scalesWithViewingDistance);
}
#endif
...
- (void)testUserLocationAnnotationView {
  ...
  MLNUserLocationAnnotationView *unarchivedAnnotationView =
      [NSKeyedUnarchiver unarchiveObjectWithFile:filePath];
