...
- (void)testGeometryConversion {
  ...
  XCTAssertEqualObjects(
      [NSValue valueWithMLNCoordinate:pointShape.coordinate],
  ...
  XCTAssertEqualObjects(
      [NSValue valueWithMLNCoordinate:polylineCoordinates[0]],
      [NSValue valueWithMLNCoordinate:CLLocationCoordinate2DMake(39.1, -84.516667)]);
  XCTAssertEqualObjects(
      [NSValue valueWithMLNCoordinate:polylineCoordinates[1]],
      [NSValue valueWithMLNCoordinate:CLLocationCoordinate2DMake(29.95, -90.066667)]);
  ...
  [interiorPolygon getCoordinates:interiorPolygonCoordinates
                            range:NSMakeRange(0, interiorPolygon.pointCount)];
...
- (void)testPropertyConversion {
  ...
  XCTAssertTrue([identifier isKindOfClass:[NSNumber class]],
                @"Feature identifier should be NSNumber");
  XCTAssertEqual(strcmp(identifier.objCType, @encode(uint64_t)), 0,
                 @"Feature identifier should be 64-bit unsigned integer");
  ...
  XCTAssertEqual(strcmp(boolean.objCType, @encode(char)), 0,
                 @"Boolean property should be converted to bool NSNumber");
  ...
  XCTAssertEqual(strcmp(unsignedInteger.objCType, @encode(uint64_t)), 0,
                 @"Unsigned integer property should be converted to unsigned long long NSNumber");
  ...
  XCTAssertEqual(strcmp(integer.objCType, @encode(int64_t)), 0,
                 @"Integer property should be converted to long long NSNumber");
  ...
  XCTAssertEqual(strcmp(floatingPointNumber.objCType, @encode(double)), 0,
                 @"Floating-point number property should be converted to double NSNumber");
...
- (void)testMultiPolylineFeatureGeoJSONDictionary {
  ...
  MLNMultiPolylineFeature *multiPolylineFeature =
      [MLNMultiPolylineFeature multiPolylineWithPolylines:@[ polyLine1, polyLine2 ]];
...
- (void)testMultiPolygonFeatureGeoJSONDictionary {
  ...
  MLNMultiPolygonFeature *multiPolylineFeature =
      [MLNMultiPolygonFeature multiPolygonWithPolygons:@[ polygon1, polygon2 ]];
...
- (void)testPointCollectionFeatureGeoJSONDictionary {
  ...
  MLNPointCollectionFeature *pointCollectionFeature =
      [MLNPointCollectionFeature pointCollectionWithCoordinates:coords count:3];
...
- (void)testShapeCollectionFeatureGeoJSONDictionary {
  ...
  MLNShapeCollectionFeature *shapeCollectionFeature =
      [MLNShapeCollectionFeature shapeCollectionWithShapes:@[ pointFeature, polylineFeature ]];
  ...
  expectedGeometry = @{@"type" : @"GeometryCollection", @"geometries" : @[]};
  XCTAssertEqualObjects(geoJSONFeature[@"geometry"], expectedGeometry);
}
