...
- (void)testTileSetFromTileURLTemplates {
  ...
  MLNCoordinateBounds bounds = MLNCoordinateBoundsMake(CLLocationCoordinate2DMake(12, 34),
                                                       CLLocationCoordinate2DMake(56, 78));
  tileSet = MLNTileSetFromTileURLTemplates(@[ @"tile.1" ], @{
  ...
  MLNAttributionInfo *mapboxInfo = [[MLNAttributionInfo alloc]
      initWithTitle:[[NSAttributedString alloc] initWithString:@"Mapbox"]
...
#endif
  NSAttributedString *gl =
      [[NSAttributedString alloc] initWithString:@"GL"
                                      attributes:@{
  ...
  if (@available(iOS 13.0, *)) {
    ...
    html = (@"<font style=\"font-family: 'Helvetica'; font-weight: normal; font-style: normal; "
            @"font-size: 12.00px\">"
            @"<a href=\"https://www.mapbox.com/\">Mapbox</a> </font>"
            @"<font style=\"font-family: 'Helvetica'; font-weight: normal; font-style: normal; "
            @"font-size: 12.00px; background-color: #ff0000\">GL</font>\n");
  } else {
    html = (@"<font style=\"font-family: 'Helvetica'; font-weight: normal; font-style: normal; "
            @"font-size: 12.00pt\">"
            @"<a href=\"https://www.mapbox.com/\">Mapbox</a> </font>"
            @"<font style=\"font-family: 'Helvetica'; font-weight: normal; font-style: normal; "
            @"font-size: 12.00pt; background-color: #ff0000\">GL</font>\n");
  }
#else
  NSString *html = (@"<font face=\"Helvetica\" size=\"3\" style=\"font: 12.0px Helvetica\">"
                    ...
                    @"background-color: #ff0000\">GL</font>\n");
#endif
  ...
  tileSet = MLNTileSetFromTileURLTemplates(tileURLTemplates, @{
    MLNTileSourceOptionTileCoordinateSystem : [NSValue value:&tms
                                                withObjCType:@encode(MLNTileCoordinateSystem)],
  });
...
- (void)testTileSetFromTileURLTemplatesRasterEncodings {
  ...
  tileSet = MLNTileSetFromTileURLTemplates(tileURLTemplates, @{
    MLNTileSourceOptionDEMEncoding : [NSValue value:&terrarium
                                       withObjCType:@encode(MLNDEMEncoding)],
  });
...
- (void)testTileSetFromTileURLTemplatesVectorEncodings {
  ...
  tileSet = MLNTileSetFromTileURLTemplates(tileURLTemplates, @{
    MLNVectorTileSourceOptionEncoding : [NSValue value:&mlt
                                          withObjCType:@encode(MLNVectorTileSourceEncoding)],
  });
...
- (void)testInvalidTileSet {
  // a tile set that provides an mbgl tile set and invalid (crossed) minimum and maximum zoom levels
  // throws an exception
