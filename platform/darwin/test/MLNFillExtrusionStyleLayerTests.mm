...
- (void)testPredicates {
  ...
  MLNFillExtrusionStyleLayer *layer =
      [[MLNFillExtrusionStyleLayer alloc] initWithIdentifier:@"layerID" source:source];
...
- (void)testProperties {
  ...
  // fill-extrusion-base
  {
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionBase(), propertyValue,
                   @"Setting fillExtrusionBase to a constant value expression should update "
                   @"fill-extrusion-base.");
    ...
    XCTAssertEqual(
        rawLayer->getFillExtrusionBase(), propertyValue,
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionBase(), propertyValue,
                   @"Setting fillExtrusionBase to a camera-data expression should update "
                   @"fill-extrusion-base.");
    ...
    XCTAssertTrue(
        rawLayer->getFillExtrusionBase().isUndefined(),
  ...
  // fill-extrusion-color
  {
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionColor(), propertyValue,
                   @"Setting fillExtrusionColor to a constant value expression should update "
                   @"fill-extrusion-color.");
    ...
    XCTAssertEqual(
        rawLayer->getFillExtrusionColor(), propertyValue,
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionColor(), propertyValue,
                   @"Setting fillExtrusionColor to a camera-data expression should update "
                   @"fill-extrusion-color.");
    pedanticFunctionExpression = [NSExpression
        expressionWithFormat:
            @"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)",
    ...
    XCTAssertTrue(
        rawLayer->getFillExtrusionColor().isUndefined(),
  ...
  // fill-extrusion-vertical-gradient
  {
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionVerticalGradient(), propertyValue,
                   @"Setting fillExtrusionHasVerticalGradient to a constant value expression "
                   @"should update fill-extrusion-vertical-gradient.");
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionVerticalGradient(), propertyValue,
                   @"Setting fillExtrusionHasVerticalGradient to a camera expression should update "
                   @"fill-extrusion-vertical-gradient.");
    XCTAssertEqualObjects(
        layer.fillExtrusionHasVerticalGradient, functionExpression,
    ...
    XCTAssertTrue(rawLayer->getFillExtrusionVerticalGradient().isUndefined(),
                  @"Unsetting fillExtrusionHasVerticalGradient should return "
                  @"fill-extrusion-vertical-gradient to the default value.");
    XCTAssertEqualObjects(
        layer.fillExtrusionHasVerticalGradient, defaultExpression,
        @"fillExtrusionHasVerticalGradient should return the default value after being unset.");

    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.fillExtrusionHasVerticalGradient = functionExpression, NSException,
        NSInvalidArgumentException,
        @"MLNFillExtrusionLayer should raise an exception if a camera-data expression is applied "
        @"to a property that does not support key paths to feature attributes.");
  ...
  // fill-extrusion-height
  {
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionHeight(), propertyValue,
                   @"Setting fillExtrusionHeight to a constant value expression should update "
                   @"fill-extrusion-height.");
    ...
    XCTAssertEqual(
        rawLayer->getFillExtrusionHeight(), propertyValue,
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionHeight(), propertyValue,
                   @"Setting fillExtrusionHeight to a camera-data expression should update "
                   @"fill-extrusion-height.");
    pedanticFunctionExpression = [NSExpression
        expressionWithFormat:
            @"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)",
    ...
    XCTAssertTrue(
        rawLayer->getFillExtrusionHeight().isUndefined(),
        @"Unsetting fillExtrusionHeight should return fill-extrusion-height to the default value.");
    XCTAssertEqualObjects(
        layer.fillExtrusionHeight, defaultExpression,
  ...
  // fill-extrusion-opacity
  {
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionOpacity(), propertyValue,
                   @"Setting fillExtrusionOpacity to a constant value expression should update "
                   @"fill-extrusion-opacity.");
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionOpacity(), propertyValue,
                   @"Setting fillExtrusionOpacity to a camera expression should update "
                   @"fill-extrusion-opacity.");
    ...
    XCTAssertTrue(rawLayer->getFillExtrusionOpacity().isUndefined(),
                  @"Unsetting fillExtrusionOpacity should return fill-extrusion-opacity to the "
                  @"default value.");
    XCTAssertEqualObjects(
        layer.fillExtrusionOpacity, defaultExpression,
        @"fillExtrusionOpacity should return the default value after being unset.");

    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.fillExtrusionOpacity = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNFillExtrusionLayer should raise an exception if a camera-data expression is applied "
        @"to a property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // fill-extrusion-pattern
  {
    ...
    NSExpression *constantExpression =
        [NSExpression expressionForConstantValue:@"Fill Extrusion Pattern"];
    layer.fillExtrusionPattern = constantExpression;
    mbgl::style::PropertyValue<mbgl::style::expression::Image> propertyValue = {
        "Fill Extrusion Pattern"};
    XCTAssertEqual(rawLayer->getFillExtrusionPattern(), propertyValue,
                   @"Setting fillExtrusionPattern to a constant value expression should update "
                   @"fill-extrusion-pattern.");
    ...
    constantExpression =
        [NSExpression expressionWithFormat:@"MLN_FUNCTION('image', 'Fill Extrusion Pattern')"];
    XCTExpectFailure(
        @"Awaiting unit test refactoring https://github.com/maplibre/maplibre-native/issues/421");
    NSExpression *functionExpression = [NSExpression
        expressionWithFormat:@"mgl_step:from:stops:($zoomLevel, %@, %@)", constantExpression,
...

    {
      ...
      propertyValue = mbgl::style::PropertyExpression<mbgl::style::expression::Image>(
          step(zoom(), image(literal("Fill Extrusion Pattern")), 18.0,
               image(literal("Fill Extrusion Pattern"))));
    }

    XCTAssertEqual(rawLayer->getFillExtrusionPattern(), propertyValue,
                   @"Setting fillExtrusionPattern to a camera expression should update "
                   @"fill-extrusion-pattern.");
    ...
    XCTAssertTrue(rawLayer->getFillExtrusionPattern().isUndefined(),
                  @"Unsetting fillExtrusionPattern should return fill-extrusion-pattern to the "
                  @"default value.");
    XCTAssertEqualObjects(
        layer.fillExtrusionPattern, defaultExpression,
  ...
  // fill-extrusion-translate
  {
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionTranslate(), propertyValue,
                   @"Setting fillExtrusionTranslation to a constant value expression should update "
                   @"fill-extrusion-translate.");
    XCTAssertEqualObjects(
        layer.fillExtrusionTranslation, constantExpression,
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionTranslate(), propertyValue,
                   @"Setting fillExtrusionTranslation to a camera expression should update "
                   @"fill-extrusion-translate.");
    ...
    XCTAssertTrue(rawLayer->getFillExtrusionTranslate().isUndefined(),
                  @"Unsetting fillExtrusionTranslation should return fill-extrusion-translate to "
                  @"the default value.");
    XCTAssertEqualObjects(
        layer.fillExtrusionTranslation, defaultExpression,
        @"fillExtrusionTranslation should return the default value after being unset.");

    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.fillExtrusionTranslation = functionExpression, NSException,
        NSInvalidArgumentException,
        @"MLNFillExtrusionLayer should raise an exception if a camera-data expression is applied "
        @"to a property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
  ...
  // fill-extrusion-translate-anchor
  {
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionTranslateAnchor(), propertyValue,
                   @"Setting fillExtrusionTranslationAnchor to a constant value expression should "
                   @"update fill-extrusion-translate-anchor.");
    XCTAssertEqualObjects(
        layer.fillExtrusionTranslationAnchor, constantExpression,
    ...
    XCTAssertEqual(rawLayer->getFillExtrusionTranslateAnchor(), propertyValue,
                   @"Setting fillExtrusionTranslationAnchor to a camera expression should update "
                   @"fill-extrusion-translate-anchor.");
    ...
    XCTAssertTrue(rawLayer->getFillExtrusionTranslateAnchor().isUndefined(),
                  @"Unsetting fillExtrusionTranslationAnchor should return "
                  @"fill-extrusion-translate-anchor to the default value.");
    XCTAssertEqualObjects(
        layer.fillExtrusionTranslationAnchor, defaultExpression,
        @"fillExtrusionTranslationAnchor should return the default value after being unset.");

    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.fillExtrusionTranslationAnchor = functionExpression, NSException,
        NSInvalidArgumentException,
        @"MLNFillExtrusionLayer should raise an exception if a camera-data expression is applied "
        @"to a property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
...
- (void)testValueAdditions {
  XCTAssertEqual(
      [NSValue valueWithMLNFillExtrusionTranslationAnchor:MLNFillExtrusionTranslationAnchorMap]
          .MLNFillExtrusionTranslationAnchorValue,
      MLNFillExtrusionTranslationAnchorMap);
  XCTAssertEqual(
      [NSValue valueWithMLNFillExtrusionTranslationAnchor:MLNFillExtrusionTranslationAnchorViewport]
          .MLNFillExtrusionTranslationAnchorValue,
