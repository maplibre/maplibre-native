...
- (void)testPredicates {
  ...
  XCTAssertEqualObjects(layer.predicate,
                        [NSPredicate predicateWithFormat:@"$featureIdentifier = 1"]);
  layer.predicate = nil;
  XCTAssertNil(layer.predicate);
}
...
- (void)testProperties {
  ...
  // icon-allow-overlap
  {
    ...
    XCTAssertEqual(rawLayer->getIconAllowOverlap(), propertyValue,
                   @"Setting iconAllowsOverlap to a constant value expression should update "
                   @"icon-allow-overlap.");
    ...
    XCTExpectFailure(
        @"Awaiting unit test refactoring https://github.com/maplibre/maplibre-native/issues/421");
    NSExpression *functionExpression = [NSExpression
        expressionWithFormat:@"mgl_step:from:stops:($zoomLevel, %@, %@)", constantExpression,
...

    {
      ...
      propertyValue =
          mbgl::style::PropertyExpression<bool>(step(zoom(), literal(true), 18.0, literal(true)));
    }

    XCTAssertEqual(
        rawLayer->getIconAllowOverlap(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getIconAllowOverlap().isUndefined(),
    ...
    XCTAssertThrowsSpecificNamed(
        layer.iconAllowsOverlap = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
                                                            @{@18 : constantExpression}];
  ...
  // icon-anchor
  {
    ...
    mbgl::style::PropertyValue<mbgl::style::SymbolAnchorType> propertyValue = {
  ...
  // icon-ignore-placement
  {
    ...
    XCTAssertEqual(rawLayer->getIconIgnorePlacement(), propertyValue,
                   @"Setting iconIgnoresPlacement to a constant value expression should update "
                   @"icon-ignore-placement.");
    ...
    XCTAssertEqual(rawLayer->getIconIgnorePlacement(), propertyValue,
                   @"Setting iconIgnoresPlacement to a camera expression should update "
                   @"icon-ignore-placement.");
    ...
    XCTAssertTrue(rawLayer->getIconIgnorePlacement().isUndefined(),
                  @"Unsetting iconIgnoresPlacement should return icon-ignore-placement to the "
                  @"default value.");
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.iconIgnoresPlacement = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // icon-image
  {
    XCTAssertTrue(rawLayer->getIconImage().isUndefined(), @"icon-image should be unset initially.");
    ...
    XCTAssertEqual(
        rawLayer->getIconImage(), propertyValue,
    ...
    NSExpression *tokenExpression =
        [NSExpression expressionWithFormat:@"MLN_FUNCTION('image', CAST(token, \"NSString\"))"];
    XCTAssertEqualObjects(
        layer.iconImageName, tokenExpression,
        @"Setting iconImageName to a constant string with tokens should convert to an expression.");
  }
  ...
  // icon-offset
  {
    ...
    NSExpression *constantExpression =
    ...
    functionExpression = [NSExpression
        expressionWithFormat:
            @"mgl_interpolate:withCurveType:parameters:stops:(keyName, 'linear', nil, %@)",
            @{@18 : constantExpression}];
    layer.iconOffset = functionExpression;
    ...
    NSExpression *pedanticFunctionExpression =
        [NSExpression expressionWithFormat:@"mgl_interpolate:withCurveType:parameters:stops:(CAST("
                                           @"keyName, 'NSNumber'), 'linear', nil, %@)",
                                           @{@18 : constantExpression}];
...

    {
      using namespace mbgl::style::expression::dsl;
      propertyValue = mbgl::style::PropertyExpression<std::array<float, 2>>(
          interpolate(linear(), zoom(), 10.0,
                      interpolate(linear(), number(get("keyName")), 18.0, literal({1, 1}))));
    }

    XCTAssertEqual(rawLayer->getIconOffset(), propertyValue,
                   @"Setting iconOffset to a camera-data expression should update icon-offset.");
    pedanticFunctionExpression = [NSExpression
        expressionWithFormat:
            @"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)",
            @{@10 : pedanticFunctionExpression}];
    XCTAssertEqualObjects(layer.iconOffset, pedanticFunctionExpression,
  ...
  // icon-optional
  {
    ...
    mbgl::style::PropertyValue<bool> propertyValue = {true};
    XCTAssertEqual(
        rawLayer->getIconOptional(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.iconOptional = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // icon-padding
  {
    ...
    NSExpression *constantExpression = [NSExpression
        expressionWithFormat:@"%@",
#if TARGET_OS_IPHONE
    ...
    XCTAssertEqual(
        rawLayer->getIconPadding(), propertyValue,
  ...
  // icon-pitch-alignment
  {
    ...
    mbgl::style::PropertyValue<mbgl::style::AlignmentType> propertyValue = {
        mbgl::style::AlignmentType::Auto};
    XCTAssertEqual(rawLayer->getIconPitchAlignment(), propertyValue,
                   @"Setting iconPitchAlignment to a constant value expression should update "
                   @"icon-pitch-alignment.");
    ...
    XCTAssertEqual(
        rawLayer->getIconPitchAlignment(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getIconPitchAlignment().isUndefined(),
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.iconPitchAlignment = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // icon-rotate
  {
    ...
    XCTAssertEqual(
        rawLayer->getIconRotate(), propertyValue,
...

    {
      using namespace mbgl::style::expression::dsl;
      propertyValue =
          mbgl::style::PropertyExpression<float>(step(zoom(), literal(1.0), 18.0, literal(1.0)));
    }
  ...
  // icon-rotation-alignment
  {
    ...
    XCTAssertEqual(rawLayer->getIconRotationAlignment(), propertyValue,
                   @"Setting iconRotationAlignment to a constant value expression should update "
                   @"icon-rotation-alignment.");
    ...
    XCTAssertEqual(rawLayer->getIconRotationAlignment(), propertyValue,
                   @"Setting iconRotationAlignment to a camera expression should update "
                   @"icon-rotation-alignment.");
    ...
    XCTAssertTrue(rawLayer->getIconRotationAlignment().isUndefined(),
                  @"Unsetting iconRotationAlignment should return icon-rotation-alignment to the "
                  @"default value.");
    XCTAssertEqualObjects(
        layer.iconRotationAlignment, defaultExpression,
        @"iconRotationAlignment should return the default value after being unset.");

    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.iconRotationAlignment = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // icon-size
  {
    XCTAssertTrue(rawLayer->getIconSize().isUndefined(), @"icon-size should be unset initially.");
  ...
  // icon-text-fit
  {
    ...
    mbgl::style::PropertyValue<mbgl::style::IconTextFitType> propertyValue = {
        mbgl::style::IconTextFitType::Both};
    XCTAssertEqual(
        rawLayer->getIconTextFit(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.iconTextFit = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // icon-text-fit-padding
  {
    ...
    XCTAssertEqual(rawLayer->getIconTextFitPadding(), propertyValue,
                   @"Setting iconTextFitPadding to a constant value expression should update "
                   @"icon-text-fit-padding.");
    ...
    XCTAssertEqual(
        rawLayer->getIconTextFitPadding(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getIconTextFitPadding().isUndefined(),
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.iconTextFitPadding = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // icon-keep-upright
  {
    ...
    XCTAssertEqual(rawLayer->getIconKeepUpright(), propertyValue,
                   @"Setting keepsIconUpright to a constant value expression should update "
                   @"icon-keep-upright.");
    ...
    XCTAssertEqual(
        rawLayer->getIconKeepUpright(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getIconKeepUpright().isUndefined(),
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.keepsIconUpright = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-keep-upright
  {
    ...
    XCTAssertEqual(rawLayer->getTextKeepUpright(), propertyValue,
                   @"Setting keepsTextUpright to a constant value expression should update "
                   @"text-keep-upright.");
...

    {
      using namespace mbgl::style::expression::dsl;
      propertyValue =
          mbgl::style::PropertyExpression<bool>(step(zoom(), literal(false), 18.0, literal(false)));
    }

    XCTAssertEqual(
        rawLayer->getTextKeepUpright(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getTextKeepUpright().isUndefined(),
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.keepsTextUpright = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-max-angle
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getTextMaxAngle(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.maximumTextAngle = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-max-width
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getTextMaxWidth(), propertyValue,
  ...
  // symbol-avoid-edges
  {
    ...
    XCTAssertEqual(rawLayer->getSymbolAvoidEdges(), propertyValue,
                   @"Setting symbolAvoidsEdges to a constant value expression should update "
                   @"symbol-avoid-edges.");
    ...
    XCTAssertEqual(
        rawLayer->getSymbolAvoidEdges(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getSymbolAvoidEdges().isUndefined(),
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.symbolAvoidsEdges = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // symbol-placement
  {
    ...
    mbgl::style::PropertyValue<mbgl::style::SymbolPlacementType> propertyValue = {
        mbgl::style::SymbolPlacementType::LineCenter};
    XCTAssertEqual(
        rawLayer->getSymbolPlacement(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getSymbolPlacement().isUndefined(),
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.symbolPlacement = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // symbol-screen-space
  {
    ...
    XCTAssertEqual(rawLayer->getSymbolScreenSpace(), propertyValue,
                   @"Setting symbolScreenSpace to a constant value expression should update "
                   @"symbol-screen-space.");
    ...
    XCTAssertEqual(
        rawLayer->getSymbolScreenSpace(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getSymbolScreenSpace().isUndefined(),
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.symbolScreenSpace = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // symbol-sort-key
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getSymbolSortKey(), propertyValue,
  ...
  // symbol-spacing
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getSymbolSpacing(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.symbolSpacing = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // symbol-z-order
  {
    ...
    mbgl::style::PropertyValue<mbgl::style::SymbolZOrderType> propertyValue = {
        mbgl::style::SymbolZOrderType::Source};
    XCTAssertEqual(
        rawLayer->getSymbolZOrder(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.symbolZOrder = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-field
  {
    XCTAssertTrue(rawLayer->getTextField().isUndefined(), @"text-field should be unset initially.");
    ...
    MLNAttributedExpression *attributedConstantExpression = [[MLNAttributedExpression alloc]
        initWithExpression:[NSExpression expressionWithFormat:@"'Text Field'"]
                attributes:@{}];
    constantExpression = [NSExpression mgl_expressionForAttributedExpressions:@[
      [NSExpression expressionForConstantValue:attributedConstantExpression]
    ]];
    XCTExpectFailure(
        @"Awaiting unit test refactoring https://github.com/maplibre/maplibre-native/issues/421");
    NSExpression *functionExpression = [NSExpression
    ...
    XCTAssertEqual(
        rawLayer->getTextField(), propertyValue,
        @"Setting text to a constant string with tokens should convert to an expression.");

    MLNAttributedExpression *tokenAttibutedExpression = [[MLNAttributedExpression alloc]
        initWithExpression:[NSExpression expressionWithFormat:@"CAST(token, 'NSString')"]
                attributes:@{}];
    NSExpression *tokenExpression = [NSExpression mgl_expressionForAttributedExpressions:@[
      [NSExpression expressionForConstantValue:tokenAttibutedExpression]
    ]];
    XCTAssertEqualObjects(
        layer.text, tokenExpression,
        @"Setting text to a constant string with tokens should convert to an expression.");
  }
  ...
  // text-allow-overlap
  {
    ...
    XCTAssertEqual(rawLayer->getTextAllowOverlap(), propertyValue,
                   @"Setting textAllowsOverlap to a constant value expression should update "
                   @"text-allow-overlap.");
    ...
    XCTAssertEqual(
        rawLayer->getTextAllowOverlap(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getTextAllowOverlap().isUndefined(),
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.textAllowsOverlap = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-font
  {
    XCTAssertTrue(rawLayer->getTextFont().isUndefined(), @"text-font should be unset initially.");
    NSExpression *defaultExpression = layer.textFontNames;

    NSExpression *constantExpression =
        [NSExpression expressionWithFormat:@"{'Text Font', 'Tnof Txet'}"];
    layer.textFontNames = constantExpression;
    mbgl::style::PropertyValue<std::vector<std::string>> propertyValue = {
        {"Text Font", "Tnof Txet"}};
    XCTAssertEqual(
        rawLayer->getTextFont(), propertyValue,
    ...
    {
      using namespace mbgl::style::expression::dsl;
      propertyValue = mbgl::style::PropertyExpression<std::vector<std::string>>(step(
          zoom(), literal({"Text Font", "Tnof Txet"}), 18.0, literal({"Text Font", "Tnof Txet"})));
    }
  ...
  // text-size
  {
    XCTAssertTrue(rawLayer->getTextSize().isUndefined(), @"text-size should be unset initially.");
  ...
  // text-ignore-placement
  {
    ...
    XCTAssertEqual(rawLayer->getTextIgnorePlacement(), propertyValue,
                   @"Setting textIgnoresPlacement to a constant value expression should update "
                   @"text-ignore-placement.");
    ...
    XCTAssertEqual(rawLayer->getTextIgnorePlacement(), propertyValue,
                   @"Setting textIgnoresPlacement to a camera expression should update "
                   @"text-ignore-placement.");
    ...
    XCTAssertTrue(rawLayer->getTextIgnorePlacement().isUndefined(),
                  @"Unsetting textIgnoresPlacement should return text-ignore-placement to the "
                  @"default value.");
    XCTAssertEqualObjects(
        layer.textIgnoresPlacement, defaultExpression,
        @"textIgnoresPlacement should return the default value after being unset.");

    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.textIgnoresPlacement = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-justify
  {
    ...
    mbgl::style::PropertyValue<mbgl::style::TextJustifyType> propertyValue = {
        mbgl::style::TextJustifyType::Right};
    XCTAssertEqual(
        rawLayer->getTextJustify(), propertyValue,
  ...
  // text-letter-spacing
  {
    ...
    XCTAssertEqual(rawLayer->getTextLetterSpacing(), propertyValue,
                   @"Setting textLetterSpacing to a constant value expression should update "
                   @"text-letter-spacing.");
    ...
    XCTAssertEqual(
        rawLayer->getTextLetterSpacing(), propertyValue,
    ...
    XCTAssertEqual(rawLayer->getTextLetterSpacing(), propertyValue,
                   @"Setting textLetterSpacing to a camera-data expression should update "
                   @"text-letter-spacing.");
    pedanticFunctionExpression = [NSExpression
        expressionWithFormat:
            @"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)",
    ...
    XCTAssertTrue(
        rawLayer->getTextLetterSpacing().isUndefined(),
  ...
  // text-line-height
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getTextLineHeight(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.textLineHeight = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-optional
  {
    ...
    mbgl::style::PropertyValue<bool> propertyValue = {true};
    XCTAssertEqual(
        rawLayer->getTextOptional(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.textOptional = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-padding
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getTextPadding(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.textPadding = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-pitch-alignment
  {
    ...
    XCTAssertEqual(rawLayer->getTextPitchAlignment(), propertyValue,
                   @"Setting textPitchAlignment to a constant value expression should update "
                   @"text-pitch-alignment.");
    ...
    XCTAssertEqual(
        rawLayer->getTextPitchAlignment(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getTextPitchAlignment().isUndefined(),
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.textPitchAlignment = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-radial-offset
  {
    ...
    XCTAssertEqual(rawLayer->getTextRadialOffset(), propertyValue,
                   @"Setting textRadialOffset to a constant value expression should update "
                   @"text-radial-offset.");
    ...
    XCTAssertEqual(
        rawLayer->getTextRadialOffset(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getTextRadialOffset().isUndefined(),
  ...
  // text-rotate
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getTextRotate(), propertyValue,
  ...
  // text-rotation-alignment
  {
    ...
    XCTAssertEqual(rawLayer->getTextRotationAlignment(), propertyValue,
                   @"Setting textRotationAlignment to a constant value expression should update "
                   @"text-rotation-alignment.");
    ...
    XCTAssertEqual(rawLayer->getTextRotationAlignment(), propertyValue,
                   @"Setting textRotationAlignment to a camera expression should update "
                   @"text-rotation-alignment.");
    ...
    XCTAssertTrue(rawLayer->getTextRotationAlignment().isUndefined(),
                  @"Unsetting textRotationAlignment should return text-rotation-alignment to the "
                  @"default value.");
    XCTAssertEqualObjects(
        layer.textRotationAlignment, defaultExpression,
        @"textRotationAlignment should return the default value after being unset.");

    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.textRotationAlignment = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-transform
  {
    ...
    mbgl::style::PropertyValue<mbgl::style::TextTransformType> propertyValue = {
        mbgl::style::TextTransformType::Lowercase};
    XCTAssertEqual(
        rawLayer->getTextTransform(), propertyValue,
  ...
  // text-variable-anchor
  {
    ...
    mbgl::style::PropertyValue<std::vector<mbgl::style::SymbolAnchorType>> propertyValue = {
        {mbgl::style::SymbolAnchorType::Top, mbgl::style::SymbolAnchorType::Bottom}};
    XCTAssertEqual(rawLayer->getTextVariableAnchor(), propertyValue,
                   @"Setting textVariableAnchor to a constant value expression should update "
                   @"text-variable-anchor.");
    ...
    XCTAssertEqual(
        rawLayer->getTextVariableAnchor(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getTextVariableAnchor().isUndefined(),
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.textVariableAnchor = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-variable-anchor-offset
  {
    ...
    mbgl::style::PropertyValue<mbgl::VariableAnchorOffsetCollection> propertyValue = {
        "Text Variable Anchor Offset"};
    XCTAssertEqual(rawLayer->getTextVariableAnchorOffset(), propertyValue,
                   @"Setting textVariableAnchorOffset to a constant value expression should update "
                   @"text-variable-anchor-offset.");
    XCTAssertEqualObjects(
        layer.textVariableAnchorOffset, constantExpression,
...

    {
      ...
      propertyValue = mbgl::style::PropertyExpression<mbgl::VariableAnchorOffsetCollection>(
          step(zoom(), literal("Text Variable Anchor Offset"), 18.0,
               literal("Text Variable Anchor Offset")));
    }

    XCTAssertEqual(rawLayer->getTextVariableAnchorOffset(), propertyValue,
                   @"Setting textVariableAnchorOffset to a camera expression should update "
                   @"text-variable-anchor-offset.");
...

    {
      using namespace mbgl::style::expression::dsl;
      propertyValue =
          mbgl::style::PropertyExpression<mbgl::VariableAnchorOffsetCollection>(interpolate(
              linear(), number(get("keyName")), 18.0, literal("Text Variable Anchor Offset")));
    }

    XCTAssertEqual(rawLayer->getTextVariableAnchorOffset(), propertyValue,
                   @"Setting textVariableAnchorOffset to a data expression should update "
                   @"text-variable-anchor-offset.");
    NSExpression *pedanticFunctionExpression =
        [NSExpression expressionWithFormat:@"mgl_interpolate:withCurveType:parameters:stops:(CAST("
                                           @"keyName, 'NSNumber'), 'linear', nil, %@)",
...

    {
      ...
      propertyValue = mbgl::style::PropertyExpression<mbgl::VariableAnchorOffsetCollection>(
          interpolate(linear(), zoom(), 10.0,
                      interpolate(linear(), number(get("keyName")), 18.0,
                                  literal("Text Variable Anchor Offset"))));
    }

    XCTAssertEqual(rawLayer->getTextVariableAnchorOffset(), propertyValue,
                   @"Setting textVariableAnchorOffset to a camera-data expression should update "
                   @"text-variable-anchor-offset.");
    pedanticFunctionExpression = [NSExpression
        expressionWithFormat:
            @"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)",
    ...
    XCTAssertTrue(rawLayer->getTextVariableAnchorOffset().isUndefined(),
                  @"Unsetting textVariableAnchorOffset should return text-variable-anchor-offset "
                  @"to the default value.");
    XCTAssertEqualObjects(
        layer.textVariableAnchorOffset, defaultExpression,
  ...
  // text-writing-mode
  {
    ...
    NSExpression *constantExpression =
        [NSExpression expressionWithFormat:@"{'horizontal','vertical'}"];
    layer.textWritingModes = constantExpression;
    mbgl::style::PropertyValue<std::vector<mbgl::style::TextWritingModeType>> propertyValue = {
        {mbgl::style::TextWritingModeType::Horizontal, mbgl::style::TextWritingModeType::Vertical}};
    XCTAssertEqual(rawLayer->getTextWritingMode(), propertyValue,
                   @"Setting textWritingModes to a constant value expression should update "
                   @"text-writing-mode.");
...

    {
      using namespace mbgl::style::expression::dsl;
      propertyValue =
          mbgl::style::PropertyExpression<std::vector<mbgl::style::TextWritingModeType>>(
              step(zoom(), literal({"horizontal", "vertical"}), 18.0,
                   literal({"horizontal", "vertical"})));
    }

    XCTAssertEqual(
        rawLayer->getTextWritingMode(), propertyValue,
    ...
    XCTAssertTrue(
        rawLayer->getTextWritingMode().isUndefined(),
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.textWritingModes = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // icon-color
  {
    XCTAssertTrue(rawLayer->getIconColor().isUndefined(), @"icon-color should be unset initially.");
    NSExpression *defaultExpression = layer.iconColor;

    NSExpression *constantExpression =
        [NSExpression expressionWithFormat:@"%@", [MLNColor redColor]];
    ...
    {
      using namespace mbgl::style::expression::dsl;
      propertyValue = mbgl::style::PropertyExpression<mbgl::Color>(interpolate(
          linear(), zoom(), 10.0,
          interpolate(linear(), number(get("keyName")), 18.0, literal(mbgl::Color(1, 0, 0, 1)))));
    }
    ...
    XCTAssert(toptions.delay &&
              MLNTimeIntervalFromDuration(*toptions.delay) == transitionTest.delay);
    XCTAssert(toptions.duration &&
              MLNTimeIntervalFromDuration(*toptions.duration) == transitionTest.duration);
  ...
  // icon-halo-blur
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getIconHaloBlur(), propertyValue,
  ...
  // icon-halo-color
  {
    ...
    mbgl::style::PropertyValue<mbgl::Color> propertyValue = {{1, 0, 0, 1}};
    XCTAssertEqual(
        rawLayer->getIconHaloColor(), propertyValue,
  ...
  // icon-halo-width
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getIconHaloWidth(), propertyValue,
  ...
  // icon-opacity
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getIconOpacity(), propertyValue,
  ...
  // icon-translate
  {
    ...
    mbgl::style::PropertyValue<std::array<float, 2>> propertyValue = {{1, 1}};
    XCTAssertEqual(
        rawLayer->getIconTranslate(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.iconTranslation = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // icon-translate-anchor
  {
    ...
    mbgl::style::PropertyValue<mbgl::style::TranslateAnchorType> propertyValue = {
        mbgl::style::TranslateAnchorType::Viewport};
    XCTAssertEqual(rawLayer->getIconTranslateAnchor(), propertyValue,
                   @"Setting iconTranslationAnchor to a constant value expression should update "
                   @"icon-translate-anchor.");
    ...
    XCTAssertEqual(rawLayer->getIconTranslateAnchor(), propertyValue,
                   @"Setting iconTranslationAnchor to a camera expression should update "
                   @"icon-translate-anchor.");
    ...
    XCTAssertTrue(rawLayer->getIconTranslateAnchor().isUndefined(),
                  @"Unsetting iconTranslationAnchor should return icon-translate-anchor to the "
                  @"default value.");
    XCTAssertEqualObjects(
        layer.iconTranslationAnchor, defaultExpression,
        @"iconTranslationAnchor should return the default value after being unset.");

    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.iconTranslationAnchor = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-color
  {
    XCTAssertTrue(rawLayer->getTextColor().isUndefined(), @"text-color should be unset initially.");
  ...
  // text-halo-blur
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getTextHaloBlur(), propertyValue,
  ...
  // text-halo-color
  {
    ...
    mbgl::style::PropertyValue<mbgl::Color> propertyValue = {{1, 0, 0, 1}};
    XCTAssertEqual(
        rawLayer->getTextHaloColor(), propertyValue,
  ...
  // text-halo-width
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getTextHaloWidth(), propertyValue,
  ...
  // text-opacity
  {
    ...
    mbgl::style::PropertyValue<float> propertyValue = {1.0};
    XCTAssertEqual(
        rawLayer->getTextOpacity(), propertyValue,
  ...
  // text-translate
  {
    ...
    mbgl::style::PropertyValue<std::array<float, 2>> propertyValue = {{1, 1}};
    XCTAssertEqual(
        rawLayer->getTextTranslate(), propertyValue,
    ...
    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.textTranslation = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
  ...
  // text-translate-anchor
  {
    ...
    XCTAssertEqual(rawLayer->getTextTranslateAnchor(), propertyValue,
                   @"Setting textTranslationAnchor to a constant value expression should update "
                   @"text-translate-anchor.");
    ...
    XCTAssertEqual(rawLayer->getTextTranslateAnchor(), propertyValue,
                   @"Setting textTranslationAnchor to a camera expression should update "
                   @"text-translate-anchor.");
    ...
    XCTAssertTrue(rawLayer->getTextTranslateAnchor().isUndefined(),
                  @"Unsetting textTranslationAnchor should return text-translate-anchor to the "
                  @"default value.");
    XCTAssertEqualObjects(
        layer.textTranslationAnchor, defaultExpression,
        @"textTranslationAnchor should return the default value after being unset.");

    functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
    XCTAssertThrowsSpecificNamed(
        layer.textTranslationAnchor = functionExpression, NSException, NSInvalidArgumentException,
        @"MLNSymbolLayer should raise an exception if a camera-data expression is applied to a "
        @"property that does not support key paths to feature attributes.");
    functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)",
                                                            constantExpression,
...
- (void)testValueAdditions {
  XCTAssertEqual([NSValue valueWithMLNIconAnchor:MLNIconAnchorCenter].MLNIconAnchorValue,
                 MLNIconAnchorCenter);
  XCTAssertEqual([NSValue valueWithMLNIconAnchor:MLNIconAnchorLeft].MLNIconAnchorValue,
                 MLNIconAnchorLeft);
  XCTAssertEqual([NSValue valueWithMLNIconAnchor:MLNIconAnchorRight].MLNIconAnchorValue,
                 MLNIconAnchorRight);
  XCTAssertEqual([NSValue valueWithMLNIconAnchor:MLNIconAnchorTop].MLNIconAnchorValue,
                 MLNIconAnchorTop);
  XCTAssertEqual([NSValue valueWithMLNIconAnchor:MLNIconAnchorBottom].MLNIconAnchorValue,
                 MLNIconAnchorBottom);
  XCTAssertEqual([NSValue valueWithMLNIconAnchor:MLNIconAnchorTopLeft].MLNIconAnchorValue,
                 MLNIconAnchorTopLeft);
  XCTAssertEqual([NSValue valueWithMLNIconAnchor:MLNIconAnchorTopRight].MLNIconAnchorValue,
                 MLNIconAnchorTopRight);
  XCTAssertEqual([NSValue valueWithMLNIconAnchor:MLNIconAnchorBottomLeft].MLNIconAnchorValue,
                 MLNIconAnchorBottomLeft);
  XCTAssertEqual([NSValue valueWithMLNIconAnchor:MLNIconAnchorBottomRight].MLNIconAnchorValue,
                 MLNIconAnchorBottomRight);
  XCTAssertEqual(
      [NSValue valueWithMLNIconPitchAlignment:MLNIconPitchAlignmentMap].MLNIconPitchAlignmentValue,
      MLNIconPitchAlignmentMap);
  XCTAssertEqual([NSValue valueWithMLNIconPitchAlignment:MLNIconPitchAlignmentViewport]
                     .MLNIconPitchAlignmentValue,
                 MLNIconPitchAlignmentViewport);
  XCTAssertEqual(
      [NSValue valueWithMLNIconPitchAlignment:MLNIconPitchAlignmentAuto].MLNIconPitchAlignmentValue,
      MLNIconPitchAlignmentAuto);
  XCTAssertEqual([NSValue valueWithMLNIconRotationAlignment:MLNIconRotationAlignmentMap]
                     .MLNIconRotationAlignmentValue,
                 MLNIconRotationAlignmentMap);
  XCTAssertEqual([NSValue valueWithMLNIconRotationAlignment:MLNIconRotationAlignmentViewport]
                     .MLNIconRotationAlignmentValue,
                 MLNIconRotationAlignmentViewport);
  XCTAssertEqual([NSValue valueWithMLNIconRotationAlignment:MLNIconRotationAlignmentAuto]
                     .MLNIconRotationAlignmentValue,
                 MLNIconRotationAlignmentAuto);
  XCTAssertEqual([NSValue valueWithMLNIconTextFit:MLNIconTextFitNone].MLNIconTextFitValue,
                 MLNIconTextFitNone);
  XCTAssertEqual([NSValue valueWithMLNIconTextFit:MLNIconTextFitWidth].MLNIconTextFitValue,
                 MLNIconTextFitWidth);
  XCTAssertEqual([NSValue valueWithMLNIconTextFit:MLNIconTextFitHeight].MLNIconTextFitValue,
                 MLNIconTextFitHeight);
  XCTAssertEqual([NSValue valueWithMLNIconTextFit:MLNIconTextFitBoth].MLNIconTextFitValue,
                 MLNIconTextFitBoth);
  XCTAssertEqual(
      [NSValue valueWithMLNSymbolPlacement:MLNSymbolPlacementPoint].MLNSymbolPlacementValue,
      MLNSymbolPlacementPoint);
  XCTAssertEqual(
      [NSValue valueWithMLNSymbolPlacement:MLNSymbolPlacementLine].MLNSymbolPlacementValue,
      MLNSymbolPlacementLine);
  XCTAssertEqual(
      [NSValue valueWithMLNSymbolPlacement:MLNSymbolPlacementLineCenter].MLNSymbolPlacementValue,
      MLNSymbolPlacementLineCenter);
  XCTAssertEqual([NSValue valueWithMLNSymbolZOrder:MLNSymbolZOrderAuto].MLNSymbolZOrderValue,
                 MLNSymbolZOrderAuto);
  XCTAssertEqual([NSValue valueWithMLNSymbolZOrder:MLNSymbolZOrderViewportY].MLNSymbolZOrderValue,
                 MLNSymbolZOrderViewportY);
  XCTAssertEqual([NSValue valueWithMLNSymbolZOrder:MLNSymbolZOrderSource].MLNSymbolZOrderValue,
                 MLNSymbolZOrderSource);
  XCTAssertEqual([NSValue valueWithMLNTextAnchor:MLNTextAnchorCenter].MLNTextAnchorValue,
                 MLNTextAnchorCenter);
  XCTAssertEqual([NSValue valueWithMLNTextAnchor:MLNTextAnchorLeft].MLNTextAnchorValue,
                 MLNTextAnchorLeft);
  XCTAssertEqual([NSValue valueWithMLNTextAnchor:MLNTextAnchorRight].MLNTextAnchorValue,
                 MLNTextAnchorRight);
  XCTAssertEqual([NSValue valueWithMLNTextAnchor:MLNTextAnchorTop].MLNTextAnchorValue,
                 MLNTextAnchorTop);
  XCTAssertEqual([NSValue valueWithMLNTextAnchor:MLNTextAnchorBottom].MLNTextAnchorValue,
                 MLNTextAnchorBottom);
  XCTAssertEqual([NSValue valueWithMLNTextAnchor:MLNTextAnchorTopLeft].MLNTextAnchorValue,
                 MLNTextAnchorTopLeft);
  XCTAssertEqual([NSValue valueWithMLNTextAnchor:MLNTextAnchorTopRight].MLNTextAnchorValue,
                 MLNTextAnchorTopRight);
  XCTAssertEqual([NSValue valueWithMLNTextAnchor:MLNTextAnchorBottomLeft].MLNTextAnchorValue,
                 MLNTextAnchorBottomLeft);
  XCTAssertEqual([NSValue valueWithMLNTextAnchor:MLNTextAnchorBottomRight].MLNTextAnchorValue,
                 MLNTextAnchorBottomRight);
  XCTAssertEqual(
      [NSValue valueWithMLNTextJustification:MLNTextJustificationAuto].MLNTextJustificationValue,
      MLNTextJustificationAuto);
  XCTAssertEqual(
      [NSValue valueWithMLNTextJustification:MLNTextJustificationLeft].MLNTextJustificationValue,
      MLNTextJustificationLeft);
  XCTAssertEqual(
      [NSValue valueWithMLNTextJustification:MLNTextJustificationCenter].MLNTextJustificationValue,
      MLNTextJustificationCenter);
  XCTAssertEqual(
      [NSValue valueWithMLNTextJustification:MLNTextJustificationRight].MLNTextJustificationValue,
      MLNTextJustificationRight);
  XCTAssertEqual(
      [NSValue valueWithMLNTextPitchAlignment:MLNTextPitchAlignmentMap].MLNTextPitchAlignmentValue,
      MLNTextPitchAlignmentMap);
  XCTAssertEqual([NSValue valueWithMLNTextPitchAlignment:MLNTextPitchAlignmentViewport]
                     .MLNTextPitchAlignmentValue,
                 MLNTextPitchAlignmentViewport);
  XCTAssertEqual(
      [NSValue valueWithMLNTextPitchAlignment:MLNTextPitchAlignmentAuto].MLNTextPitchAlignmentValue,
      MLNTextPitchAlignmentAuto);
  XCTAssertEqual([NSValue valueWithMLNTextRotationAlignment:MLNTextRotationAlignmentMap]
                     .MLNTextRotationAlignmentValue,
                 MLNTextRotationAlignmentMap);
  XCTAssertEqual([NSValue valueWithMLNTextRotationAlignment:MLNTextRotationAlignmentViewport]
                     .MLNTextRotationAlignmentValue,
                 MLNTextRotationAlignmentViewport);
  XCTAssertEqual([NSValue valueWithMLNTextRotationAlignment:MLNTextRotationAlignmentAuto]
                     .MLNTextRotationAlignmentValue,
                 MLNTextRotationAlignmentAuto);
  XCTAssertEqual([NSValue valueWithMLNTextTransform:MLNTextTransformNone].MLNTextTransformValue,
                 MLNTextTransformNone);
  XCTAssertEqual(
      [NSValue valueWithMLNTextTransform:MLNTextTransformUppercase].MLNTextTransformValue,
      MLNTextTransformUppercase);
  XCTAssertEqual(
      [NSValue valueWithMLNTextTransform:MLNTextTransformLowercase].MLNTextTransformValue,
      MLNTextTransformLowercase);
  XCTAssertEqual(
      [NSValue valueWithMLNTextWritingMode:MLNTextWritingModeHorizontal].MLNTextWritingModeValue,
      MLNTextWritingModeHorizontal);
  XCTAssertEqual(
      [NSValue valueWithMLNTextWritingMode:MLNTextWritingModeVertical].MLNTextWritingModeValue,
      MLNTextWritingModeVertical);
  XCTAssertEqual([NSValue valueWithMLNIconTranslationAnchor:MLNIconTranslationAnchorMap]
                     .MLNIconTranslationAnchorValue,
                 MLNIconTranslationAnchorMap);
  XCTAssertEqual([NSValue valueWithMLNIconTranslationAnchor:MLNIconTranslationAnchorViewport]
                     .MLNIconTranslationAnchorValue,
                 MLNIconTranslationAnchorViewport);
  XCTAssertEqual([NSValue valueWithMLNTextTranslationAnchor:MLNTextTranslationAnchorMap]
                     .MLNTextTranslationAnchorValue,
                 MLNTextTranslationAnchorMap);
  XCTAssertEqual([NSValue valueWithMLNTextTranslationAnchor:MLNTextTranslationAnchorViewport]
                     .MLNTextTranslationAnchorValue,
