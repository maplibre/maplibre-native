...
/**
 ...
 This will output the included warning in the test log, which `xbeautify` will detect.
 ...
 will also be picked up by xbeautify. PENDING tests will be distinguished by a `⧖`
 and `[PENDING]`
 */
#define MLN_CHECK_IF_PENDING_TEST_SHOULD_RUN() \
    ...
    { \
        ...
        if (![runPendingTests boolValue]) { \
            /* The following warning will be picked up by xbeautify */ \
