...
void (*const glFlush)() = [](auto... args) { return QOpenGLContext::currentContext()->functions()->glFlush(args...); };
...
void (*const glTexImage3D)(GLenum, GLint, GLint, GLsizei, GLsizei, GLsizei, GLint, GLenum, GLenum, const GLvoid*) =
    [](auto... args) { return QOpenGLContext::currentContext()->extraFunctions()->glTexImage3D(args...); };
...
void (*const glCopyTexSubImage3D)(GLenum, GLint, GLint, GLint, GLint, GLint, GLint, GLsizei, GLsizei) =
    [](auto... args) { return QOpenGLContext::currentContext()->extraFunctions()->glCopyTexSubImage3D(args...); };
void (*const glCompressedTexImage3D)(GLenum, GLint, GLenum, GLsizei, GLsizei, GLsizei, GLint, GLsizei, const GLvoid*) =
    [](auto... args) { return QOpenGLContext::currentContext()->extraFunctions()->glCompressedTexImage3D(args...); };
...
void (*const glBlitFramebuffer)(GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLint, GLbitfield, GLenum) =
    [](auto... args) { return QOpenGLContext::currentContext()->extraFunctions()->glBlitFramebuffer(args...); };
