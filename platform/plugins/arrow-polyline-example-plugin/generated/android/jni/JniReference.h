...
JNIEXPORT JniReference<jobject> create_object(JNIEnv* env, const JniReference<jclass>& javaClass) noexcept;

JNIEXPORT JniReference<jobject> create_instance_object(JNIEnv* env,
                                                       const JniReference<jclass>& javaClass,
                                                       jlong instancePointer) noexcept;

JNIEXPORT JniReference<jobject> alloc_object(JNIEnv* env, const JniReference<jclass>& javaClass) noexcept;
