...
void set_unsigned_optional_field_value(JNIEnv* const env,
                                       const JniReference<jobject>& object,
                                       const char* field_name,
                                       const char* field_type,
                                       const std::optional<CppType>& value) noexcept {
    const auto signed_value = value ? std::optional<HostSignedType>(static_cast<HostSignedType>(*value))
                                    : std::optional<HostSignedType>{};
    set_converted_object_field_value(env, object, field_name, field_type, signed_value);
}

template <typename Result>
Result get_byte_array_field_value(JNIEnv* const env, const JniReference<jobject>& object, const char* field_name) {
    const auto field_value = make_local_ref(
        env, static_cast<jbyteArray>(get_field_value_impl(env, &JNIEnv::GetObjectField, object, field_name, "[B")));
    return convert_from_jni(env, field_value, TypeId<Result>{});
}

} // namespace

bool get_field_value(JNIEnv* const env,
                     const JniReference<jobject>& object,
                     const char* field_name,
...
int8_t get_field_value(JNIEnv* const env,
                       const JniReference<jobject>& object,
                       const char* field_name,
...
int16_t get_field_value(JNIEnv* const env,
                        const JniReference<jobject>& object,
                        const char* field_name,
...
int32_t get_field_value(JNIEnv* const env,
                        const JniReference<jobject>& object,
                        const char* field_name,
...
int64_t get_field_value(JNIEnv* const env,
                        const JniReference<jobject>& object,
                        const char* field_name,
...
uint8_t get_field_value(JNIEnv* const env,
                        const JniReference<jobject>& object,
                        const char* field_name,
                        TypeId<uint8_t>) noexcept {
    return static_cast<uint8_t>(get_field_value_impl(env, &JNIEnv::GetShortField, object, field_name, "S"));
}

uint16_t get_field_value(JNIEnv* const env,
                         const JniReference<jobject>& object,
                         const char* field_name,
                         TypeId<uint16_t>) noexcept {
    return static_cast<uint16_t>(get_field_value_impl(env, &JNIEnv::GetIntField, object, field_name, "I"));
}

uint32_t get_field_value(JNIEnv* const env,
                         const JniReference<jobject>& object,
                         const char* field_name,
                         TypeId<uint32_t>) noexcept {
    return static_cast<uint32_t>(get_field_value_impl(env, &JNIEnv::GetLongField, object, field_name, "J"));
}

uint64_t get_field_value(JNIEnv* const env,
                         const JniReference<jobject>& object,
                         const char* field_name,
                         TypeId<uint64_t>) noexcept {
    return static_cast<uint64_t>(get_field_value_impl(env, &JNIEnv::GetLongField, object, field_name, "J"));
}

float get_field_value(JNIEnv* const env,
                      const JniReference<jobject>& object,
                      const char* field_name,
...
double get_field_value(JNIEnv* const env,
                       const JniReference<jobject>& object,
                       const char* field_name,
...
std::string get_field_value(JNIEnv* const env,
                            const JniReference<jobject>& object,
                            const char* field_name,
                            TypeId<std::string>) {
...
std::optional<bool> get_field_value(JNIEnv* const env,
                                    const JniReference<jobject>& object,
                                    const char* field_name,
                                    TypeId<std::optional<bool>>) noexcept {
    return get_converted_object_field_value<std::optional<bool>>(env, object, field_name, "Ljava/lang/Boolean;");
}

std::optional<int8_t> get_field_value(JNIEnv* const env,
                                      const JniReference<jobject>& object,
                                      const char* field_name,
                                      TypeId<std::optional<int8_t>>) noexcept {
    return get_converted_object_field_value<std::optional<int8_t>>(env, object, field_name, "Ljava/lang/Byte;");
}

std::optional<int16_t> get_field_value(JNIEnv* const env,
                                       const JniReference<jobject>& object,
                                       const char* field_name,
                                       TypeId<std::optional<int16_t>>) noexcept {
    return get_converted_object_field_value<std::optional<int16_t>>(env, object, field_name, "Ljava/lang/Short;");
}

std::optional<int32_t> get_field_value(JNIEnv* const env,
                                       const JniReference<jobject>& object,
                                       const char* field_name,
                                       TypeId<std::optional<int32_t>>) noexcept {
    return get_converted_object_field_value<std::optional<int32_t>>(env, object, field_name, "Ljava/lang/Integer;");
}

std::optional<int64_t> get_field_value(JNIEnv* const env,
                                       const JniReference<jobject>& object,
                                       const char* field_name,
                                       TypeId<std::optional<int64_t>>) noexcept {
    return get_converted_object_field_value<std::optional<int64_t>>(env, object, field_name, "Ljava/lang/Long;");
}

std::optional<uint8_t> get_field_value(JNIEnv* const env,
                                       const JniReference<jobject>& object,
                                       const char* field_name,
                                       TypeId<std::optional<uint8_t>>) noexcept {
    return get_converted_object_field_value<std::optional<uint8_t>>(env, object, field_name, "Ljava/lang/Short;");
}

std::optional<uint16_t> get_field_value(JNIEnv* const env,
                                        const JniReference<jobject>& object,
                                        const char* field_name,
                                        TypeId<std::optional<uint16_t>>) noexcept {
    return get_converted_object_field_value<std::optional<uint16_t>>(env, object, field_name, "Ljava/lang/Integer;");
}

std::optional<uint32_t> get_field_value(JNIEnv* const env,
                                        const JniReference<jobject>& object,
                                        const char* field_name,
                                        TypeId<std::optional<uint32_t>>) noexcept {
    return get_converted_object_field_value<std::optional<uint32_t>>(env, object, field_name, "Ljava/lang/Long;");
}

std::optional<uint64_t> get_field_value(JNIEnv* const env,
                                        const JniReference<jobject>& object,
                                        const char* field_name,
                                        TypeId<std::optional<uint64_t>>) noexcept {
    return get_converted_object_field_value<std::optional<uint64_t>>(env, object, field_name, "Ljava/lang/Long;");
}

std::optional<float> get_field_value(JNIEnv* const env,
                                     const JniReference<jobject>& object,
                                     const char* field_name,
                                     TypeId<std::optional<float>>) noexcept {
    return get_converted_object_field_value<std::optional<float>>(env, object, field_name, "Ljava/lang/Float;");
}

std::optional<double> get_field_value(JNIEnv* const env,
                                      const JniReference<jobject>& object,
                                      const char* field_name,
                                      TypeId<std::optional<double>>) noexcept {
    return get_converted_object_field_value<std::optional<double>>(env, object, field_name, "Ljava/lang/Double;");
}

std::optional<std::string> get_field_value(JNIEnv* const env,
                                           const JniReference<jobject>& object,
                                           const char* field_name,
                                           TypeId<std::optional<std::string>>) {
    return get_converted_object_field_value<std::optional<std::string>>(env, object, field_name, "Ljava/lang/String;");
}

std::shared_ptr<std::vector<uint8_t>> get_field_value(JNIEnv* const env,
                                                      const JniReference<jobject>& object,
                                                      const char* field_name,
...
std::optional<std::shared_ptr<std::vector<uint8_t>>> get_field_value(
    JNIEnv* const env,
    const JniReference<jobject>& object,
    const char* field_name,
...
::glue_internal::Locale get_field_value(JNIEnv* const env,
                                        const JniReference<jobject>& object,
                                        const char* field_name,
                                        TypeId<::glue_internal::Locale>) noexcept {
    return get_converted_object_field_value<::glue_internal::Locale>(env, object, field_name, "Ljava/util/Locale;");
}

std::optional<::glue_internal::Locale> get_field_value(JNIEnv* const env,
                                                       const JniReference<jobject>& object,
                                                       const char* field_name,
...
JniReference<jobject> get_object_field_value(JNIEnv* const env,
                                             const JniReference<jobject>& object,
                                             const char* field_name,
                                             const char* field_signature) noexcept {
    return make_local_ref(env, get_field_value_impl(env, &JNIEnv::GetObjectField, object, field_name, field_signature));
}

// -------------------- JNI object field setters --------------------------------------------------

void set_field_value(JNIEnv* const env,
                     const JniReference<jobject>& object,
                     const char* field_name,
                     bool value) noexcept {
...
void set_object_field_value(JNIEnv* const env,
                            const JniReference<jobject>& object,
                            const char* field_name,
