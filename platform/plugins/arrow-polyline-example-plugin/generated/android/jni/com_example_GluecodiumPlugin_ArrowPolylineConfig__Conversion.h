...
namespace jni {
JNIEXPORT ::GluecodiumPlugin::ArrowPolylineConfig convert_from_jni(JNIEnv* _jenv,
                                                                   const JniReference<jobject>& _jinput,
                                                                   TypeId<::GluecodiumPlugin::ArrowPolylineConfig>);
JNIEXPORT std::optional<::GluecodiumPlugin::ArrowPolylineConfig> convert_from_jni(
    JNIEnv* _jenv,
    const JniReference<jobject>& _jinput,
...
JNIEXPORT JniReference<jobject> convert_to_jni(JNIEnv* _jenv,
