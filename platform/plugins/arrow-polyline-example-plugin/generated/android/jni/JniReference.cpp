...
JniReference<jobject> create_object(JNIEnv* env, const JniReference<jclass>& javaClass) noexcept {
...
JniReference<jobject> create_instance_object(JNIEnv* env,
...
JniReference<jobject> alloc_object(JNIEnv* env, const JniReference<jclass>& javaClass) noexcept {
