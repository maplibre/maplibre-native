...
jint
unbox_int_value( JNIEnv* const env, const ::glue_internal::jni::JniReference<jobject>& jvalue ) noexcept
{
    return ::glue_internal::jni::call_java_method<jint>( env, "java/lang/Integer", jvalue, "intValue", "()I" );
}

jlong
unbox_long_value( JNIEnv* const env, const ::glue_internal::jni::JniReference<jobject>& jvalue ) noexcept
{
    return ::glue_internal::jni::call_java_method<jlong>( env, "java/lang/Long", jvalue, "longValue", "()J" );
}

template<typename T>
::glue_internal::jni::JniReference<jobject>
                          ...
                          const char* const method_signature) noexcept
{
    ...
    const auto unboxed_value = ::glue_internal::jni::call_java_method<JResult>(env, jvalue, method_name, method_signature );
