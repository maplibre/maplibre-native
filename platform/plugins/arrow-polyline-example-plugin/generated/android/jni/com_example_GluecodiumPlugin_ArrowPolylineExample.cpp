...
jlong Java_com_example_GluecodiumPlugin_ArrowPolylineExample_create(JNIEnv* _jenv, jobject _jinstance)
...
void Java_com_example_GluecodiumPlugin_ArrowPolylineExample_addArrowPolyline(JNIEnv* _jenv,
                                                                             jobject _jinstance,
                                                                             jobject jcoordinates,
                                                                             jobject jconfig)

{
    ::std::vector<::GluecodiumPlugin::LatLng> coordinates = ::glue_internal::jni::convert_from_jni(
        _jenv,
        ::glue_internal::jni::make_non_releasing_ref(jcoordinates),
        ::glue_internal::jni::TypeId<::std::vector<::GluecodiumPlugin::LatLng>>{});

    ::GluecodiumPlugin::ArrowPolylineConfig config = ::glue_internal::jni::convert_from_jni(
        _jenv,
...
void Java_com_example_GluecodiumPlugin_ArrowPolylineExample_removeArrowPolyline(JNIEnv* _jenv, jobject _jinstance)
...
JNIEXPORT void JNICALL Java_com_example_GluecodiumPlugin_ArrowPolylineExample_disposeNativeHandle(JNIEnv* _jenv,
                                                                                                  jobject _jinstance,
                                                                                                  jlong _jpointerRef) {
...
JNIEXPORT void JNICALL Java_com_example_GluecodiumPlugin_ArrowPolylineExample_cacheThisInstance(JNIEnv* _jenv,
                                                                                                jobject _jinstance) {
