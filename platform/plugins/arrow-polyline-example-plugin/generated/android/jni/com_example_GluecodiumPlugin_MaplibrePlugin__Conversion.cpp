...
REGISTER_JNI_CLASS_CACHE_INHERITANCE("com/example/GluecodiumPlugin/MaplibrePlugin", com_example_GluecodiumPlugin_MaplibrePlugin, "GluecodiumPlugin_MaplibrePlugin", ::GluecodiumPlugin::MaplibrePlugin)



std::shared_ptr<::GluecodiumPlugin::MaplibrePlugin> convert_from_jni(JNIEnv* _env, const JniReference<jobject>& _jobj, TypeId<std::shared_ptr<::GluecodiumPlugin::MaplibrePlugin>>)
{
...
convert_to_jni(JNIEnv* _jenv, const std::shared_ptr<::GluecodiumPlugin::MaplibrePlugin>& _ninput)
{
    if ( !_ninput )
    {
        return {};
