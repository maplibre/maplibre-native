...
protected:
    JavaContainerAdder(JNIEnv* const env, const char* class_name) noexcept;
...
public:
    ...
    JniReference<jobject> fetch_container() noexcept { return std::move(m_java_container.instance); }
...
public:
    ...
    jint length() const noexcept { return m_length; }
...
public:
    ...
    JniReference<jobject> fetch_hash_map() noexcept { return std::move(m_java_container.instance); }
...
public:
    ...
    bool has_next() const noexcept { return m_set_iterator.has_next(); }
