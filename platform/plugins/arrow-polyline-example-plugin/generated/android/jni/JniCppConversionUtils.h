...
JNIEXPORT std::optional<std::string> convert_from_jni(JNIEnv* const env,
 ...
 */
JNIEXPORT std::shared_ptr<::std::vector<uint8_t>> convert_from_jni(JNIEnv* const env,
...
std::chrono::time_point<Clock, Duration> convert_from_jni(JNIEnv* const env,
                                                          const JniReference<jobject>& jvalue,
                                                          TypeId<std::chrono::time_point<Clock, Duration>>) {
    if (!jvalue) {
...
template <class Clock, class Duration>
std::optional<std::chrono::time_point<Clock, Duration>> convert_from_jni(
    JNIEnv* const env,
    const JniReference<jobject>& jvalue,
    TypeId<std::optional<std::chrono::time_point<Clock, Duration>>>) {
    return jvalue ? std::optional<std::chrono::time_point<Clock, Duration>>(
...
std::chrono::duration<Rep, Period> convert_from_jni(JNIEnv* const env,
                                                    const JniReference<jobject>& jvalue,
...
template <class Rep, class Period>
std::optional<std::chrono::duration<Rep, Period>> convert_from_jni(
    JNIEnv* const env, const JniReference<jobject>& jvalue, TypeId<std::optional<std::chrono::duration<Rep, Period>>>) {
    return jvalue ? std::optional<std::chrono::duration<Rep, Period>>(
 ...
 */
JNIEXPORT ::glue_internal::Locale convert_from_jni(JNIEnv* const env,
                                                   const JniReference<jobject>& jvalue,
                                                   TypeId<::glue_internal::Locale>);
JNIEXPORT std::optional<::glue_internal::Locale> convert_from_jni(JNIEnv* const env,
                                                                  const JniReference<jobject>& jvalue,
 ...
 */
JNIEXPORT JniReference<jbyteArray> convert_to_jni(JNIEnv* const env,
...
template <class Clock, class Duration>
JniReference<jobject> convert_to_jni(JNIEnv* const env, const std::chrono::time_point<Clock, Duration>& nvalue) {
    return create_date_new_object(env,
                                  std::chrono::duration_cast<std::chrono::milliseconds>(nvalue.time_since_epoch()));
}

template <class Clock, class Duration>
JniReference<jobject> convert_to_jni(JNIEnv* const env,
                                     const std::optional<std::chrono::time_point<Clock, Duration>>& nvalue) {
...
JNIEXPORT JniReference<jobject> create_duration_new_object(JNIEnv* const env,
                                                           std::intmax_t seconds,
                                                           std::intmax_t nanos) noexcept;

template <class Rep, class Period>
JniReference<jobject> convert_to_jni(JNIEnv* const env, const std::chrono::duration<Rep, Period>& nvalue) {
    using namespace std::chrono;
 ...
 */
JNIEXPORT JniReference<jobject> convert_to_jni(JNIEnv* const env, const ::glue_internal::Locale& nvalue) noexcept;
JNIEXPORT JniReference<jobject> convert_to_jni(JNIEnv* const env,
                                               const std::optional<::glue_internal::Locale>& nvalue) noexcept;

template <class Rep, class Period>
JNIEXPORT JniReference<jobject> convert_to_jni(JNIEnv* const env,
                                               const std::optional<std::chrono::duration<Rep, Period>>& nvalue) {
    return nvalue ? convert_to_jni(env, *nvalue) : JniReference<jobject>{};
}
...
std::optional<std::function<R(Args...)>> convert_from_jni(JNIEnv* _jenv,
                                                          const JniReference<jobject>& _jinput,
                                                          TypeId<std::optional<std::function<R(Args...)>>>) {
    return _jinput ? convert_from_jni(_jenv, _jinput, TypeId<std::function<R(Args...)>>{})
                   : std::optional<std::function<R(Args...)>>{};
}

template <class R, class... Args>
JniReference<jobject> convert_to_jni(JNIEnv* _jenv, const std::optional<std::function<R(Args...)>> _ninput) {
