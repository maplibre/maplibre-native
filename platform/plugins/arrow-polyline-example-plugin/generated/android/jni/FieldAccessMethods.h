...
JNIEXPORT JniReference<jobject> get_object_field_value(JNIEnv* const env,
...
JNIEXPORT bool get_field_value(JNIEnv* const env,
                               const JniReference<jobject>& object,
                               const char* field_name,
                               TypeId<bool>) noexcept;
JNIEXPORT int8_t get_field_value(JNIEnv* const env,
                                 const JniReference<jobject>& object,
                                 const char* field_name,
                                 TypeId<int8_t>) noexcept;
JNIEXPORT int16_t get_field_value(JNIEnv* const env,
                                  const JniReference<jobject>& object,
                                  const char* field_name,
                                  TypeId<int16_t>) noexcept;
JNIEXPORT int32_t get_field_value(JNIEnv* const env,
                                  const JniReference<jobject>& object,
                                  const char* field_name,
                                  TypeId<int32_t>) noexcept;
JNIEXPORT int64_t get_field_value(JNIEnv* const env,
                                  const JniReference<jobject>& object,
                                  const char* field_name,
                                  TypeId<int64_t>) noexcept;
JNIEXPORT uint8_t get_field_value(JNIEnv* const env,
                                  const JniReference<jobject>& object,
                                  const char* field_name,
                                  TypeId<uint8_t>) noexcept;
JNIEXPORT uint16_t get_field_value(JNIEnv* const env,
                                   const JniReference<jobject>& object,
                                   const char* field_name,
                                   TypeId<uint16_t>) noexcept;
JNIEXPORT uint32_t get_field_value(JNIEnv* const env,
                                   const JniReference<jobject>& object,
                                   const char* field_name,
                                   TypeId<uint32_t>) noexcept;
JNIEXPORT uint64_t get_field_value(JNIEnv* const env,
                                   const JniReference<jobject>& object,
                                   const char* field_name,
                                   TypeId<uint64_t>) noexcept;
JNIEXPORT float get_field_value(JNIEnv* const env,
                                const JniReference<jobject>& object,
                                const char* field_name,
                                TypeId<float>) noexcept;
JNIEXPORT double get_field_value(JNIEnv* const env,
                                 const JniReference<jobject>& object,
                                 const char* field_name,
                                 TypeId<double>) noexcept;
JNIEXPORT ::std::string get_field_value(JNIEnv* const env,
                                        const JniReference<jobject>& object,
                                        const char* field_name,
                                        TypeId<::std::string>);
...
JNIEXPORT ::std::shared_ptr<::std::vector<uint8_t>> get_field_value(JNIEnv* const env,
                                                                    const JniReference<jobject>& object,
                                                                    const char* field_name,
...
std::chrono::time_point<Clock, Duration> get_field_value(JNIEnv* const env,
                                                         const JniReference<jobject>& object,
                                                         const char* field_name,
...
template <class Clock, class Duration>
std::optional<std::chrono::time_point<Clock, Duration>> get_field_value(
    JNIEnv* const env,
    const JniReference<jobject>& object,
    const char* field_name,
...
JNIEXPORT ::glue_internal::Locale get_field_value(JNIEnv* const env,
                                                  const JniReference<jobject>& object,
                                                  const char* field_name,
...
JNIEXPORT void set_object_field_value(JNIEnv* const env,
                                      const JniReference<jobject>& object,
                                      const char* field_name,
...
void set_converted_object_field_value(JNIEnv* const env,
                                      const JniReference<jobject>& object,
                                      const char* field_name,
...
JNIEXPORT ::std::chrono::duration<Rep, Period> get_field_value(JNIEnv* const env,
                                                               const JniReference<jobject>& object,
                                                               const char* field_name,
