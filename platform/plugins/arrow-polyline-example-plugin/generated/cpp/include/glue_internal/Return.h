...
template <class Value, class Error>
bool Return<Value, Error>::has_value() const noexcept {
    return m_has_value;
}

template <class Value, class Error>
auto Return<Value, Error>::error() const noexcept -> Error {
    if (m_has_value) {
        return Error();
    } else {
        return m_error;
...
template <class Value, class Error>
constexpr Value Return<Value, Error>::unsafe_value() const& {
    return m_value;
}

template <class Value, class Error>
Value Return<Value, Error>::unsafe_value() && {
    return std::move(m_value);
}

template <class Value, class Error>
void Return<Value, Error>::reset() noexcept {
    if (m_has_value) {
        m_value.~Value();
        new (&m_error)(Error){};
        m_has_value = false;
...
template <class Error>
bool Return<void, Error>::has_value() const noexcept {
    return m_has_value;
}

template <class Error>
auto Return<void, Error>::error() const noexcept -> Error {
    if (m_has_value) {
        return Error();
    } else {
        return m_error;
...
template <class Error>
void Return<void, Error>::reset() noexcept {
    if (m_has_value) {
        new (&m_error)(Error){};
        m_has_value = false;
    } else {
