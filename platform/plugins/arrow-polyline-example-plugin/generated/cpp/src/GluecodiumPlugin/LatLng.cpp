...
std::size_t hash<::GluecodiumPlugin::LatLng>::operator()(const ::GluecodiumPlugin::LatLng& t) const {
    size_t hash_value = 43;
    hash_value = (hash_value ^ ::glue_internal::hash<decltype(::GluecodiumPlugin::LatLng::latitude)>()(t.latitude))
                 << 1;
    hash_value = (hash_value ^ ::glue_internal::hash<decltype(::GluecodiumPlugin::LatLng::longitude)>()(t.longitude))
                 << 1;
    return hash_value;
}
} // namespace glue_internal
