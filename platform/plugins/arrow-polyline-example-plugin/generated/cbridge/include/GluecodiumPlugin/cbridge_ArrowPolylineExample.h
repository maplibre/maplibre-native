...
_GLUECODIUM_C_EXPORT const void* GluecodiumPlugin_ArrowPolylineExample_get_swift_object_from_wrapper_cache(
    _baseRef handle);
_GLUECODIUM_C_EXPORT void GluecodiumPlugin_ArrowPolylineExample_cache_swift_object_wrapper(_baseRef handle,
...
_GLUECODIUM_C_EXPORT void GluecodiumPlugin_ArrowPolylineExample_addArrowPolyline(_baseRef _instance,
                                                                                 _baseRef coordinates,
                                                                                 _baseRef config);
