...
_GLUECODIUM_C_EXPORT _baseRef GluecodiumPlugin_ArrowPolylineConfig_create_handle(double headLength,
                                                                                 double headAngle,
                                                                                 _baseRef lineColor,
                                                                                 double lineWidth);
_GLUECODIUM_C_EXPORT void GluecodiumPlugin_ArrowPolylineConfig_release_handle(_baseRef handle);

_GLUECODIUM_C_EXPORT _baseRef GluecodiumPlugin_ArrowPolylineConfig_create_optional_handle(double headLength,
                                                                                          double headAngle,
                                                                                          _baseRef lineColor,
                                                                                          double lineWidth);
