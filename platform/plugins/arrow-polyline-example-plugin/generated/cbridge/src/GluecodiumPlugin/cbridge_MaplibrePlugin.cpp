...
_baseRef GluecodiumPlugin_MaplibrePlugin_copy_handle(_baseRef handle) {
    return handle
        ? reinterpret_cast<_baseRef>(checked_pointer_copy(*get_pointer<::std::shared_ptr< ::GluecodiumPlugin::MaplibrePlugin >>(handle)))
        : 0;
}

const void* GluecodiumPlugin_MaplibrePlugin_get_swift_object_from_wrapper_cache(_baseRef handle) {
    return handle
        ? ::glue_internal::get_wrapper_cache().get_cached_wrapper(get_pointer<::std::shared_ptr< ::GluecodiumPlugin::MaplibrePlugin >>(handle)->get())
        : nullptr;
}

void GluecodiumPlugin_MaplibrePlugin_cache_swift_object_wrapper(_baseRef handle, const void* swift_pointer) {
    if (!handle) return;
    ::glue_internal::get_wrapper_cache().cache_wrapper(get_pointer<::std::shared_ptr< ::GluecodiumPlugin::MaplibrePlugin >>(handle)->get(), swift_pointer);
}
...
void GluecodiumPlugin_MaplibrePlugin_remove_swift_object_from_wrapper_cache(_baseRef handle) {
    ...
    ::glue_internal::get_wrapper_cache().remove_cached_wrapper(get_pointer<::std::shared_ptr< ::GluecodiumPlugin::MaplibrePlugin >>(handle)->get());
}
...
void* GluecodiumPlugin_MaplibrePlugin_get_typed(_baseRef handle) {
    const auto& real_type_id = ::glue_internal::get_type_repository().get_id(get_pointer<::std::shared_ptr< ::GluecodiumPlugin::MaplibrePlugin >>(handle)->get());
...
_baseRef GluecodiumPlugin_MaplibrePlugin_create() {
    return Conversion<::std::shared_ptr< ::GluecodiumPlugin::MaplibrePlugin >>::toBaseRef(::GluecodiumPlugin::MaplibrePlugin::create());
}
