...
_baseRef GluecodiumPlugin_LatLng_create_handle(double latitude, double longitude) {
...
void GluecodiumPlugin_LatLng_release_handle(_baseRef handle) {
    delete get_pointer<::GluecodiumPlugin::LatLng>(handle);
}

_baseRef GluecodiumPlugin_LatLng_create_optional_handle(double latitude, double longitude) {
...
_baseRef GluecodiumPlugin_LatLng_unwrap_optional_handle(_baseRef handle) {
