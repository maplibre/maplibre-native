...
_baseRef GluecodiumPlugin_ArrowPolylineConfig_create_handle(double headLength,
                                                            double headAngle,
                                                            _baseRef lineColor,
                                                            double lineWidth) {
...
void GluecodiumPlugin_ArrowPolylineConfig_release_handle(_baseRef handle) {
    delete get_pointer<::GluecodiumPlugin::ArrowPolylineConfig>(handle);
}

_baseRef GluecodiumPlugin_ArrowPolylineConfig_create_optional_handle(double headLength,
                                                                     double headAngle,
                                                                     _baseRef lineColor,
                                                                     double lineWidth) {
    auto _struct = new (::std::nothrow)
        std::optional<::GluecodiumPlugin::ArrowPolylineConfig>(::GluecodiumPlugin::ArrowPolylineConfig());
    (*_struct)->head_length = headLength;
    (*_struct)->head_angle = headAngle;
    (*_struct)->line_color = Conversion<::std::string>::toCpp(lineColor);
    (*_struct)->line_width = lineWidth;
...
_baseRef GluecodiumPlugin_ArrowPolylineConfig_unwrap_optional_handle(_baseRef handle) {
    return reinterpret_cast<_baseRef>(
        &**reinterpret_cast<std::optional<::GluecodiumPlugin::ArrowPolylineConfig>*>(handle));
}
