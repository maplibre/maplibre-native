...
_baseRef ArrayOf_GluecodiumPlugin_LatLng_copy_handle(_baseRef handle) {
    return reinterpret_cast<_baseRef>(new ::std::vector<::GluecodiumPlugin::LatLng>(
        *reinterpret_cast<::std::vector<::GluecodiumPlugin::LatLng>*>(handle)));
}
...
_baseRef ArrayOf_GluecodiumPlugin_LatLng_get(_baseRef handle, uint64_t index) {
    return Conversion<::GluecodiumPlugin::LatLng>::referenceBaseRef(
        Conversion<::std::vector<::GluecodiumPlugin::LatLng>>::toCpp(handle)[index]);
}

void ArrayOf_GluecodiumPlugin_LatLng_append(_baseRef handle, _baseRef item) {
    Conversion<::std::vector<::GluecodiumPlugin::LatLng>>::toCpp(handle).push_back(
        Conversion<::GluecodiumPlugin::LatLng>::toCpp(item));
}

_baseRef ArrayOf_GluecodiumPlugin_LatLng_create_optional_handle() {
    return reinterpret_cast<_baseRef>(new (::std::nothrow) std::optional<::std::vector<::GluecodiumPlugin::LatLng>>(
        ::std::vector<::GluecodiumPlugin::LatLng>()));
}
...
_baseRef ArrayOf_GluecodiumPlugin_LatLng_unwrap_optional_handle(_baseRef handle) {
    return reinterpret_cast<_baseRef>(
        &**reinterpret_cast<std::optional<::std::vector<::GluecodiumPlugin::LatLng>>*>(handle));
}
