...
class ArrowPolylineExampleImpl : public ::GluecodiumPlugin::ArrowPolylineExample,
...
public:
    ...
    void add_arrow_polyline(const std::vector<::GluecodiumPlugin::LatLng>& coordinates,
                            const ::GluecodiumPlugin::ArrowPolylineConfig& config) override;
...
private:
    ...
    static std::vector<LatLng> makeChevronArrowHead(const std::vector<LatLng>& shaft,
