...
uint64_t ArrowPolylineExampleImpl::get_ptr() const {
  auto basePtr = static_cast<mbgl::platform::XPlatformPlugin*>(
      const_cast<ArrowPolylineExampleImpl*>(this));
...
ArrowPolylineExampleImpl::LatLng ArrowPolylineExampleImpl::coordinateAt(
    const LatLng& origin, double distance, double bearingDeg) {
...
void ArrowPolylineExampleImpl::add_arrow_polyline(
