...
using SkyShaderSource = ShaderSource<BuiltIn::SkyShader, gfx::Backend::Type::Vulkan>;
...
using AtmosphereShaderSource = ShaderSource<BuiltIn::AtmosphereShader, gfx::Backend::Type::Vulkan>;
