...
MBGL_DEFINE_ENUM(BuiltIn,
                 {{BuiltIn::None, "None"},
                  ...
                  {BuiltIn::FillExtrusionShadowMaskShader, "FillExtrusionShadowMaskShader"},
                  {BuiltIn::FillExtrusionShadowMaskInstancedShader, "FillExtrusionShadowMaskInstancedShader"},
