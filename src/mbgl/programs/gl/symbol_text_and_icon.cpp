...
struct ShaderSource<SymbolTextAndIconProgram> {
    ...
    static constexpr const uint8_t hash[8] = {0x76, 0xc4, 0x7d, 0x53, 0xa3, 0xe7, 0x50, 0x4a};
    static constexpr const auto vertexOffset = 66146;
    static constexpr const auto fragmentOffset = 70360;
};
