...
struct ShaderSource<SymbolIconProgram> {
    ...
    static constexpr const uint8_t hash[8] = {0xa6, 0x62, 0xee, 0x12, 0xa5, 0xd2, 0xe7, 0xa2};
    static constexpr const auto vertexOffset = 56800;
    static constexpr const auto fragmentOffset = 59707;
};
