...
struct ShaderSource<FillExtrusionPatternProgram> {
    ...
    static constexpr const uint8_t hash[8] = {0xa6, 0xeb, 0xfc, 0x97, 0xd9, 0xe6, 0x93, 0x88};
    static constexpr const auto vertexOffset = 26850;
    static constexpr const auto fragmentOffset = 30634;
};
