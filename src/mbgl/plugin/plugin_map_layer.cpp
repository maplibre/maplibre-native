...
__attribute__((visibility("default"))) MapLayerType::MapLayerType() {}

__attribute__((visibility("default"))) __attribute__((used)) MapLayerType::~MapLayerType() = default;

// Returns the layer type string that is used in the style
__attribute__((used)) __attribute__((visibility("default"))) std::string MapLayerType::getLayerType() {
    // Base class does nothing
    return "base class does nothing";
}

// If this layer type requires pass 3d
__attribute__((used)) __attribute__((visibility("default"))) bool mbgl::plugin::MapLayerType::requiresPass3D() {
    // Base class returns false
    return false;
}

// The list of properties
__attribute__((used)) __attribute__((visibility("default"))) std::vector<std::shared_ptr<mbgl::plugin::LayerProperty>>
mbgl::plugin::MapLayerType::getLayerProperties() {
...
__attribute__((used)) __attribute__((visibility("default"))) std::shared_ptr<mbgl::plugin::MapLayer>
mbgl::plugin::MapLayerType::createMapLayer() {
    // Base class does nothing
    return nullptr;
}
...
extern "C" __attribute__((used)) __attribute__((visibility("default"))) void _force_link_MapLayerType() {
