...
void CommandEncoder::present(gfx::Renderable& renderable, std::function<void()> completionCallback) {
    renderable.getResource<RenderableResource>().swap(completionCallback);
}
