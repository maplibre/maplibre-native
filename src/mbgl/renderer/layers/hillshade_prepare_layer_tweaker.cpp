...
constexpr const std::array<float, 4>& getUnpackVector(const Tileset::Encoding encoding) {
    return (encoding == Tileset::Encoding::Terrarium) ? unpackTerrarium : unpackMapbox;
}
} // namespace
