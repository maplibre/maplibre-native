...
ImageDifference
diffImages(const Immutable<std::vector<ImmutableImage>>&, const Immutable<std::vector<ImmutableImage>>&);

using ImmutableSource = Immutable<style::Source::Impl>;
using SourceDifference = StyleDifference<ImmutableSource>;

SourceDifference
diffSources(const Immutable<std::vector<ImmutableSource>>&, const Immutable<std::vector<ImmutableSource>>&);

using ImmutableLayer = Immutable<style::Layer::Impl>;
using LayerDifference = StyleDifference<ImmutableLayer>;

LayerDifference
diffLayers(const Immutable<std::vector<ImmutableLayer>>&, const Immutable<std::vector<ImmutableLayer>>&);
