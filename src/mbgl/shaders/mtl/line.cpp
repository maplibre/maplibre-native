...
const std::array<UniformBlockInfo, 4> ShaderSource<BuiltIn::LineShader, gfx::Backend::Type::Metal>::uniforms = {
    ...
    UniformBlockInfo{true, true, sizeof(LineUBO), idLineUBO},
    UniformBlockInfo{true, true, sizeof(LinePropertiesUBO), idLinePropertiesUBO},
...
const std::array<UniformBlockInfo, 5> ShaderSource<BuiltIn::LinePatternShader, gfx::Backend::Type::Metal>::uniforms = {
    UniformBlockInfo{true, false, sizeof(LineDynamicUBO), idLineDynamicUBO},
    UniformBlockInfo{true, true, sizeof(LinePatternUBO), idLineUBO},
    UniformBlockInfo{true, true, sizeof(LinePatternPropertiesUBO), idLinePropertiesUBO},
...
const std::array<UniformBlockInfo, 4> ShaderSource<BuiltIn::LineSDFShader, gfx::Backend::Type::Metal>::uniforms = {
    UniformBlockInfo{true, false, sizeof(LineDynamicUBO), idLineDynamicUBO},
    UniformBlockInfo{true, true, sizeof(LineSDFUBO), idLineUBO},
    UniformBlockInfo{true, true, sizeof(LineSDFPropertiesUBO), idLinePropertiesUBO},
