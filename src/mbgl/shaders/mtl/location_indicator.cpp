...
const std::array<AttributeInfo, 1> LocationIndicatorShaderSource::attributes = {AttributeInfo{
    0, gfx::AttributeDataType::Float2, locationIndicatorUBOCount + 0, idLocationIndicatorPosVertexAttribute}};
...
const std::array<AttributeInfo, 2> LocationIndicatorTexturedShaderSource::attributes = {
    AttributeInfo{
        0, gfx::AttributeDataType::Float2, locationIndicatorUBOCount + 0, idLocationIndicatorPosVertexAttribute},
    AttributeInfo{
        1, gfx::AttributeDataType::Float2, locationIndicatorUBOCount + 1, idLocationIndicatorTexVertexAttribute},
};
