...
public:
    ...
    void CreateComplexGlyphIDs(const std::string &text, std::vector<GlyphID> &glyphIDs, std::vector<HBShapeAdjust> &adjusts);
    void CreateComplexGlyphIDs(const std::u16string &text, std::vector<GlyphID> &glyphIDs, std::vector<HBShapeAdjust> &adjusts);
