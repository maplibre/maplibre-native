...
public:
    IndexedSymbolInstance(uint32_t crossTileID_, Point<int64_t> coord_) : crossTileID(crossTileID_), coord(coord_) {}
...
public:
    ...
    enum class AddLayerResult : uint8_t { NoChanges = 0, BucketsAdded = 1 << 0, BucketsRemoved = 1 << 1 };
