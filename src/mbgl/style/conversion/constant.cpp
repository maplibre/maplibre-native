...
template <class T>
std::optional<T> Converter<T, typename std::enable_if_t<std::is_enum_v<T>>>::operator()(
...
template std::optional<CirclePitchScaleType> Converter<CirclePitchScaleType>::operator()(const Convertible&, Error&)
    const;
template std::optional<HillshadeIlluminationAnchorType>
Converter<HillshadeIlluminationAnchorType>::operator()(const Convertible&, Error&) const;
...
template std::optional<RasterResamplingType> Converter<RasterResamplingType>::operator()(const Convertible&, Error&)
    const;
template std::optional<SymbolAnchorType> Converter<SymbolAnchorType>::operator()(const Convertible&, Error&) const;
template std::optional<SymbolPlacementType> Converter<SymbolPlacementType>::operator()(const Convertible&, Error&)
    const;
...
template std::optional<TranslateAnchorType> Converter<TranslateAnchorType>::operator()(const Convertible&, Error&)
    const;
template std::optional<VisibilityType> Converter<VisibilityType>::operator()(const Convertible&, Error&) const;
template std::optional<std::vector<TextVariableAnchorType>>
Converter<std::vector<TextVariableAnchorType>>::operator()(const Convertible&, Error&) const;
template std::optional<std::vector<TextWritingModeType>>
Converter<std::vector<TextWritingModeType>>::operator()(const Convertible&, Error&) const;
...
template <size_t N>
std::optional<std::array<float, N>> Converter<std::array<float, N>>::operator()(const Convertible& value, Error& error)
    const {
...
template std::optional<std::array<float, 2>> Converter<std::array<float, 2>>::operator()(const Convertible&, Error&)
    const;
template std::optional<std::array<float, 3>> Converter<std::array<float, 3>>::operator()(const Convertible&, Error&)
    const;
template std::optional<std::array<float, 4>> Converter<std::array<float, 4>>::operator()(const Convertible&, Error&)
    const;

template <size_t N>
std::optional<std::array<double, N>> Converter<std::array<double, N>>::operator()(
    const Convertible& value, Error& error
) const {
    if (!isArray(value) || arrayLength(value) != N) {
        error.message = "value must be an array of " + util::toString(N) + " numbers";
...
template std::optional<std::array<double, 3>> Converter<std::array<double, 3>>::operator()(const Convertible&, Error&)
    const;

std::optional<std::vector<float>> Converter<std::vector<float>>::operator()(const Convertible& value, Error& error)
    const {
    if (!isArray(value)) {
        error.message = "value must be an array";
        return std::nullopt;
...
std::optional<std::vector<std::string>> Converter<std::vector<std::string>>::operator()(
    const Convertible& value, Error& error
) const {
    if (!isArray(value)) {
        error.message = "value must be an array";
