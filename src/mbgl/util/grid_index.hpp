...
public:
    ...
    bool hitTest(const BBox&, std::optional<std::function<bool(const T&)>> predicate = {}) const;
    bool hitTest(const BCircle&, std::optional<std::function<bool(const T&)>> predicate = {}) const;
