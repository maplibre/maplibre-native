...
AnnotationTile::AnnotationTile(const OverscaledTileID& overscaledTileID, const TileParameters& parameters, TileObserver* observer)
    : GeometryTile(overscaledTileID, AnnotationManager::SourceID, parameters, observer),
