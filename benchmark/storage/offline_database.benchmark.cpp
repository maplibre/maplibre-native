    ...
    void resetAmbientTiles() {
        ...
        for (unsigned i = 0; i < tileCount; ++i) {
            const Resource ambient =
                Resource::tile("mapbox://tile_ambient" + util::toString(i), 1, 0, 0, 0, Tileset::Scheme::XYZ);
    ...
    void resetRegion() {
        ...
        for (unsigned i = 0; i < tileCount; ++i) {
            const Resource offline =
                Resource::tile("mapbox://tile_offline_region" + util::toString(i), 1.0, 0, 0, 0, Tileset::Scheme::XYZ);
