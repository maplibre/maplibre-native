...
constexpr mln_plugin_shader_attribute_v1 attributes[] = {
    ...
    {sizeof(mln_plugin_shader_attribute_v1), 2, 2, str("a_color_min"), MLN_PLUGIN_VERTEX_UINT8_X4_NORMALIZED},
    {sizeof(mln_plugin_shader_attribute_v1), 3, 3, str("a_color_max"), MLN_PLUGIN_VERTEX_UINT8_X4_NORMALIZED},
    {sizeof(mln_plugin_shader_attribute_v1), 4, 4, str("a_base_min"), MLN_PLUGIN_VERTEX_FLOAT},
    {sizeof(mln_plugin_shader_attribute_v1), 5, 5, str("a_height_min"), MLN_PLUGIN_VERTEX_FLOAT},
    ...
    {sizeof(mln_plugin_shader_attribute_v1), 14, 14, str("a_base_max"), MLN_PLUGIN_VERTEX_FLOAT},
    {sizeof(mln_plugin_shader_attribute_v1), 15, 15, str("a_height_max"), MLN_PLUGIN_VERTEX_FLOAT},
};
constexpr mln_plugin_shader_property_binding_v1 bindings[] = {
    ...
    {sizeof(mln_plugin_shader_property_binding_v1),
     ...
     MLN_PLUGIN_PROPERTY_ENCODING_COLOR_RGBA8,
     0,
