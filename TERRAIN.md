...
| `fill-extrusion` | now yes, generated by gl-js | local baseline; gl-js render differs 60% |
| `pitched-world` | yes, but re-baselined locally | 30% |
| `skirts-auto` | yes, but re-baselined locally | 29% |
| `skirts-none` | yes, but re-baselined locally | 26% |
