...
- (instancetype)init {
  ...
  if (path) {
    ...
    self.styleResultPath =
        [path stringByAppendingPathComponent:@"/ios-metal-render-test-runner-style.html"];
    self.metricResultPath =
        [path stringByAppendingPathComponent:@"/ios-metal-render-test-runner-metrics.html"];
#else
    self.styleResultPath =
        [path stringByAppendingPathComponent:@"/ios-render-test-runner-style.html"];
    self.metricResultPath =
        [path stringByAppendingPathComponent:@"/ios-render-test-runner-metrics.html"];
#endif
